					...
					var modul_id = o.modul_id;
						if(o.status == true){
							if(isUpload) {
								...
								iframe.attr({'id':grid=grid+'_pd_frame'});
								...
								uploadfile('form_create_'+grid, grid, formAction, base_url+'processor/plc/master/sub/kategori/dokumen?action=update&id='+o.last_id+'&foreign_key='+o.foreign_id+'&company_id='+o.company_id+'&group_id='+o.group_id+'&modul_id='+o.modul_id);
								...
								$.get(base_url+'processor/plc/master/sub/kategori/dokumen?action=update&id='+o.last_id+'&foreign_key='+o.foreign_id+'&company_id='+o.company_id+'&group_id='+o.group_id+'&modul_id='+o.modul_id, function(data) {
				...
				success: function(data) {
					...
					if(o.status == true){
						if(isUpload > 0) {				
							...
							uploadfile('form_update_'+grid, grid, formAction, base_url+'processor/plc/master/sub/kategori/dokumen?action=update&id='+o.last_id+'&foreign_key='+o.foreign_id+'&company_id='+o.company_id+'&group_id='+o.group_id+'&modul_id='+o.modul_id);
...
<iframe name="master_sub_kategori_dokumen_frame" id="master_sub_kategori_dokumen_frame" height="0" width="0"></iframe>
