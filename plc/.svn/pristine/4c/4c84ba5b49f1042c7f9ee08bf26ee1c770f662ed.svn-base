...
function update_btn_back_cek_dok_prareg(grid, url, dis) {
...
function update_btn_back_v3_cekdok_prareg_QA(grid, url, dis) {
    var urlc = new URL(url);
    let searchParams = new URLSearchParams(url);
    ...
    if(conf > 0) {
        ...
        $.ajax({
                url:base_url+"processor/plc/v3/cek/dokumen/prareg?action=cekReviseQA",
                type: 'post',
                data: $('#form_update_'+grid).serialize()+'&'+$.param({ 'iM_modul_activity': iM_modul_activity })+'&'+$.param({ 'modul_id': iModul_id }),
...
function update_btn_back_v3_cekdok_prareg_BD(grid, url, dis) {
    var urlc = new URL(url);
    let searchParams = new URLSearchParams(url);
    ...
    if(conf > 0) {
        ...
        $.ajax({
                url:base_url+"processor/plc/v3/cek/dokumen/prareg?action=cekReviseBD",
                type: 'post',
                data: $('#form_update_'+grid).serialize()+'&'+$.param({ 'iM_modul_activity': iM_modul_activity })+'&'+$.param({ 'modul_id': iModul_id }),
                success: function(data1) {
                    var oo = $.parseJSON(data1);
