...
function ceckcentang3(id,idall,idrevall){
	j=0;
...
$("#<?php echo $path; ?>_rev_all_cek_3_").change(function(){
	va=false;
	da=false;
	if($(this).attr('checked')){
		va=true;
...
$("#<?php echo $path; ?>_app_all_cek_3_").click(function(){
	va=false;
	da=false;
	if($(this).attr('checked')){
		va=true;
...
$(".appr_").change(function(){
	ceckcentang3("appr_","<?php echo $path; ?>_app_all_cek_3_","<?php echo $path; ?>_rev_all_cek_3_");
});
$(".rev_").change(function(){
	ceckcentang3("rev_","<?php echo $path; ?>_rev_all_cek_3_","<?php echo $path; ?>_app_all_cek_3_");
});
...
<div class="tab">
	<div id="create_<?php echo $path  ?>" class="margin_0">
		<div style="overflow:auto; max-width:1280px">
			<table class="hover_table" id="table_create_<?php echo $path ?>" cellspacing="0" cellpadding="1" style="border: 1px solid #548cb6; text-align: center; margin-left: 5px; border-collapse: collapse">
				<thead>
				<tr style="width: 100%; border: 1px solid #dddddd; background: #548cb6; border-collapse: collapse; color:white;">
					...
					?>
								...
								<th style="border: 1px solid #dddddd; width: 10%;">Rev <br> Dokumen <br> 
								<input type="checkbox" name="all_cek_3_" id="<?php echo $path; ?>_rev_all_cek_3_" class='all_rev' /></th>	<th style="border: 1px solid #dddddd; width: 10%;">Approved<br> 
								<input type="checkbox" name="all_cek_3_" id="<?php echo $path; ?>_app_all_cek_3_" class="all_rev" /></th>
								<th style="border: 1px solid #dddddd; width: 10%;">Keterangan <br> Revision Analisa</th>		
					</tr>
					<?php
							$s++;
								...
								<tr style="border: 1px solid #dddddd; border-collapse: collapse; background: #ffffff;">
									...
									<?php if($vdocs['istatus_upload']==1){
										...
										<?php
											...
											$disabled3='';
											$dis3=$vdocs['iStatus_td_kelengkapan3']!=0?'dis':'';
											?>
											<td style="border: 1px solid #dddddd;"><?php echo $ista3 ?></td>
											<td style="border: 1px solid #dddddd;"><?php if($status3==2){ ?><input type="checkbox" name="cek_3[<?php echo $vdocs['idossier_dok_td_memo_id']; ?>]" id="cek_3_<?php echo $vdocs['idossier_dok_td_memo_id']; ?>" value="1" class='rev_'<?php echo $checkrev3.$disabled3 ?> /><?php } ?></td>
											<td style="border: 1px solid #dddddd;"><?php if($status3==2){ ?><input type="checkbox" name="cek_3[<?php echo $vdocs['idossier_dok_td_memo_id']; ?>]" id="cek_3_<?php echo $vdocs['idossier_dok_td_memo_id']; ?>" value="2" class='appr_'<?php echo $checkapp3.$disabled3 ?> /><?php } ?></td>
									
											<td style="border: 1px solid #dddddd;">
												<?php if($status3==2){ 
														//if($vdocs['iStatus_td_kelengkapan3']!=2){
													?>
															<textarea name="cek_3_keterangan[<?php echo $vdocs['idossier_dok_td_memo_id'] ?>]" id="cek_3_keterangan_<?php echo $vdocs['idossier_dok_td_memo_id'] ?>"><?php echo $vdocs['vKeterangan_td_kelengkapan3']; ?></textarea> <?php 
														//}else{
