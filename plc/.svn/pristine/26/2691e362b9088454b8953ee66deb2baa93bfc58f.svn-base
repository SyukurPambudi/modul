				...
				success: function(data) {
					...
					if(o.status == true){
						if(isUpload) {
							...
							uploadfile('form_update_'+grid, grid, formAction, base_url+'processor/plcexport/dossier/upload/dokumen?action=update&id='+o.last_id+'&foreign_key='+o.foreign_id+'&company_id='+o.company_id+'&group_id='+o.group_id+'&modul_id='+o.modul_id);
					
													
							}else{
							_custom_alert('Data Berhasil Disimpan!',header,info, grid, 1, 20000);
							$.get(base_url+'processor/plcexport/dossier/upload/dokumen?action=update&id='+o.last_id+'&foreign_key='+o.foreign_id+'&company_id='+o.company_id+'&group_id='+o.group_id+'&modul_id='+o.modul_id, function(data) {
