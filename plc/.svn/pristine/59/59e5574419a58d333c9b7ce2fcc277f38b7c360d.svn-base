...
class Browse_upb_to_kill extends MX_Controller {
    ...
    function index($action = '') {
		...
		$grid->addList('pilih','vupb_nomor','vupb_nama');
	...
	function listBox_browse_upb_to_kill_pilih($value, $pk, $name, $rowData) {
		...
		$o = '<input type="radio" name="pilih" onClick="javascript:pilih_upb_detail('.$pk.',\''.$rowData->vupb_nomor.'\',\''.$rowData->vupb_nama.'\') ;" /><script type="text/javascript">
