...
function add_row_dmf(table_id){		
		...
		if (n.length == 0) {
			...
			row_content	 += '<input type="file" id="fileuploaddmf'+c+'" class="fileupload multi multifile" name="fileuploaddmf[]" style="width: 70%" />';
		...
		$("#fileuploaddmf"+c).change(function () {
...
<table class="hover_table" id="dmf" cellspacing="0" cellpadding="1" style="width: 98%; border: 1px solid #dddddd; text-align: center; margin-left: 5px; border-collapse: collapse">
	...
	<tr style="width: 98%; border: 1px solid #dddddd; background: #548cb6; border-collapse: collapse">
		<th colspan="6" style="border: 1px solid #dddddd;"><span style="font-weight: bold; color: #ffffff; text-shadow: 0 1px 1px rgba(0, 0, 0, 0.3); text-transform: uppercase;">Upload File DMF</span></th>
	</tr>
	...
	<tbody>
		...
		?>
				<tr style="border: 1px solid #dddddd; border-collapse: collapse; background: #ffffff; ">
					...
					<td colspan="2" style="border: 1px solid #dddddd; width: 27%">
						...
						<input type="hidden" name="namafileddmf[]" style="width: 70%" value="<?php echo $row['filename'] ?>" />
		...
		?>
				<tr style="border: 1px solid #dddddd; border-collapse: collapse; background: #ffffff; ">
					...
					<td colspan="2" style="border: 1px solid #dddddd; width: 27%">
						<input type="file" id="fileuploaddmf1" class="fileupload multi multifile" name="fileuploaddmf[]" style="width: 70%" />
						<input type="hidden" name="namafileddmf[]" style="width: 70%" value="" />
	...
	<tfoot>
		...
		<tr>
			...
			<a href="javascript:;" onclick="javascript:add_row_dmf('dmf')">Tambah</a></td>
		</tr><?php //}?>
	</tfoot>
</table>
<script>
	$("#fileuploaddmf1").change(function () {
	    var fileExtension = ["pdf","jpeg", "jpg", "png", "gif", "bmp"];
	    if ($.inArray($(this).val().split(".").pop().toLowerCase(), fileExtension) == -1) {
