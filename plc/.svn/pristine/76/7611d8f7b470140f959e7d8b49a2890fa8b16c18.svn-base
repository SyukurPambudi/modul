				...
				success: function(data) {
					...
					if(o.status == true){
						if(isUpload) {
							...
							var iframe = $('<iframe name="upload_doksas_frame"/>');
							iframe.attr({'id':'upload_doksas_frame'});
							...
							$('#form_update_'+grid).attr('target','upload_doksas_frame');

							uploadfile('form_update_'+grid, grid, formAction, base_url+'processor/plc/upload/dokumen/sas/export?action=update&id='+o.last_id+'&foreign_key='+o.foreign_id+'&company_id='+o.company_id+'&group_id='+o.group_id+'&modul_id='+o.modul_id);
													
							}else{
							_custom_alert('Data Berhasil Disimpan!',header,info, grid, 1, 20000);
							$.get(base_url+'processor/plc/upload/dokumen/sas/export?action=update&id='+o.last_id+'&foreign_key='+o.foreign_id+'&company_id='+o.company_id+'&group_id='+o.group_id+'&modul_id='+o.modul_id, function(data) {
				...
				success: function(data) {
					...
					if(o.status == true){
						if(isUpload > 0) {				
							...
							uploadfile('form_update_'+grid, grid, formAction, base_url+'processor/plc/upload/dokumen/sas/export?action=view&id='+o.last_id+'&foreign_key='+o.foreign_id+'&company_id='+o.company_id+'&group_id='+o.group_id+'&modul_id='+o.modul_id);
							...
							$.get(base_url+'processor/plc/upload/dokumen/sas/export?action=view&id='+o.last_id+'&foreign_key='+o.foreign_id+'&company_id='+o.company_id+'&group_id='+o.group_id+'&modul_id='+o.modul_id, function(data) {
		                            $('div#form_'+grid).html(data);
		                            $('html, body').animate({scrollTop:$('#'+grid).offset().top - 20}, 'slow');
		                    });
						}
