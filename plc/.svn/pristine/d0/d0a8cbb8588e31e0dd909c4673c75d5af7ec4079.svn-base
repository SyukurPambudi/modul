...
$("#<?php echo $tableId;?> .file_remove").click(function(){
	...
	var tmpDel = $("#bahan_baku_rls_del");
	li.remove();
	var v = tmpDel.val();
	v+=','+fileid;
	tmpDel.val( v );
	alert( $("#bahan_baku_rls_del").val() );
});

function add_row_bahan_baku_rls(table_id){		
		//alert(table_id);
		...
		if (n.length == 0) {
			...
			row_content	 += '<span class="delete_btn"><a href="javascript:;" class="bahan_baku_rls_del" onclick="del_row1(this, \'bahan_baku_rls_del\')">[Hapus]</a></span></td>';		
			row_content  += '</tr>';
...
<table class="hover_table" id="bahan_baku_rls" cellspacing="0" cellpadding="1" style="width: 98%; border: 1px solid #dddddd; text-align: center; margin-left: 5px; border-collapse: collapse">
	<thead>
	...
	<tbody>
		...
		if(in_array('PD', $mydept)) {
			...
			$value = $row['filename'];
			if($value != '') {
				if (file_exists('./files/plc/bahan_baku/release/'.$idsp.'/'.$value)) {
					$link = base_url().'processor/plc/bahan/baku/release/bb?action=download&id='.$idsp.'&path='.$path.'&file='.$value;
		...
		?>
				<tr style="border: 1px solid #dddddd; border-collapse: collapse; background: #ffffff; ">
					<td style="border: 1px solid #dddddd; width: 3%; text-align: center;">
						<span class="bahan_baku_rls_num"><?php echo $i ?></span>
					</td>							
					...
					<td style="border: 1px solid #dddddd; width: 10%">
						<span class="delete_btn"><a href="javascript:;" class="bahan_baku_rls_del" onclick="del_row(this, 'bahan_baku_rls_del')">[Hapus]</a></span>
		...
		?>
				<tr style="border: 1px solid #dddddd; border-collapse: collapse; background: #ffffff; ">
					<td style="border: 1px solid #dddddd; width: 3%; text-align: center;">
						<span class="bahan_baku_rls_num">1</span>
					</td>		
					<td colspan="2" style="border: 1px solid #dddddd; width: 27%">
					...
					<td style="border: 1px solid #dddddd; width: 10%">
						<span class="delete_btn"><a href="javascript:;" class="bahan_baku_rls_del" onclick="del_row1(this, 'bahan_baku_rls_del')">[Hapus]</a></span>
					</td>	
				</tr>
		<?php }
		} 	
	...
	<tfoot>
		<tr>
			<td colspan="5"></td><td style="text-align: center"><a href="javascript:;" onclick="javascript:add_row_bahan_baku_rls('bahan_baku_rls')">Tambah</a></td>
		</tr>
	</tfoot>
</table>