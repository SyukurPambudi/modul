...
<table class="hover_table" id="brosur_bb_upload" cellspacing="0" cellpadding="1" style="width: 98%; border: 1px solid #dddddd; text-align: center; margin-left: 5px; border-collapse: collapse">
	...
	<tr style="width: 98%; border: 1px solid #dddddd; background: #548cb6; border-collapse: collapse">
		<th colspan="9" style="border: 1px solid #dddddd;"><span style="font-weight: bold; color: #ffffff; text-shadow: 0 1px 1px rgba(0, 0, 0, 0.3); text-transform: uppercase;">Download Dokumen</span></th>
	</tr>
	<tr style="width: 100%; border: 1px solid #dddddd; background: #b3d2ea; border-collapse: collapse">
		...
		<th colspan="2" style="border: 1px solid #dddddd;width: 20%;">Tanggal Upload</th>
		<th colspan="2" style="border: 1px solid #dddddd;width: 20%;">Tanggal Download</th>
		<th colspan="2" style="border: 1px solid #dddddd;width: 20%;">PIC</th>
		...
		<?php
			...
			if(!empty($rows)) {
				...
				foreach($rows as $row) {
					...
					$ipk=$row['idossier_file_dok_sas_id'];
					if($value != '') {
						if (file_exists('./files/plc/dok_sas/'.$id.'/'.$value)) {
							$link = base_url().'processor/plc/download/dokumen/sas/export?action=download&id='.$id.'&file='.$value.'&ipk='.$ipk;
							...
							$linknya .='<script>
										...
										grid="download_dokumen_sas_export";
		...
		?>
				<tr style="border: 1px solid #dddddd; border-collapse: collapse; background: #ffffff; ">
					...
					<td colspan="1" style="border: 1px solid #dddddd; width: 27%">
						...
						<input type="hidden" name="fileid[]" style="width: 70%" value="<?php echo $row['idossier_file_dok_sas_id'] ?>" />
					</td>	
	...
	<tfoot>
		<tr>
			<td colspan="8"></td><td style="text-align: center">
				<?php if ($this->input->get('action') != 'view') { ?>
