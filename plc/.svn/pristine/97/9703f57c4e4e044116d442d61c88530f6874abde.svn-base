...
function save_draft_btn_multiupload(grid, url, dis, isdraft) {
	...
	$.each(req, function(i,v){
		var id = $(this).attr('id');
		if(($(this).attr('id')=='spesifikasi_soi_fg_tentative_vnip_formulator') || ($(this).attr('id')=='spesifikasi_soi_fg_tentative_iupb_id')){
			$('#'+id+'_dis').removeClass('error_text');
		}else{
			...
			if(isUpload && !isValidAFileSize('#form_create_'+grid+' input.multifile', uploadLimit)) {
				...
				$.ajax({
					...
					success: function(data) {	
						...
						if(o.status == true) {
							if(isUpload) {
								var iframe = $('<iframe name="spesifikasi_soi_fg_tentative_frame"/>');
								iframe.attr({'id':'spesifikasi_soi_fg_tentative_frame'});
								...
								$('#form_create_'+grid).attr('target','spesifikasi_soi_fg_tentative_frame');								
								//$('#form_create_'+grid).submit();
								uploadfile('form_create_'+grid, grid, formAction, base_url+'processor/plc/spesifikasi/soi/fg/tentative?action=update&id='+o.last_id+'&foreign_key='+o.foreign_id+'&company_id='+o.company_id+'&group_id='+o.group_id+'&modul_id='+o.modul_id);
								...
								$.get(base_url+'processor/plc/spesifikasi/soi/fg/tentative?action=update&id='+o.last_id+'&foreign_key='+o.foreign_id+'&company_id='+o.company_id+'&group_id='+o.group_id+'&modul_id='+o.modul_id, function(data) {
				...
				.done(function(data) {
					...
					$('#grid_'+grid).trigger('reloadGrid');
						...
						$.get(base_url+'processor/plc/spesifikasi/soi/fg/tentative?action=update&id='+last_id+'&foreign_key='+foreign_id+'&company_id='+company_id+'&group_id='+group_id+'&modul_id='+modul_id, function(data) {
	                            $('div#form_'+grid).html(data);
	                            $('html, body').animate({scrollTop:$('#'+grid).offset().top - 20}, 'slow');
	                    });
				});*/
				...
				success: function(data) {
					...
					if(o.status == true){
						if(isUpload) {
							...
							$('#form_update_'+grid).attr('target','spesifikasi_soi_fg_tentative_frame');								
							//$('#form_update_'+grid).submit();
							uploadfile('form_update_'+grid, grid, formAction, base_url+'processor/plc/spesifikasi/soi/fg/tentative?action=update&id='+o.last_id+'&foreign_key='+o.foreign_id+'&company_id='+o.company_id+'&group_id='+o.group_id+'&modul_id='+o.modul_id);
	...
	custom_confirm('Anda Yakin Confirm UPB : '+upbno,function(){
		$.ajax({
			...
			success: function(data) {
				...
				$.get(base_url+'processor/plc/spesifikasi/soi/fg/tentative?action=view&id='+o.last_id+'&foreign_key='+o.foreign_id+'&company_id='+o.company_id+'&group_id='+o.group_id+'&modul_id='+o.modul_id, function(data) {
                        $('div#form_'+grid).html(data);
                        $('html, body').animate({scrollTop:$('#'+grid).offset().top - 20}, 'slow');
                });
			}		
...
<iframe name="spesifikasi_soi_fg_tentative_frame" id="spesifikasi_soi_fg_tentative_frame" height="0" width="0"></iframe>
