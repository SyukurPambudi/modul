...
<div class="v3_table_soi_bb_file_draft">
	<table class="hover_table" cellspacing="0" cellpadding="1" style="width: 98%; border: 1px solid #dddddd; text-align: center; margin-left: 5px; border-collapse: collapse">
		...
		<tr style="width: 98%; border: 1px solid #dddddd; background: #548cb6; border-collapse: collapse">
			<th colspan="6" style="border: 1px solid #dddddd;"><span style="font-weight: bold; color: #ffffff; text-shadow: 0 1px 1px rgba(0, 0, 0, 0.3); text-transform: uppercase;">File Upload Draft SOI Bahan Baku</span></th>
		</tr>
						...
						<td style="border: 1px solid #dddddd; width: 100px;">
							<?php 
								...
								if (file_exists('./'.$filepath.'/'.$pk_id.'/'.$filename)){
									$link = base_url().'processor/plc/v3/spesifikasi/soi/bb?action=download&id='.$pk_id.'&path='.$fileid.'&file='.$filename;
