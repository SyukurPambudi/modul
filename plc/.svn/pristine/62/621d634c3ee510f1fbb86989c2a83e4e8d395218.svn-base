...
<div class="tab">
	...
	<?php
			$sql = "select * 
					...
					join plc2.itemas d on d.C_ITENO=c.iupb_id
					where a.lDeleted = 0
					and b.lDeleted = 0
					...
					<tbody>
						...
						?>
							...
							<tr style="border: 1px solid #dddddd; border-collapse: collapse;">
								...
								<td style="border: 1px solid #dddddd; width: 15%; text-align: left">
									<input value="<?php echo $r['idossier_upd_id'] ?>" type="hidden" name="idossier_upd_id[]" class="upd_prio_upd_id upd_id upb_idi required" />
									<input type="hidden" name="upb_idi[]" class="upb_idi" value="<?php echo $r['idossier_upd_id'] ?>">

									<input readonly="readonly" style="width: 65%" class="input_tgl upd_prio_upd_no" type="text" name="iupd_nomor" value="<?php echo $r['vUpd_no'] ?>"  />
									<button class="btn_browse_upd" type="button" onclick="javascript:get_upb_exists();javascript:browse_multi_prioritas_upd('<?php echo $browse_url ?>&pdId=damn','List UPB',this,'iupd_id='+$('.list_upbid_exists').val());return false;">...</button>
								...
								<td style="border: 1px solid #dddddd; width: 20%; text-align: left"><div class="upd_prio_iupb_id"><?php echo $r['C_ITENO'] ?></div></td>
						...
						?>
							<tr style="border: 1px solid #dddddd; border-collapse: collapse;">
								...
								<td style="border: 1px solid #dddddd; width: 15%; text-align: left">
									<input type="hidden" name="idossier_upd_id[]" class="upd_prio_upd_id upd_id required upb_idi" />
