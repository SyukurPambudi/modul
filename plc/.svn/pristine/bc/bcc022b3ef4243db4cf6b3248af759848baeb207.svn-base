<table width="75%" border='1'  style ="border-radius:5px;border-collapse:collapse">
		<tr>
			...
			<th width="15%" colspan="2">Kelengkapan Dokumen III</th>
		</tr>
		<tr>
			<th>Ya</th>
			<th>Tidak</th>
		...
		?>
			<tr>
				...
				<td align="center">
					<input type="radio" disabled="TRUE" name="iStatus_kelengkapan2_<?php echo $list['idossier_dok_list_id']   ?>[]" value="1" <?php echo ($list['iStatus_kelengkapan2']=='1')?'checked':'' ?>  >
				</td>
				<td align="center">
					<input type="radio" disabled="TRUE" name="iStatus_kelengkapan2_<?php echo $list['idossier_dok_list_id']   ?>[]" value="0" <?php echo ($list['iStatus_kelengkapan2']=='0')?'checked':'' ?>   >
				</td>
				<td align="center">
					<input type="radio" disabled="TRUE" name="iStatus_kelengkapan3_<?php echo $list['idossier_dok_list_id']   ?>[]" value="1" <?php echo ($list['iStatus_kelengkapan3']=='1')?'checked':'' ?>  >
				</td>
				<td align="center">
					<input type="radio" disabled="TRUE" name="iStatus_kelengkapan3_<?php echo $list['idossier_dok_list_id']   ?>[]" value="0" <?php echo ($list['iStatus_kelengkapan3']=='0')?'checked':'' ?>   >
				</td>
			</tr>
		<?php
			$no++;
