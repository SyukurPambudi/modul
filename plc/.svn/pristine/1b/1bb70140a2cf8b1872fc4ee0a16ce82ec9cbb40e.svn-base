...
function add_row_<?php echo $nmfield ?>_upload(table_id){		
		...
		if (n.length == 0) {
			...
			row_content	 += '<input type="file" id="fileupload'+table_id+c+'" class="fileupload multi multifile <?php echo $field_required ?> " name="fileupload_<?php echo $nmfield ?>[]" style="width: 70%" />*';
			row_content  += '<input type="hidden" name="namafile_<?php echo $nmfield ?>[]" style="width: 70%" value="" />';	
			row_content  += '<input type="hidden" class="fileid" name="fileid_<?php echo $nmfield ?>[]" style="width: 70%" value="" /></td>';
			row_content	 += '<td colspan="3" style="border: 1px solid #dddddd; width: 8%">';
			row_content	 += '<textarea id= "filekt_request_reforpd'+c+'" class=" fileKet <?php echo $field_required ?>" name="file_vKeterangan_<?php echo $nmfield ?>[]" style="width: 240px; height: 50px;"></textarea><br/>tersisa <span id="len_request_reforpd'+c+'">250</span> karakter<br/></td>';
			...
			row_content  += '<input type="hidden" class="fileid" name="fileid_<?php echo $nmfield ?>[]" style="width: 70%" value="" /></td>';
			row_content	 += '<td colspan="3" style="border: 1px solid #dddddd; width: 8%">';
			row_content	 += '<textarea id= "filekt_request_reforpd'+c+'"class="fileKet <?php echo $field_required ?>" name="file_vKeterangan_<?php echo $nmfield ?>[]" style="width: 240px; height: 50px;"></textarea><br/>tersisa <span id="len_request_reforpd'+c+'">250</span> karakter<br/>';
			row_content  += '</td>';
	...
	<tbody>
		...
		?>
				<tr style="border: 1px solid #dddddd; border-collapse: collapse; background: #ffffff; ">
					...
					<td colspan="1" style="border: 1px solid #dddddd; width: 27%">
						...
						<input type="hidden" class="fileid" name="fileid_<?php echo $nmfield ?>[]" style="width: 70%" value="<?php echo $aidi ?>" />
					</td>	
		...
		?>
				<tr style="border: 1px solid #dddddd; border-collapse: collapse; background: #ffffff; ">
					...
					<td colspan="1" style="border: 1px solid #dddddd; width: 27%">
						<input type="file" id="fileupload_<?php echo $nmfield ?>_1" class="fileupload multi multifile <?php echo $field_required ?> " name="fileupload_<?php echo $nmfield ?>[]" style="width: 70%" /> *
						<input type="hidden" name="namafile_<?php echo $nmfield ?>[]" style="width: 70%" value="" />
						<input type="hidden" class="fileid" name="fileid_<?php echo $nmfield ?>[]" style="width: 70%" value="" />
						</td>	
					<td colspan="3" style="border: 1px solid #dddddd; width: 15%">
						<textarea class="fileKet <?php echo $field_required ?>" id="filekt_request_reforpd1" name="file_vKeterangan_<?php echo $nmfield ?>[]" style="width: 240px; height: 50px;"size="250"></textarea>
						<br/>
						tersisa <span id="len_request_reforpd1">250</span> karakter <?php echo $field_required ?> <br/>
