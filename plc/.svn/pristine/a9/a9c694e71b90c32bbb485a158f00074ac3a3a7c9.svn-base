				...
				<table class="table table-bordered table-striped">
					<thead>
						<tr>
							...
							<th>Tgl Permintaan<br> Sample Originator</th>
							<th>Tgl Kirim<br> Sample Originator</th>
							<th>Jumlah Hari</th>
						</tr>
					</thead>
					<tbody>
						...
						?>
							<tr class="ui-widget-content jqgrow ui-row-ltr" role="row" id="param_id">
                                   ...
                                   <td style="text-align:left; width:12%;" ><?php echo $data['date_prioritas'] ?></td>
                                   <td style="text-align:left; width:14%;" ><?php echo $data['tgl_request'] ?></td>
                                   <td style="text-align:left; width:14%;" ><?php echo $data['tgl_kirim'] ?></td>
                                   <td style="text-align:left; width:8%;" ><?php echo $jml_hari ?></td>
