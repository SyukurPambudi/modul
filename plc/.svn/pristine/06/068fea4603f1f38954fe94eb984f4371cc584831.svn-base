			...
			if(isUpload && !isValidAFileSize('#form_create_'+grid+' input.multifile', uploadLimit)) {
				...
				$.ajax({
					...
					success: function(data) {	
						...
						if(o.status == true) {
							if(isUpload) {
								var iframe = $('<iframe name="pembagian_produk_staff_export_frame"/>');
								iframe.attr({'id':'pembagian_produk_staff_export_frame'});
								...
								$('#form_create_'+grid).attr('target','pembagian_produk_staff_export_frame');

								//uploadfile('form_create_'+grid, grid, formAction, base_url+'processor/plc/study/literatur/pd?action=update&id='+o.last_id+'&foreign_key='+o.foreign_id+'&company_id='+o.company_id+'&group_id='+o.group_id+'&modul_id='+o.modul_id);							    

								//pembagian_produk_staff_export_tryUPload('form_create'+grid , grid, formAction, base_url+'processor/plc/study/literatur/pd?action=update&id='+o.last_id+'&foreign_key='+o.foreign_id+'&company_id='+o.company_id+'&group_id='+o.group_id+'&modul_id='+o.modul_id );
							
							}else{
								//_custom_alert('Data Berhasil Disimpan !',header,info, grid, 1, 20000);
								//$.get(base_url+'processor/plc/pembagian/produk/staff/export?action=update&id='+o.last_id+'&foreign_key='+o.foreign_id+'&company_id='+o.company_id+'&group_id='+o.group_id+'&modul_id='+o.modul_id, function(data) {
			                        $('div#form_'+grid).html('');
					...
					var modul_id = o.modul_id;
						if(o.status == true){
							if(isUpload) {
								...
								//pembagian_produk_staff_export_tryUPload('form_update_'+grid , grid, formAction, base_url+'processor/plc/study/literatur/pd?action=update&id='+o.last_id+'&foreign_key='+o.foreign_id+'&company_id='+o.company_id+'&group_id='+o.group_id+'&modul_id='+o.modul_id );
				...
				success: function(data) {
					...
					if(o.status == true){
						if(isUpload) {
							...
							$('#form_update_'+grid).attr('target','pembagian_produk_staff_export_frame');

							//uploadfile('form_update_'+grid, grid, formAction, base_url+'processor/plc/study/literatur/pd?action=update&id='+o.last_id+'&foreign_key='+o.foreign_id+'&company_id='+o.company_id+'&group_id='+o.group_id+'&modul_id='+o.modul_id);
							//pembagian_produk_staff_export_tryUPload('form_update_'+grid , grid, formAction, base_url+'processor/plc/study/literatur/pd?action=update&id='+o.last_id+'&foreign_key='+o.foreign_id+'&company_id='+o.company_id+'&group_id='+o.group_id+'&modul_id='+o.modul_id );
...
<iframe name="pembagian_produk_staff_export_frame" id="pembagian_produk_staff_export_frame" height="0" width="0"></iframe>
