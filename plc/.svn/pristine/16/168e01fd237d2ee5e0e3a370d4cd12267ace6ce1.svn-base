...
function save_draft_btn_multiupload(grid, url, dis, isdraft) {
	...
	if($("#study_literatur_ad_cPIC").val()==''){
			$("#study_literatur_ad_cPIC_text").addClass('error_text');	
			conf++;
		}
		if($("#study_literatur_ad_iupb_id").val()==''){
			$("#study_literatur_ad_iupb_id_dis").addClass('error_text');	
			conf++;
		}
			...
			if(isUpload && !isValidAFileSize('#form_create_'+grid+' input.multifile', uploadLimit)) {
				...
				$.ajax({
					...
					success: function(data) {	
						...
						if(o.status == true) {
							if(isUpload) {
								var iframe = $('<iframe name="study_literatur_ad_frame"/>');
								iframe.attr({'id':'study_literatur_ad_frame'});
								...
								$('#form_create_'+grid).attr('target','study_literatur_ad_frame');

								//study_literatur_ad_tryUPload('form_create_'+grid , grid, formAction, base_url+'processor/plc/study/literatur/ad?action=update&id='+o.last_id+'&foreign_key='+o.foreign_id+'&company_id='+o.company_id+'&group_id='+o.group_id+'&modul_id='+o.modul_id );
								uploadfile('form_create_'+grid, grid, formAction, base_url+'processor/plc/study/literatur/ad?action=update&id='+o.last_id+'&foreign_key='+o.foreign_id+'&company_id='+o.company_id+'&group_id='+o.group_id+'&modul_id='+o.modul_id);

							}else{
								_custom_alert('Data Berhasil Disimpan !',header,info, grid, 1, 20000);
								$.get(base_url+'processor/plc/study/literatur/ad?action=update&id='+o.last_id+'&foreign_key='+o.foreign_id+'&company_id='+o.company_id+'&group_id='+o.group_id+'&modul_id='+o.modul_id, function(data) {
					...
					var modul_id = o.modul_id;
						if(o.status == true){
							if(isUpload) {
								...
								//study_literatur_ad_tryUPload('form_update_'+grid , grid, formAction, base_url+'processor/plc/study/literatur/ad?action=update&id='+o.last_id+'&foreign_key='+o.foreign_id+'&company_id='+o.company_id+'&group_id='+o.group_id+'&modul_id='+o.modul_id );
								uploadfile('form_create_'+grid, grid, formAction, base_url+'processor/plc/study/literatur/ad?action=update&id='+o.last_id+'&foreign_key='+o.foreign_id+'&company_id='+o.company_id+'&group_id='+o.group_id+'&modul_id='+o.modul_id);
				...
				success: function(data) {
					...
					if(o.status == true){
						if(isUpload) {
							...
							$('#form_update_'+grid).attr('target','study_literatur_ad_frame');

							//study_literatur_ad_tryUPload('form_update_'+grid , grid, formAction, base_url+'processor/plc/study/literatur/ad?action=update&id='+o.last_id+'&foreign_key='+o.foreign_id+'&company_id='+o.company_id+'&group_id='+o.group_id+'&modul_id='+o.modul_id );
							uploadfile('form_update_'+grid, grid, formAction, base_url+'processor/plc/study/literatur/ad?action=update&id='+o.last_id+'&foreign_key='+o.foreign_id+'&company_id='+o.company_id+'&group_id='+o.group_id+'&modul_id='+o.modul_id);
...
<iframe name="study_literatur_ad_frame" id="study_literatur_ad_frame" height="0" width="0"></iframe>
