...
function add_row_upload_stress_mikrobiologi(table_id){		
		...
		if (n.length == 0) {
			...
			row_content	 += '<input type="text" class="" name="namafile3[]"/>';
			row_content  += ''</td>';
			...
			row_content	 += '<span class="delete_btn"><a href="javascript:;" class="stress_test_mikrobiologi_del" onclick="del_row(this, \'stress_test_mikrobiologi_del\')">[Hapus]</a></span></td>';		
			row_content  += '</tr>';
...
<table class="hover_table" id="stress_test_mikrobiologi" cellspacing="0" cellpadding="1" style="width: 98%; border: 1px solid #dddddd; text-align: center; margin-left: 5px; border-collapse: collapse">
	...
	<tbody>
		...
		?>
				<tr style="border: 1px solid #dddddd; border-collapse: collapse; background: #ffffff; ">
					...
					<td colspan="2" style="border: 1px solid #dddddd; width: 27%">
						...
						<input type="text" class="" name="namafile3[]" value="<?php echo $row['filename'];?>"/>
						</td>	
					<td colspan="2" style="border: 1px solid #dddddd; width: 8%">
						<textarea class="" name="fileketerangan3[]" style="width: 240px; height: 50px;"><?php echo $row['keterangan'] ?></textarea>
					</td>
					<td style="border: 1px solid #dddddd; width: 10%">
						<span class="delete_btn"><a href="javascript:;" class="stress_test_mikrobiologi_del" onclick="del_row(this, 'stress_test_mikrobiologi_del')">[Hapus]</a></span>
					</td>		
				</tr>
		<?php
			$i++;	
		...
		<tr style="border: 1px solid #dddddd; border-collapse: collapse; background: #ffffff; ">
					...
					<td colspan="2" style="border: 1px solid #dddddd; width: 27%">
						<input type="file" class="fileupload multi multifile" name="fileupload3[]" style="width: 70%" /> *max 5 mb
						<input type="text" class="" name="namafile3[]" value=""/>
						</td>	
	...
	<tfoot>
		<tr>
			<td colspan="5"></td><td style="text-align: center"><a href="javascript:;" onclick="javascript:add_row_upload_stress_mikrobiologi('add_row_upload_stress_mikrobiologi')">Tambah</a></td>
		</tr>
	</tfoot>
</table>