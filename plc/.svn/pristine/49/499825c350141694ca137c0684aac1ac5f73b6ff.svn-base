...
$("#<?php echo $tableId;?> .file_remove").click(function(){
	...
	var tmpDel = $("#basic_formula1_del");
	li.remove();
	var v = tmpDel.val();
	v+=','+fileid;
	tmpDel.val( v );
	alert( $("#basic_formula1_del").val() );
});

function add_row_basic_formula1(table_id){		
		//alert(table_id);
		...
		if (n.length == 0) {
			...
			row_content	 += '<span class="delete_btn"><a href="javascript:;" class="basic_formula1_del" onclick="del_row1(this, \'basic_formula1_del\')">[Hapus]</a></span></td>';		
			row_content  += '</tr>';
...
<table class="hover_table" id="basic_formula1" cellspacing="0" cellpadding="1" style="width: 98%; border: 1px solid #dddddd; text-align: center; margin-left: 5px; border-collapse: collapse">
	<thead>
		...
		?>
				<tr style="border: 1px solid #dddddd; border-collapse: collapse; background: #ffffff; ">
					<td style="border: 1px solid #dddddd; width: 3%; text-align: center;">
						<span class="basic_formula1_num"><?php echo $i ?></span>
					</td>							
		...
		?>
				<tr style="border: 1px solid #dddddd; border-collapse: collapse; background: #ffffff; ">
					<td colspan="6" style="border: 1px solid #dddddd; width: 3%; text-align: center;">
						<span class="basic_formula1_num">Tidak Ada File</span>
					</td>		
				</tr>
		<?php }
		} 	
