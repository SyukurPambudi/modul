					...
					success: function(data) {	
						...
						if(o.status == true) {
							if(isUpload) {
								...
								uploadfile('form_create_'+grid, grid, formAction, base_url+'processor/plc/upd/prioritas/export?action=update&id='+o.last_id+'&foreign_key='+o.foreign_id+'&company_id='+o.company_id+'&group_id='+o.group_id+'&modul_id='+o.modul_id);

							}else{
								_custom_alert('Data Berhasil Disimpan !',header,info, grid, 1, 20000);
								$.get(base_url+'processor/plc/upd/prioritas/export?action=update&id='+o.last_id+'&foreign_key='+o.foreign_id+'&company_id='+o.company_id+'&group_id='+o.group_id+'&modul_id='+o.modul_id, function(data) {
				...
				success: function(data) {
					...
					if(o.status == true){
						if(isUpload) {
							...
							uploadfile('form_update_'+grid, grid, formAction, base_url+'processor/plc/upd/prioritas/export?action=update&id='+o.last_id+'&foreign_key='+o.foreign_id+'&company_id='+o.company_id+'&group_id='+o.group_id+'&modul_id='+o.modul_id);
...
<iframe name="upd_prioritas_export_frame" id="upd_prioritas_export_frame" height="0" width="0"></iframe>
