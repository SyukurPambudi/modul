					...
					<tbody>
						...
						?>
							<tr class="ui-widget-content jqgrow ui-row-ltr" role="row" id="param_id">
                                   ...
                                   <td style="text-align:left; width:14%;" ><?php echo $data['tanggal_sub_dokumen'] ?></td>
                                   <td style="text-align:left; width:14%;" ><?php echo $data['tgl_tamb_data'] ?></td>
                                   <td style="text-align:left; width:7%;" ><?php echo $jml_hari ?></td>
