...
var config = {
	...
	select: function(event, ui){
		$.ajax({
					url: base_url+'processor/plc/upb/daftar?action=gethistkomposisi',
					type: "post",
					data: {
						raw_id: ui.item.id,
						},
