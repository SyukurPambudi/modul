...
function add_row_fgt_upload(table_id){		
		//alert(table_id);
		...
		if (n.length == 0) {
			...
			row_content	 += '<span class="delete_btn"><a href="javascript:;" class="spesifikasi_fgt_del" onclick="del_row1(this, \'spesifikasi_fgt_del\')">[Hapus]</a></span></td>';		
			row_content  += '</tr>';
...
<table class="hover_table" id="fgt_upload" cellspacing="0" cellpadding="1" style="width: 98%; border: 1px solid #dddddd; text-align: center; margin-left: 5px; border-collapse: collapse">
	<thead>
	...
	<tbody>
		<?php
			...
			if($value != '') {
				if (file_exists('./files/plc/spek_fg/'.$idsp.'/'.$value)) {
					$link = base_url().'processor/plc/spesifikasi/fg/tentative?action=download&id='.$idsp.'&file='.$value;
		...
		?>
				<tr style="border: 1px solid #dddddd; border-collapse: collapse; background: #ffffff; ">
					...
					<td style="border: 1px solid #dddddd; width: 10%">
						<span class="delete_btn"><a href="javascript:;" class="spesifikasi_fgt_del" onclick="del_row1(this, 'spesifikasi_fgt_del')">[Hapus]</a></span>
		...
		<tr style="border: 1px solid #dddddd; border-collapse: collapse; background: #ffffff; ">
					<td style="border: 1px solid #dddddd; width: 3%; text-align: center;">
						<span class="fgt_upload_num">1</span>
					</td>		
					<td colspan="2" style="border: 1px solid #dddddd; width: 27%">
	...
	<tfoot>
		<tr>
			<td colspan="5"></td><td style="text-align: center"><a href="javascript:;" onclick="javascript:add_row_fgt_upload('fgt_upload')">Tambah</a></td>
		</tr>
	</tfoot>
</table>