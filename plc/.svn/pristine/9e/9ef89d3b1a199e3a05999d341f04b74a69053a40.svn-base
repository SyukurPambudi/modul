...
$("#<?php echo $tableId;?> .file_remove").click(function(){
	...
	var tmpDel = $("#uji_mikro_bb_literatur_del");
	li.remove();
	var v = tmpDel.val();
	v+=','+fileid;
	tmpDel.val( v );
	alert( $("#uji_mikro_bb_literatur_del").val() );
});

function del_upload_uji_mikro_bb_literatur(dis, conname, table_id) {
	if($('.'+conname).length > 1) {
		...
		var n = $("span."+table_id+"_num:last").text();
			...
			row_content	 += '<span class="delete_btn"><a href="javascript:;" class="uji_mikro_bb_literatur_del" onclick="del_upload_uji_mikro_bb_literatur(this, \'uji_mikro_bb_literatur_del\', \'uji_mikro_bb_literatur\')">[Hapus]</a></span></td>';		
			row_content  += '</tr>';
...
<table class="hover_table" id="uji_mikro_bb_literatur" cellspacing="0" cellpadding="1" style="width: 98%; border: 1px solid #dddddd; text-align: center; margin-left: 5px; border-collapse: collapse">
	<thead>
	...
	<tbody>
		...
		if(in_array('QA', $mydept)) {
			...
			if($value != '') {
				if (file_exists('./files/plc/local/uji_mikro_bb/rpt_study_literatur/'.$iuji_mikro_bb.'/'.$value)) {
		...
		?>
				<tr style="border: 1px solid #dddddd; border-collapse: collapse; background: #ffffff; ">
					<td style="border: 1px solid #dddddd; width: 3%; text-align: center;">
						<span class="uji_mikro_bb_literatur_num"><?php echo $i ?></span>
					</td>		
					...
					<td style="border: 1px solid #dddddd; width: 10%">
						<span class="delete_btn"><a href="javascript:;" class="uji_mikro_bb_literatur_del" onclick="del_upload_uji_mikro_bb_literatur(this, 'uji_mikro_bb_literatur_del', 'uji_mikro_bb_literatur')">[Hapus]</a></span>
		...
		<tr style="border: 1px solid #dddddd; border-collapse: collapse; background: #ffffff; ">
					<td style="border: 1px solid #dddddd; width: 3%; text-align: center;">
						<span class="uji_mikro_bb_literatur_num">1</span>
					</td>		
					<td colspan="2" style="border: 1px solid #dddddd; width: 27%">
	...
	<tfoot>
		<tr>
			<td colspan="5"></td><td style="text-align: center"><a href="javascript:;" onclick="javascript:add_row_upload_kimiawi('uji_mikro_bb_literatur')">Tambah</a></td>
		</tr>
	</tfoot>
</table>