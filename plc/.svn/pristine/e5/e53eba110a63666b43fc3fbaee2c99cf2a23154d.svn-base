...
function save_draft_btn_multiupload(grid, url, dis, isdraft) {
	...
	if($("#import_uji_labs_cPIC").val()==''){
			$("#import_uji_labs_cPIC_text").addClass('error_text');	
			conf++;
		}
		if($("#import_uji_labs_iupb_id").val()==''){
			$("#import_uji_labs_iupb_id_dis").addClass('error_text');	
			conf++;
		}
			...
			if(isUpload && !isValidAFileSize('#form_create_'+grid+' input.multifile', uploadLimit)) {
				...
				$.ajax({
					...
					success: function(data) {	
						...
						if(o.status == true) {
							if(isUpload) {
								var iframe = $('<iframe name="import_uji_labs_frame"/>');
								iframe.attr({'id':'import_uji_labs_frame'});
								...
								$('#form_create_'+grid).attr('target','import_uji_labs_frame');

								//import_uji_labs_tryUPload('form_create_'+grid , grid, formAction, base_url+'processor/plc/study/literatur/ad?action=update&id='+o.last_id+'&foreign_key='+o.foreign_id+'&company_id='+o.company_id+'&group_id='+o.group_id+'&modul_id='+o.modul_id );
								uploadfile('form_create_'+grid, grid, formAction, base_url+'processor/plc/import/uji/labs?action=update&id='+o.last_id+'&foreign_key='+o.foreign_id+'&company_id='+o.company_id+'&group_id='+o.group_id+'&modul_id='+o.modul_id);

							}else{
								_custom_alert('Data Berhasil Disimpan !',header,info, grid, 1, 20000);
								$.get(base_url+'processor/plc/import/uji/labs?action=update&id='+o.last_id+'&foreign_key='+o.foreign_id+'&company_id='+o.company_id+'&group_id='+o.group_id+'&modul_id='+o.modul_id, function(data) {
				...
				success: function(data) {
					...
					if(o.status == true){
						if(isUpload) {
							...
							$('#form_update_'+grid).attr('target','import_uji_labs_frame');

							//import_uji_labs_tryUPload('form_update_'+grid , grid, formAction, base_url+'processor/plc/study/literatur/ad?action=update&id='+o.last_id+'&foreign_key='+o.foreign_id+'&company_id='+o.company_id+'&group_id='+o.group_id+'&modul_id='+o.modul_id );
							uploadfile('form_update_'+grid, grid, formAction, base_url+'processor/plc/import/uji/labs?action=update&id='+o.last_id+'&foreign_key='+o.foreign_id+'&company_id='+o.company_id+'&group_id='+o.group_id+'&modul_id='+o.modul_id);
...
<iframe name="import_uji_labs_frame" id="import_uji_labs_frame" height="0" width="0"></iframe>
