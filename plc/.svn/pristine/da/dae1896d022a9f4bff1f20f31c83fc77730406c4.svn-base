					...
					success: function(data) {	
						...
						if(o.status == true) {
							if(isUpload) {
								...
								$.get(base_url+'processor/plc/study/literatur/pd?action=update&id='+o.last_id+'&foreign_key='+o.foreign_id+'&company_id='+o.company_id+'&group_id='+o.group_id+'&modul_id='+o.modul_id, function(data) {
					...
					var modul_id = o.modul_id;
						if(o.status == true){
							if(isUpload) {
								...
								//study_literatur_pd_tryUPload('form_update_'+grid , grid, formAction, base_url+'processor/plc/study/literatur/pd?action=update&id='+o.last_id+'&foreign_key='+o.foreign_id+'&company_id='+o.company_id+'&group_id='+o.group_id+'&modul_id='+o.modul_id );
