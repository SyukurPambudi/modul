...
class setup_modul_activity extends MX_Controller {
    ...
    function index($action = '') {
        ...
        $grid->setTable('plc3.m_modul_activity');      
        ...
        //List field
        $grid->addFields('iSort','iM_activity','iType','vDept_assigned','vNotif_sql_to','vNotif_sql_cc','vNotif_info','vSql_get_passed','vNip_assigned','vDesciption','vFieldName','dFieldName','cFieldName','tFieldName','lDeleted'); 
        ...
        */
        ...
        $grid->setLabel('vNotif_sql_to','SQL Nip Penerima Notif');
        $grid->setLabel('vNotif_sql_cc','SQL Nip Penerima CC Notif');
        $grid->setLabel('vNotif_info','Informasi Activity Selanjutnya');
        ...
        $grid->setJoinTable('plc3.m_activity', 'm_modul_activity.iM_activity = m_activity.iM_activity', 'inner');
    ...
    public function manipulate_grid_button($button) {  
        unset($button['create']);
        $url = base_url()."processor/plc/setup/modul/activity?action=create&foreign_key=".$this->input->get('iM_modul')."&iM_modul=".$this->input->get('iM_modul')."&company_id=".$this->input->get('company_id')."&group_id=".$this->input->get('group_id')."&modul_id=".$this->input->get('modul_id');
    ...
    function listBox_Action($row, $actions) {
        ...
        $url = base_url()."processor/plc/setup/modul/activity?action=update&iM_modul=".$row->iM_modul."&foreign_key=".$row->iM_modul."&id=".$row->iM_modul_activity;
        ...
        $url2 = base_url()."processor/plc/setup/modul/activity?action=view&iM_modul=".$row->iM_modul."&foreign_key=".$row->iM_modul."&id=".$row->iM_modul_activity;
    ...
    function listBox_setup_modul_activity_iM_activity($value){
        $activity = $this->db->get_where('plc3.m_activity', array('lDeleted' => 0, 'iM_activity' => $value))->row_array();
        $return = (!empty($activity))?$activity['vKode_activity'].' - '.$activity['vNama_activity']:$value;
        return $return;
    }


    function insertBox_setup_modul_activity_vNotif_sql_to($field, $id) {
        $return = '<textarea name="'.$field.'" id="'.$id.'" class="required" style="width: 850px; height: 300px;" size="250" ></textarea>';
        return $return;
    }
    
    function updateBox_setup_modul_activity_vNotif_sql_to($field, $id, $value, $rowData) {
    ...
    function insertBox_setup_modul_activity_vNotif_sql_cc($field, $id) {
        $return = '<textarea name="'.$field.'" id="'.$id.'" class="required" style="width: 850px; height: 300px;" size="250" ></textarea>';
        return $return;
    }
    
    function updateBox_setup_modul_activity_vNotif_sql_cc($field, $id, $value, $rowData) {
            if ($this->input->get('action') == 'view') {
                 $return= '<label title="Note">'.nl2br($value).'</label>'; 
            }else{ 
                $return = '<textarea name="'.$field.'" id="'.$id.'" class="required" style="width: 850px; height: 300px;" size="250" >'.$value.'</textarea>';
    ...
    function insertBox_setup_modul_activity_vNotif_info($field, $id) {
        $return = '<textarea name="'.$field.'" id="'.$id.'" class="required" style="width: 850px; height: 300px;" size="250" ></textarea>';
        return $return;
    }
    
    function updateBox_setup_modul_activity_vNotif_info($field, $id, $value, $rowData) {
            if ($this->input->get('action') == 'view') {
                 $return= '<label title="Note">'.nl2br($value).'</label>'; 
            }else{ 
                $return = '<textarea name="'.$field.'" id="'.$id.'" class="required" style="width: 850px; height: 300px;" size="250" >'.$value.'</textarea>';
    ...
    function insertBox_setup_modul_activity_iM_activity($field, $id) {
        ...
        $activity = $this->db->get_where('plc3.m_activity', array('lDeleted' => 0))->result_array();
    ...
    function updateBox_setup_modul_activity_vDesciption($field, $id, $value, $rowData) {
            if ($this->input->get('action') == 'view') {
                ...
                $return = '<textarea name="'.$field.'" id="'.$id.'" class="required" style="width: 240px; height: 75px;" size="250" >'.nl2br($value).'</textarea>';
    ...
    */
    ...
    function manipulate_insert_button($buttons) { 
        ...
        $buttons['save_back'] .= "<button type='button' 
                                    ...
                                    onclick='javascript:create_btn_back_".$this->url."(\"".$this->url."\", \"".base_url()."processor/plc/setup/modul/activity?iM_modul=".$this->input->get('foreign_key')."&company_id=".$this->input->get('company_id')."&group_id=".$this->input->get('group_id')."&modul_id=".$this->input->get('modul_id')."\", this)'>
                                    Save Activity
                                </button>";
        ...
        $buttons['cancel'] .= "<button type='button'
                                ...
                                class='icon-save ui-button'
                                onclick='javascript:cancel_btn_".$this->url."(\"".$this->url."\", \"".base_url()."processor/plc/setup/modul/activity?iM_modul=".$this->input->get('foreign_key')."&company_id=".$this->input->get('company_id')."&group_id=".$this->input->get('group_id')."&modul_id=".$this->input->get('modul_id')."\", this)'>
                                Close 
                            </button>";
    ...
    function manipulate_update_button($buttons, $rowData) { 
        ...
        $buttons['update_back'] .= "<button type='button'
                                        ...
                                        class='icon-save ui-button'
                                        onclick='javascript:update_btn_back_".$this->url."(\"".$this->url."\", \"".base_url()."processor/plc/setup/modul/activity?iM_modul=".$this->input->get('foreign_key')."&company_id=".$this->input->get('company_id')."&group_id=".$this->input->get('group_id')."&modul_id=".$this->input->get('modul_id')."\", this)'>
                                        Update Activity
                                    </button>";
