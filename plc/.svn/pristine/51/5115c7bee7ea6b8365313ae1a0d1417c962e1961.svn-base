...
<table class="hover_table" cellspacing="0" cellpadding="1" style="width: 98%; border: 1px solid #dddddd; text-align: center; margin-left: 5px; border-collapse: collapse">
	...
	<tr style="width: 98%; border: 1px solid #dddddd; background: #548cb6; border-collapse: collapse">
		<th colspan="7" style="border: 1px solid #dddddd;"><span style="font-weight: bold; color: #ffffff; text-shadow: 0 1px 1px rgba(0, 0, 0, 0.3); text-transform: uppercase;">Stabilita Pilot Formula : <?php echo $vkode_surat; ?></span></th>
	</tr>
	...
	<tbody>
		<?php
			...
			$sql="select * from plc2.plc2_upb_stabilita_pilot st where st.ifor_id=$ifor_id and st.ista_id <> $ista_id and st.ipilot=$ipilot";
			//echo $sql;
		...
		<tr style="border: 1px solid #dddddd; border-collapse: collapse; background: #ffffff; ">
			...
			<td style="border: 1px solid #dddddd; width: 20%">
				<?php
					$x=$r['vnip_apppd'];
					if($r['iapppd']==0){echo 'Waiting For Approval';}
					else{	
