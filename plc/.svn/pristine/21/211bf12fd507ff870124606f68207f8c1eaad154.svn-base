<table width="75%" border='1'  style ="border-radius:5px;border-collapse:collapse">
		<tr>
			...
			<th width="75%" rowspan="2">Kelengkapan Data</th>
		...
		?>
			<tr>
				...
				<td align="center">
					<input type="checkbox" name="eInjection_ich[]" value="Y"  checked="checked" disabled="disabled">
				</td>
				<td align="center">
					<input type="checkbox" name="eIncjction_eu[]" value="Y"  checked="checked" disabled="disabled">
				</td>
			</tr>
		<?php
			$no++;
