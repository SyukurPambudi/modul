...
<script type="text/javascript">
    ...
    function addrow_<?php echo $nmTable; ?>(){
            ...
            var sa=[["<input type='hidden' class='num_rows_<?php echo $nmTable ?>' value='"+rlast+"' /><a href='javascript:;' onclick='javascript:hapus_row_<?php echo $nmTable ?>("+rlast+")'><center><span class='ui-icon ui-icon-close'></span></center></a>","<select id='<?php echo $grid ?>_iM_jenis_field_"+rlast+"' name='<?php echo $grid ?>_iM_jenis_field[0][]' class='numberOnly required'><?php echo $option ?></select>","<input type='text' size='20 id='<?php echo $grid ?>_vNama_field_"+rlast+"' class='' name='<?php echo $grid ?>_vNama_field[0][]'>","<textarea id='<?php echo $grid ?>_vSource_input_"+rlast+"' class='' name='<?php echo $grid ?>_vSource_input[0][]' size='250'></textarea>","<textarea id='<?php echo $grid ?>_vSource_input_edit_"+rlast+"' class='' name='<?php echo $grid ?>_vSource_input_edit[0][]' size='250'></textarea>","<textarea id='<?php echo $grid ?>_vRequirement_field_"+rlast+"' class='' name='<?php echo $grid ?>_vRequirement_field[0][]' size='250'></textarea>","<select id='<?php echo $grid ?>_iValidation_"+rlast+"' name='<?php echo $grid ?>_iValidation[0][]'><?php echo $option2yesno ?></select>","<select id='<?php echo $grid ?>_iRequired_"+rlast+"' name='<?php echo $grid ?>_iRequired[0][]'><?php echo $option2yesno ?></select>","<textarea id='<?php echo $grid ?>_vDesciption_"+rlast+"' class='' name='<?php echo $grid ?>_vDesciption[0][]' size='250'></textarea>","<input type='text' size='20' id='<?php echo $grid ?>_vTabel_file_"+rlast+"' class='' name='<?php echo $grid ?>_vTabel_file[0][]'>","<input type='text' size='20' id='<?php echo $grid ?>_vTabel_file_pk_id_"+rlast+"' class='' name='<?php echo $grid ?>_vTabel_file_pk_id[0][]'>","<input type='text' size='12' id='<?php echo $grid ?>_vDept_author_"+rlast+"' class='' name='<?php echo $grid ?>_vDept_author[0][]'>","<input type='text' size='12' id='<?php echo $grid ?>_vNip_author_"+rlast+"' class='' name='<?php echo $grid ?>_vNip_author[0][]'>","<input type='text' size='18' id='<?php echo $grid ?>_vFile_detail_"+rlast+"' class='' name='<?php echo $grid ?>_vFile_detail[0][]'>","<input type='text' size='3' id='<?php echo $grid ?>_iSort_"+rlast+"' class='numbersOnly required' name='<?php echo $grid ?>_iSort[0][]'>"]];
