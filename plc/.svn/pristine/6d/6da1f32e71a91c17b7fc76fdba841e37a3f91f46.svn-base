...
function add_row_bk_sekunder(table_id){		
		...
		if (n.length == 0) {
			...
			row_content  +=	'<select name="ijbk_sk[]">';
			...
			row_content	 += '<span class="delete_btn"><a href="javascript:;" class="bk_sekunder_del" onclick="del_row1(this, \'bk_sekunder_del\')">[Hapus]</a></span></td>';		
			row_content  += '</tr>';
...
<table class="hover_table" id="bk_sekunder" cellspacing="0" cellpadding="1" style="width:42%; border: 1px solid #dddddd; text-align: center; margin-left: 5px; border-collapse: collapse">
	<thead>
		...
		?>
				<tr style="border: 1px solid #dddddd; border-collapse: collapse; background: #ffffff; ">
					...
					<td style="border: 1px solid #dddddd; width: 4%; text-align: center;">
						<select name="ijbk_sk[]" class="required">
						<?php foreach($jenis_bk as $jbk){
					...
					<td style="border: 1px solid #dddddd; width: 10%">
						<span class="delete_btn"><a href="javascript:;" class="bk_sekunder_del" onclick="del_row1(this, 'bk_sekunder_del')">[Hapus]</a></span>
					</td>	
				</tr>
		<?php
			$i++;	
	...
	<tfoot>
		...
		<tr>
			<td colspan="2"></td><td style="text-align: center"><a href="javascript:;" onclick="javascript:add_row_bk_sekunder('bk_sekunder')">Tambah</a></td>
		</tr><?php //}?>
	</tfoot>
</table>