...
$("#<?php echo $tableId;?> .file_remove").click(function(){
	...
	var tmpDel = $("#skala_trial_kimiawi_del");
	li.remove();
	var v = tmpDel.val();
	v+=','+fileid;
	tmpDel.val( v );
	alert( $("#skala_trial_kimiawi_del").val() );
});

function del_upload_skala_trial_kimiawi(dis, conname, table_id) {
	if($('.'+conname).length > 1) {
		...
		var n = $("span."+table_id+"_num:last").text();
			...
			row_content	 += '<span class="delete_btn"><a href="javascript:;" class="skala_trial_kimiawi_del" onclick="del_upload_skala_trial_kimiawi(this, \'skala_trial_kimiawi_del\', \'skala_trial_kimiawi\')">[Hapus]</a></span></td>';		
			row_content  += '</tr>';
...
<table class="hover_table" id="skala_trial_kimiawi" cellspacing="0" cellpadding="1" style="width: 98%; border: 1px solid #dddddd; text-align: center; margin-left: 5px; border-collapse: collapse">
	<thead>
	<tr style="width: 98%; border: 1px solid #dddddd; background: #548cb6; border-collapse: collapse">
		<th colspan="6" style="border: 1px solid #dddddd;"><span style="font-weight: bold; color: #ffffff; text-shadow: 0 1px 1px rgba(0, 0, 0, 0.3); text-transform: uppercase;">Upload Dokumen Uji kimiawi</span></th>
	</tr>
	...
	<tbody>
		...
		if(in_array('PD', $mydept)) {
			...
			$path = "kimiawi";	
			if($value != '') {
				if (file_exists('./files/plc/product_trial/skala_trial/kimiawi/'.$idsp.'/'.$value)) {
		...
		?>
				<tr style="border: 1px solid #dddddd; border-collapse: collapse; background: #ffffff; ">
					<td style="border: 1px solid #dddddd; width: 3%; text-align: center;">
						<span class="skala_trial_kimiawi_num"><?php echo $i ?></span>
					</td>		
					...
					<td style="border: 1px solid #dddddd; width: 10%">
						<span class="delete_btn"><a href="javascript:;" class="skala_trial_kimiawi_del" onclick="del_upload_skala_trial_kimiawi(this, 'skala_trial_kimiawi_del', 'skala_trial_kimiawi')">[Hapus]</a></span>
		...
		<tr style="border: 1px solid #dddddd; border-collapse: collapse; background: #ffffff; ">
					<td style="border: 1px solid #dddddd; width: 3%; text-align: center;">
						<span class="skala_trial_kimiawi_num">1</span>
					</td>		
					<td colspan="2" style="border: 1px solid #dddddd; width: 27%">
	...
	<tfoot>
		<tr>
			<td colspan="5"></td><td style="text-align: center"><a href="javascript:;" onclick="javascript:add_row_upload_kimiawi('skala_trial_kimiawi')">Tambah</a></td>
		</tr>
	</tfoot>
</table>