...
function add_row_stabilita_upload1(table_id){		
		...
		if (n.length == 0) {
			...
			row_content	 += '<span class="delete_btn"><a href="javascript:;" class="stabilita_bb_del1" onclick="ngilang1(this, \'stabilita_bb_del1\')">[Hapus]</a></span></td>';		
			row_content  += '</tr>';
	...
	<tbody>
		...
		?>
				<tr style="border: 1px solid #dddddd; border-collapse: collapse; background: #ffffff; ">
					<td style="border: 1px solid #dddddd; width: 3%; text-align: center;">
						<span class="brosur_bb_upload1_num"><?php echo $i ?></span>
					</td>		
					...
					<td style="border: 1px solid #dddddd; width: 10%">
						...
						<span class="delete_btn"><a href="javascript:;" class="stabilita_bb_del1" onclick="ngilang1(this, 'stabilita_bb_del1')">[Hapus]</a></span>	
						<?php	} ?>
		...
		<tr style="border: 1px solid #dddddd; border-collapse: collapse; background: #ffffff; ">
					...
					<td colspan="3" style="border: 1px solid #dddddd; width: 15%">
						<textarea class="required" id="filekt1"name="fileketerangan[]" style="" size="250" required></textarea>
						<br/>
