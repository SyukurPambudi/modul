				...
				<table class="table table-bordered table-striped">
					<thead>
						<tr>
							...
							<th>Tgl Prareg</th>
							<th>Tgl Approve Prareg</th>
							<th>Tgl Confirm <br> Prareg</th>
					...
					<tbody>
						...
						?>
							<tr class="ui-widget-content jqgrow ui-row-ltr" role="row" id="param_id">
                                   ...
                                   <td style="text-align:left; width:20%;" ><?php echo $data['date_prioritas'] ?></td>
                                   <td style="text-align:left; width:14%;" ><?php echo $data['tanggal_prareg'] ?></td>
                                   <td style="text-align:left; width:14%;" ><?php echo $data['tanggal_approve'] ?></td>
                                   <td style="text-align:left; width:14%;" ><?php echo $data['tanggal_doc'] ?></td>
                                   <td style="text-align:left; width:5%;" ><?php echo $jml_hari ?></td>
