...
function ceckcentang2(id,idall,idrevall){
	j=0;
...
$("#<?php echo $path; ?>_rev_all_cek_2_").change(function(){
	va=false;
	da=false;
	if($(this).attr('checked')){
		va=true;
...
$("#<?php echo $path; ?>_app_all_cek_2_").click(function(){
	va=false;
	da=false;
	if($(this).attr('checked')){
		va=true;
...
$(".appr_").change(function(){
	ceckcentang2("appr_","<?php echo $path; ?>_app_all_cek_2_","<?php echo $path; ?>_rev_all_cek_2_")
});
$(".rev_").change(function(){
	ceckcentang2("rev_","<?php echo $path; ?>_rev_all_cek_2","<?php echo $path; ?>_app_all_cek_2_")
});
		...
		<div style="overflow:auto; max-width:1280px">
			<table class="hover_table" id="table_create_<?php echo $path ?>" cellspacing="0" cellpadding="1" style="border: 1px solid #548cb6; text-align: center; margin-left: 5px; border-collapse: collapse" width='1280px' >
				...
				<tr style="width: 100%; border: 1px solid #dddddd; background: #548cb6; border-collapse: collapse; color:white;">
					...
					<th style="border: 1px solid #dddddd; width: 15%;">File Upload</th>
					<th style="border: 1px solid #dddddd; width: 15%;">Ket. Upload</th>
					...
					?>
								...
								<th style="border: 1px solid #dddddd; width: 10%;">Rev <br> Dokumen <br> <input type="checkbox" name="all_cek_2_" id="<?php echo $path; ?>_rev_all_cek_2_" class='all_rev' /></th>		
								<th style="border: 1px solid #dddddd; width: 10%;">Approved<br> <input type="checkbox" name="all_cek_2_" id="<?php echo $path; ?>_app_all_cek_2_" class="all_rev" /></th>
								...
								<tr style="border: 1px solid #dddddd; border-collapse: collapse; background: #ffffff;">
									...
									<?php if($vdocs['istatus_upload']==1){
										...
										<?php
											...
											$disabled2=$vdocs['iStatus_td_kelengkapan2']==2?' disabled="disabled"':'';
											$dis2=$vdocs['iStatus_td_kelengkapan2']!=0?'dis':'';
											?>
											<td style="border: 1px solid #dddddd;"><?php echo $ista ?></td>
											<td style="border: 1px solid #dddddd;"><?php if($status==2){ ?><input type="checkbox" name="cek_2[<?php echo $vdocs['idossier_dok_td_memo_id']; ?>]" id="cek_2_<?php echo $vdocs['idossier_dok_td_memo_id']; ?>" value="1" class='rev_'<?php echo $checkrev2.$disabled2 ?> /><?php } ?></td>
											<td style="border: 1px solid #dddddd;"><?php if($status==2){ ?><input type="checkbox" name="cek_2[<?php echo $vdocs['idossier_dok_td_memo_id']; ?>]" id="cek_2_<?php echo $vdocs['idossier_dok_td_memo_id']; ?>" value="2" class='appr_'<?php echo $checkapp2.$disabled2 ?> /><?php } ?></td>
											
											<td style="border: 1px solid #dddddd;">
												<?php if($status==2){ 
														if($vdocs['iStatus_td_kelengkapan2']!=2){
													?>
															<textarea name="cek_2_keterangan[<?php echo $vdocs['idossier_dok_td_memo_id'] ?>]" id="cek_2_keterangan_<?php echo $vdocs['idossier_dok_td_memo_id'] ?>"><?php echo $vdocs['vKeterangan_td_kelengkapan2']; ?></textarea> <?php 
														}else{
