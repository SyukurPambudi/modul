...
$arrSearch=array('upload_file'=>'Jenis Uji','action'=>'Action');
...
<script type="text/javascript">
    ...
    function addrow_<?php echo $nmTable; ?>(){
            ...
            var sa=[["<input type='hidden' class='num_rows_<?php echo $nmTable ?>' value='"+rlast+"' /><select id='<?php echo $grid; ?>_ijenis_pengujian_"+rlast+"' class='required' name='<?php echo $grid; ?>_ijenis_pengujian[]'><option value=''>---Pilih---</option><?php foreach ($datapengujian as $kpppp => $vppp) { echo "<option value='".$vppp['ijenis_mikro']."'>".$vppp['vjenis_mikro']."</option>"; } ?></select>","<a class='ui-button-text' href='javascript:;' onclick='javascript:hapus_row_<?php echo $nmTable ?>("+rlast+")'>[Hapus]</a>"]];
