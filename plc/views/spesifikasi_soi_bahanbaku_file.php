...
$("#<?php echo $tableId;?> .file_remove").click(function(){
	...
	var tmpDel = $("#soi_bb_del");
	li.remove();
	var v = tmpDel.val();
	v+=','+fileid;
	tmpDel.val( v );
	alert( $("#soi_bb_del").val() );
});
...
function add_row_soi_upload(table_id){		
		...
		if (n.length == 0) {
			...
			row_content	 += '<span class="delete_btn"><a href="javascript:;" class="soi_bb_del" onclick="del_row(this, \'soi_bb_del\')">[Hapus]</a></span></td>';		
			row_content  += '</tr>';
...
<table class="hover_table" id="soi_bb_upload" cellspacing="0" cellpadding="1" style="width: 98%; border: 1px solid #dddddd; text-align: center; margin-left: 5px; border-collapse: collapse">
	<thead>
	...
	<tbody>
		<?php
			...
			$value = $row['filename'];	
			if($value != '') {
				if (file_exists('./files/plc/soi_bahanbaku/'.$idsp.'/'.$value)) {
					$link = base_url().'processor/plc/spesifikasi/soi/bahanbaku?action=download&id='.$idsp.'&file='.$value;
		...
		?>
				<tr style="border: 1px solid #dddddd; border-collapse: collapse; background: #ffffff; ">
					<td style="border: 1px solid #dddddd; width: 3%; text-align: center;">
						<span class="soi_bb_upload_num"><?php echo $i ?></span>
					</td>		
					...
					<td style="border: 1px solid #dddddd; width: 10%">
						<span class="delete_btn"><a href="javascript:;" class="soi_bb_del" onclick="del_row1(this, 'soi_bb_del')">[Hapus]</a></span>
		...
		<tr style="border: 1px solid #dddddd; border-collapse: collapse; background: #ffffff; ">
					<td style="border: 1px solid #dddddd; width: 3%; text-align: center;">
						<span class="soi_bb_upload_num">1</span>
					</td>		
					<td colspan="2" style="border: 1px solid #dddddd; width: 27%">
	...
	<tfoot>
		<tr>
			<td colspan="5"></td><td style="text-align: center"><a href="javascript:;" onclick="javascript:add_row_soi_upload('soi_bb_upload')">Tambah</a></td>
		</tr>
	</tfoot>
</table>