	...
	<tbody>
		...
		?>
				<tr style="border: 1px solid #dddddd; border-collapse: collapse; background: #ffffff; ">
					...
					<td style="border: 1px solid #dddddd; width: 47%">
						...
						<button class="btn_browse_bb" type="button" onClick="javascript:get_rawmaterial_exists();javascript:browse_multi1_sample_permintaan_sample('<?php echo $browse_url ?>?field=sample_permintaan_sample&col=detraw_id','List Bahan Baku',this,'irawmat_id='+$('.list_raw_material_exists').val());return false;">...</button>
		...
		<tr style="border: 1px solid #dddddd; border-collapse: collapse; background: #ffffff; ">
			...
			<td style="border: 1px solid #dddddd; width: 47%">
				...
				<!-- <button class="btn_browse_bb" type="button" onclick="javascript:browse_multiple('<?php //echo $browse_url ?>?field=sample_permintaan_sample&col=detraw_id','List Bahan Baku',this,'btn_browse_bb')">...</button> -->
				<button class="btn_browse_bb" type="button" onClick="javascript:get_rawmaterial_exists();javascript:browse_multi1_sample_permintaan_sample('<?php echo $browse_url ?>?upbid='+$('#sample_permintaan_sample_iupb_id').val()+'&field=sample_permintaan_sample&col=detraw_id','List Bahan Baku',this,'irawmat_id='+$('.list_raw_material_exists').val());return false;">...</button>
				<input type="hidden" name="list_raw_material_exists" class="list_raw_material_exists"/>
			</td>	
			<td style="border: 1px solid #dddddd; width: 10%">
