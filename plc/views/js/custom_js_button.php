                        ...
                        if(o.status == true){
                            if(isUpload) {
                                ...
                                <?php
                                        ...
                                        upload_custom_grid_mikro_fg('form_update_'+grid, grid, formAction, url+'&action=update&foreign_key=0&company_id='+company_id+'&id='+last_id+'&group_id='+group_id+'&modul_id='+modul_id);
                                    <?php }
                                ?>
                    ...
                    success: function(data) {   
                        ...
                        if(o.status == true) {
                            if(isUpload) {
                                ...
                                <?php 
                                if($upload!="upload_custom_grid"){ 
                                    echo $upload ?>('form_update_'+grid, grid, formAction, url+'&action=update&foreign_key=0&company_id='+company_id+'&id=<?php echo $ifor_id ?>&group_id='+group_id+'&modul_id='+modul_id);  
                                <?php
                                    }else{ ?>
                                        var formAction = url+"&action=uploadFile";
                                        formAction+='&isUpload=1';
                                        ...
                                        formAction+='&company_id='+o.company_id;
                                        formAction+='&isdraft='+isdraft;
                                        upload_custom_grid_mikro_fg('form_update_'+grid, grid, formAction, url+'&action=update&foreign_key=0&company_id='+company_id+'&id=<?php echo $ifor_id ?>&group_id='+group_id+'&modul_id='+modul_id);
                                    <?php }
                                ?>
                                ...
                                $.get(url+'&action=update&foreign_key=0&company_id='+company_id+'&id=<?php echo $ifor_id ?>&group_id='+group_id+'&modul_id='+modul_id, function(data) {
                                    $('div#form_'+grid).html(data);
                                    $('html, body').animate({scrollTop:$('#'+grid).offset().top - 20}, 'slow');
                                });
...
function upload_custom_grid_mikro_fg(formgrid, grid, formAction, url){
    var obj = $('#'+formgrid);
    var j=0;    
    var x=1;                       
