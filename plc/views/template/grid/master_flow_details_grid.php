...
$arrSearch=array('editi'=>'','vNama_modul'=>'Nama Modul','iUrut'=>'No Urut');
...
<script type="text/javascript">
    ...
    function addrow_<?php echo $nmTable; ?>(){
            ...
            var sa=[["<input type='hidden' class='num_rows_<?php echo $nmTable ?>' value='"+rlast+"' /><a href='javascript:;' onclick='javascript:hapus_row_<?php echo $nmTable ?>("+rlast+")'><center><span class='ui-icon ui-icon-close'></span></center></a>","<input type='text' size='35' id='<?php echo $grid ?>_vkode_text_"+rlast+"' class='autocomplate_flow_process required' name='<?php echo $grid ?>_vkode_text[0][]'><input type='hidden' size='10' class='required classiMmodul' id='<?php echo $grid ?>_vkode_"+rlast+"' name='<?php echo $grid ?>_vkode[0][]'>","<input type='text' size='5' id='<?php echo $grid ?>_iUrut_"+rlast+"' class='numbersOnly required' name='<?php echo $grid ?>_iUrut[0][]'>"]];
