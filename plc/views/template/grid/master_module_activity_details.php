...
$arrSearch=array('editi'=>'','iM_activity'=>'Aktivity','iType'=>'Type','vDept_assigned'=>'Departement','vNip_assigned'=>'NIP Assign','vFieldName'=>'Field Approval','vDesciption'=>'Keterangan','iSort'=>'No Urut');
$wsearch=array('editi'=>25,'iM_activity'=>200,'iSort'=>50,'iType'=>150,'vDept_assigned'=>100,'vNip_assigned'=>180,'vFieldName'=>180,'vDesciption'=>230);
$alsearch=array('editi'=>'center','iM_activity'=>'left');
...
<script type="text/javascript">
    ...
    function addrow_<?php echo $nmTable; ?>(){
            ...
            var sa=[["<input type='hidden' class='num_rows_<?php echo $nmTable ?>' value='"+rlast+"' /><a href='javascript:;' onclick='javascript:hapus_row_<?php echo $nmTable ?>("+rlast+")'><center><span class='ui-icon ui-icon-close'></span></center></a>","<select id='<?php echo $grid ?>_iM_activity_"+rlast+"' name='<?php echo $grid ?>_iM_activity[0][]'><?php echo $option ?></select>","<select id='<?php echo $grid ?>_iType_"+rlast+"' name='<?php echo $grid ?>_iType[0][]'><?php echo $option2 ?></select>","<input type='text' size='10' id='<?php echo $grid ?>_vDept_assigned_"+rlast+"' class='required' name='<?php echo $grid ?>_vDept_assigned[0][]'>","<input type='text' size='20 id='<?php echo $grid ?>_vNip_assigned_"+rlast+"' class='required' name='<?php echo $grid ?>_vNip_assigned[0][]'>","<input type='text' size='20 id='<?php echo $grid ?>_vFieldName_"+rlast+"' class='' name='<?php echo $grid ?>_vFieldName[0][]'>","<textarea id='<?php echo $grid ?>_vDesciption_"+rlast+"' class='required' name='<?php echo $grid ?>_vDesciption[0][]' size='250'></textarea>","<input type='text' size='3' id='<?php echo $grid ?>_iSort_"+rlast+"' class='numbersOnly required' name='<?php echo $grid ?>_iSort[0][]'>"]];
