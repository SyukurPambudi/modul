...
<table id="jqGrid_ck4" width="98%"></table>
...
$("#app_all_cek_4").change(function(){
    ...
    $(tr).find('input:checkbox.appr_cek_4').attr('checked',va);
    $(tr).find('input:checkbox.rev_cek_4').attr('checked',da);
});
$("#rev_all_cek_4").click(function(){
    va=false;
    da=false;
    if($(this).attr('checked')){
        va=true;
    ...
    tr=$(this).parent().parent().parent().next();
    $(tr).find('input:checkbox.rev_cek_4').attr('checked',va);
    $(tr).find('input:checkbox.appr_cek_4').attr('checked',da);
});
$(".appr_cek_4").change(function(){
    ceckcentang("appr_cek_4","app_all_cek_4","rev_all_cek_4")
});
$(".rev_cek_4").change(function(){
    ceckcentang("rev_cek_4","rev_all_cek_4","app_all_cek_4")
});
...
/*Modify Grid */
    ...
    $grid.jqGrid({
        url: '<?php echo base_url(); ?>processor/plc/kelengkapan/dokumen4/export?action=getdetailsdok&id=<?php echo $idossier_review_id ?>',
        datatype: "json",
        mtype:'GET',
        colNames: ['Modul','Sub Modul','Dokumen', 'Nilai Bobot Dokumen', 'Divisi', 'Tersedia','Belum Tersedia','Keterangan Review','Status Dokumen','Status Upload','Upload Dokumen','Revised','Approved','Keterangan Revision Analisa Dokumen','Revisi Oleh Dossier','Revised','Approved','Keterangan','Revisi Oleh IR','Revised','Approved','Keterangan','Revisi Oleh BDIRM','Revised','Approved','Keterangan'],
        colModel: [
            ...
            { label: 'Keterangan Revision Analisa Dokumen', name: 'vKeterangan_kelengkapan1'},                
            ...
            { label: 'Keterangan', name: 'vKeterangan_kelengkapan4'}               
        ],
        loadonce: true,
    ...
    $grid.jqGrid('setGroupHeaders',{
        ...
        groupHeaders:[
        {startColumnName:'istatusrev1', numberOfColumns:2, titleText:'Status Review'},
