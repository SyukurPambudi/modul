					...
					success: function(data) {	
						...
						if(o.status == true) {
							if(isUpload) {
								...
								uploadfile('form_create_'+grid, grid, formAction, base_url+'processor/plc/dossier/dokumen/td?action=update&id='+o.last_id+'&foreign_key='+o.foreign_id+'&company_id='+o.company_id+'&group_id='+o.group_id+'&modul_id='+o.modul_id);	
								...
								$.get(base_url+'processor/plc/dossier/dokumen/td?action=update&id='+o.last_id+'&foreign_key='+o.foreign_id+'&company_id='+o.company_id+'&group_id='+o.group_id+'&modul_id='+o.modul_id, function(data) {
		...
		custom_confirm(comfirm_message,function(){
			...
			.done(function(data) {
					...
					$('#grid_'+grid).trigger('reloadGrid');
						...
						$.get(base_url+'processor/plc/dossier/dokumen/td?action=update&id='+last_id+'&foreign_key='+foreign_id+'&company_id='+company_id+'&group_id='+group_id+'&modul_id='+modul_id, function(data) {
	                            $('div#form_'+grid).html(data);
	                           // $('html, body').animate({scrollTop:$('#'+grid).offset().top - 20}, 'slow');
...
function updateupload(grid, url, dis, urlpost) {
	var req = $('#form_update_'+grid+' input.required, #form_update_'+grid+' select.required, #form_update_'+grid+' textarea.required');
	var conf=0;
	var alert_message = '';
	//alert("test");
				...
				success: function(data) {
					...
					if(o.status == true){
						if(isUpload) {
							...
							uploadfile('form_update_'+grid, grid, formAction, base_url+'processor/plc/dossier/dokumen/td?action=update&id='+o.last_id+'&foreign_key='+o.foreign_id+'&company_id='+o.company_id+'&group_id='+o.group_id+'&modul_id='+o.modul_id);
...
function updatecek2(grid, url, dis, urlpost) {
	var req = $('#form_update_'+grid+' input.required, #form_update_'+grid+' select.required, #form_update_'+grid+' textarea.required');
	var conf=0;
	var alert_message = '';
	//alert("test");
				...
				success: function(data) {
					...
					if(o.status == true){
						if(isUpload) {
							...
							uploadfile('form_update_'+grid, grid, formAction, base_url+'processor/plc/dossier/dokumen/td?action=updatecek2&id='+o.last_id+'&foreign_key='+o.foreign_id+'&company_id='+o.company_id+'&group_id='+o.group_id+'&modul_id='+o.modul_id);
...
function updatecek3(grid, url, dis, urlpost) {
	var req = $('#form_update_'+grid+' input.required, #form_update_'+grid+' select.required, #form_update_'+grid+' textarea.required');
	var conf=0;
	var alert_message = '';
	//alert("test");
				...
				success: function(data) {
					...
					if(o.status == true){
						if(isUpload) {
							...
							uploadfile('form_update_'+grid, grid, formAction, base_url+'processor/plc/dossier/dokumen/td?action=updatecek3&id='+o.last_id+'&foreign_key='+o.foreign_id+'&company_id='+o.company_id+'&group_id='+o.group_id+'&modul_id='+o.modul_id);
...
function updatecek4(grid, url, dis, urlpost) {
	var req = $('#form_update_'+grid+' input.required, #form_update_'+grid+' select.required, #form_update_'+grid+' textarea.required');
	var conf=0;
	var alert_message = '';
	//alert("test");
				...
				success: function(data) {
					...
					if(o.status == true){
						if(isUpload) {
							...
							uploadfile('form_update_'+grid, grid, formAction, base_url+'processor/plc/dossier/dokumen/td?action=updatecek4&id='+o.last_id+'&foreign_key='+o.foreign_id+'&company_id='+o.company_id+'&group_id='+o.group_id+'&modul_id='+o.modul_id);
...
function accept(grid, url, dis, id){
	var ite = $("#dossier_dokumen_td_iTeam_sre").val();
	$("#dossier_dokumen_td_iTeam_sre").removeClass('error_text');
	if(ite==''){
		_custom_alert('Team SRE Required','Error!','info',grid, 1, 5000);
		 $("#dossier_dokumen_td_iTeam_sre").addClass('error_text');
		 return false;
	}else{
...
function accept_cek2(grid, url, dis, id){
	var ite = $("#dossier_dokumen_td_iTeam_sre").val();
	$("#dossier_dokumen_td_iTeam_sre").removeClass('error_text');
	if(ite==''){
		_custom_alert('Team SRE Required','Error!','info',grid, 1, 5000);
...
function accept_cek3(grid, url, dis, id){
	var ite = $("#dossier_dokumen_td_iTeam_sre").val();
	$("#dossier_dokumen_td_iTeam_sre").removeClass('error_text');
	if(ite==''){
		_custom_alert('Team SRE Required','Error!','info',grid, 1, 5000);
...
function accept_cek4(grid, url, dis, id){
	custom_confirm('Anda Yakin?',function(){
		$.ajax({
			url: url,
			type: 'post',
...
function update_draft_memo(grid, url, dis, isdraft, urlpost) {
	var req = $('#form_update_'+grid+' input.required, #form_update_'+grid+' select.required, #form_update_'+grid+' textarea.required');
	var conf=0;
	var alert_message = '';
	//alert("test");
...
function update_memo(grid, url, dis, isdraft, urlpost) {
	var req = $('#form_update_'+grid+' input.required, #form_update_'+grid+' select.required, #form_update_'+grid+' textarea.required');
	var conf=0;
	var alert_message = '';
	//alert("test");
