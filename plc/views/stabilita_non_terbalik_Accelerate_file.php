...
function add_row_stabilita_upload(table_id){		
		...
		if (n.length == 0) {
			...
			row_content	 += '<span class="delete_btn"><a href="javascript:;" class="stabilita_bb_del" onclick="ngilang(this, \'stabilita_bb_del\')">[Hapus]</a></span></td>';		
			row_content  += '</tr>';
	...
	<tbody>
				...
				<tr style="border: 1px solid #dddddd; border-collapse: collapse; background: #ffffff; ">
					...
					<td style="border: 1px solid #dddddd; width: 10%">
						<?php if ($this->input->get('action') != 'view') { ?>
							<span class="delete_btn"><a href="javascript:;" class="stabilita_bb_del" onclick="ngilang(this, 'stabilita_bb_del')">[Hapus]</a></span>	
						<?php	} ?>
		...
		<tr style="border: 1px solid #dddddd; border-collapse: collapse; background: #ffffff; ">
					...
					<td colspan="3" style="border: 1px solid #dddddd; width: 15%">
						<textarea class="required" id="filekt2"name="fileketerangan2[]" style="width: 240px; height: 50px;"size="250" required></textarea>
						<br/>
