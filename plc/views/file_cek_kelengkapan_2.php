...
<table id="jqGrid_ck2" width="98%"></table>
...
$("#app_all_cek_2").change(function(){
    ...
    $(tr).find('input:checkbox.appr_cek_2').attr('checked',va);
    $(tr).find('input:checkbox.rev_cek_2').attr('checked',da);
});
$("#rev_all_cek_2").click(function(){
    va=false;
    da=false;
    if($(this).attr('checked')){
        va=true;
    ...
    tr=$(this).parent().parent().parent().next();
    $(tr).find('input:checkbox.rev_cek_2').attr('checked',va);
    $(tr).find('input:checkbox.appr_cek_2').attr('checked',da);
});
$(".appr_cek_2").change(function(){
    ceckcentang("appr_cek_2","app_all_cek_2","rev_all_cek_2")
});
$(".rev_cek_2").change(function(){
    ceckcentang("rev_cek_2","rev_all_cek_2","app_all_cek_2")
});
...
/*Modify Grid */
    ...
    $grid.jqGrid({
        url: '<?php echo base_url(); ?>processor/plc/kelengkapan/dokumen2/export?action=getdetailsdok&id=<?php echo $idossier_review_id ?>',
        datatype: "json",
        mtype:'GET',
        ...
        colModel: [
            ...
            { label: 'Revisi Oleh Dossier', name: 'rev_dossier'},                
   ...
   $("#jqGrid_ck2").jqGrid("setFrozenColumns");
