...
$("#<?php echo $tableId;?> .file_remove").click(function(){
	...
	var tmpDel = $("#soi_mikro_final_del");
	li.remove();
	var v = tmpDel.val();
	v+=','+fileid;
	tmpDel.val( v );
	alert( $("#soi_mikro_final_del").val() );
});

function del_upload_soi_mikro_final(dis, conname, table_id) {
	if($('.'+conname).length > 1) {
		...
		var n = $("span."+table_id+"_num:last").text();
			...
			row_content	 += '<span class="delete_btn"><a href="javascript:;" class="soi_mikro_final_del" onclick="del_upload_soi_mikro_final(this, \'soi_mikro_final_del\', \'soi_mikro_final\')">[Hapus]</a></span></td>';		
			row_content  += '</tr>';
...
<table class="hover_table" id="soi_mikro_final" cellspacing="0" cellpadding="1" style="width: 98%; border: 1px solid #dddddd; text-align: center; margin-left: 5px; border-collapse: collapse">
	<thead>
	...
	<tbody>
		...
		if(in_array('QA', $mydept)) {
			...
			$value = $row['filename'];
			$path = "rpt_soi_mikro_final";	
			if($value != '') {
				if (file_exists('./files/plc/local/soi_mikro_bb_final/rpt_soi_mikro_final/'.$iuji_mikro_bb.'/'.$value)) {
					$link = base_url().'processor/plc/soi/mikro/bb/final?action=download&id='.$iuji_mikro_bb.'&path='.$path.'&file='.$value;
		...
		?>
				<tr style="border: 1px solid #dddddd; border-collapse: collapse; background: #ffffff; ">
					<td style="border: 1px solid #dddddd; width: 3%; text-align: center;">
						<span class="soi_mikro_final_num"><?php echo $i ?></span>
					</td>		
					...
					<td style="border: 1px solid #dddddd; width: 10%">
						<span class="delete_btn"><a href="javascript:;" class="soi_mikro_final_del" onclick="del_upload_soi_mikro_final(this, 'soi_mikro_final_del', 'soi_mikro_final')">[Hapus]</a></span>
		...
		<tr style="border: 1px solid #dddddd; border-collapse: collapse; background: #ffffff; ">
					<td style="border: 1px solid #dddddd; width: 3%; text-align: center;">
						<span class="soi_mikro_final_num">1</span>
					</td>		
					<td colspan="2" style="border: 1px solid #dddddd; width: 27%">
	...
	<tfoot>
		<tr>
			<td colspan="5"></td><td style="text-align: center"><a href="javascript:;" onclick="javascript:add_row_upload_kimiawi('soi_mikro_final')">Tambah</a></td>
		</tr>
	</tfoot>
</table>