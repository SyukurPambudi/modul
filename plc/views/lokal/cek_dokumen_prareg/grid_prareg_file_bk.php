...
$arrSearch=array('iconfirm'=>'Confirm','istatus'=>'Status','ijenisbk'=>'Jenis BK','vFilename'=>'File Name','vKeterangan'=>'Keterangan','iact'=>'Action');
$wsearch=array('iconfirm'=>180,'istatus'=>80,'vFilename'=>280,'vKeterangan'=>280,'iact'=>100,'ijenisbk'=>200);
$alsearch=array('iact'=>'center','iconfirm'=>'center','istatus'=>'center','ijenisbk'=>'center');
?>
...
/*Modify Grid */
   ...
   jQuery("#<?php echo $nmTable ?>").jqGrid('gridResize',{minWidth:300,maxWidth:1305,minHeight:80, maxHeight:370}).navGrid('#<?php echo $pager; ?>',{edit:false,add:false,del:false,search:false,refresh:false}).jqGrid('setGridWidth','975')
   <?php 
    if($ddd!=0){
    ...
    function addrow_detail_bd_files_<?php echo $id ?>_edit(){
        ...
        opt2+="<?php echo $opt2; ?>";
        opt2+="</select>";
        var opt3="<select id='cek_dokumen_prareg_<?php echo $id ?>_ijenis_bk_id_"+rlast+"' name='cek_dokumen_prareg_<?php echo $id ?>_ijenis_bk_id[0][]>";
        opt3+="<?php echo $opt3; ?>";
        opt3+="</select>";
        var sa=[[opt,opt2,opt3,"<input type='file' id='fileupload_local_<?php echo $id ?>_"+rlast+"' class='fileupload multi multifile required' name='fileupload_local_<?php echo $id ?>[]' style='width: 90%' />","<textarea id='file_keterangan_local_<?php echo $id ?>_"+rlast+"' name='file_keterangan_local_<?php echo $id ?>[]' style='width: 240px; height: 50px;'></textarea>","<input type='hidden' class='num_rows_details_file_<?php echo $id ?>_edit' value='"+rlast+"' /><button id='ihapus_<?php echo $nmTable ?>' class='ui-button-text icon_hapus' style='width:75px' onclick='javascript:hapus_row_details_file_<?php echo $id ?>_edit("+rlast+")' type='button'>Hapus</button>"]];
        var lastr=jQuery("#<?php echo $nmTable; ?>").jqGrid('getGridParam', 'records');
        var names = ["iconfirm","istatus","ijenisbk","vFilename", "vKeterangan", "iact"];
        mydata=[];
