...
$nmmodule='plc';
$actiondata='getDataFileUpload';
$caption=isset($caption)?$caption:"File Upload";
$grid_detail=isset($grid_detail)?$grid_detail:"details";
$isubmit=isset($isubmit)?$isubmit:0;

$arrSearch=array('upload_file'=>'Nama File','vket'=>'Keterangan','action'=>'Action');
$wsearch=array('upload_file'=>250,'vket'=>300,'action'=>150);
...
$g=implode("&", $in);
$g=$g."&isubmit=".$isubmit."&filejenis=".$grid_detail;
...
<script type="text/javascript">
    ...
    function addrow_<?php echo $nmTable; ?>(){
            ...
            var sa=[["<input type='hidden' class='num_rows_<?php echo $nmTable ?>' value='"+rlast+"' /><input type='file' id='<?php echo $grid; ?>_upload_file_"+rlast+"' class='fileupload1 multi multifile required' name='<?php echo $grid; ?>_upload_file[]' style='width: 90%' /> *","<textarea class='' id='<?php echo $grid; ?>_fileketerangan_"+rlast+"' name='<?php echo $grid; ?>_fileketerangan[]' style='width: 290px; height: 50px;' size='290'></textarea>", "<button id='ihapus_<?php echo $nmTable ?>' class='ui-button-text icon_hapus' style='font-size: .8em !important;' onclick='javascript:hapus_row_<?php echo $nmTable ?>("+rlast+")' type='button'>Hapus</button><input type='hidden' name='product_trial_produksi_pilot_id_pk_<?php echo $grid_detail ?>[]' value='0' />"]];
