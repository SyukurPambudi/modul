...
<script>
	function del_row12(dis, conname) {
...
<table class="hover_table" id="dok_td_upload" cellspacing="0" cellpadding="1" style="width: 98%; border: 1px solid #dddddd; text-align: center; margin-left: 5px; border-collapse: collapse">
	...
	<tr style="width: 98%; border: 1px solid #dddddd; background: #548cb6; border-collapse: collapse">
		<th colspan="4" style="border: 1px solid #dddddd;"><span style="font-weight: bold; color: #ffffff; text-shadow: 0 1px 1px rgba(0, 0, 0, 0.3); text-transform: uppercase;">Upload Dokumen Tambahan</span></th>
	</tr>
	<tr style="width: 100%; border: 1px solid #dddddd; background: #b3d2ea; border-collapse: collapse">
		<th style="border: 1px solid #dddddd; width: 5%;" >No</th>
		<th colspan="1" style="border: 1px solid #dddddd; width: 45%;">Nama Dokumen</th>
		<th colspan="1" style="border: 1px solid #dddddd; width: 45%;">Pilih File</th>
		...
		?>
				<tr style="border: 1px solid #dddddd; border-collapse: collapse; background: #ffffff; ">
					<td style="border: 1px solid #dddddd; width: 3%; text-align: center;">
						...
						<input type="hidden" name="idossier_dok_td_detail_id[]" style="width: 70%" value="<?php echo $row['idossier_dok_td_detail_id'] ?>" />
						<input type="hidden" name="td_detail_id[]" style="width: 70%" value="<?php echo $row['idossier_dok_td_detail_id'] ?>" />
					</td>		
					...
					<td style="border: 1px solid #dddddd; width: 10%">
						<?php if ($this->input->get('action') != 'view') { ?>
							<?php 
								if (isset($mydept)) {
									if((in_array('SR', $mydept))) {
										if ( $row['vFilename'] != "" ) {
											?>
												<span class="delete_btn"><a href="javascript:;" class="brosur_bb_del" onclick="del_row12(this, 'brosur_bb_del')">[Hapus]</a></span>	
											<?php

										}else{
											?>
												<span class="delete_btn"><a href="javascript:;" class="brosur_bb_del" onclick="del_row13(this, 'brosur_bb_del')">[Hide]</a></span>						
											<?php
										}
