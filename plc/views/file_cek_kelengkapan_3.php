...
<table id="jqGrid_ck3" width="98%"></table>
...
$("#app_all_cek_3").change(function(){
    ...
    $(tr).find('input:checkbox.appr_cek_3').attr('checked',va);
    $(tr).find('input:checkbox.rev_cek_3').attr('checked',da);
});
$("#rev_all_cek_3").click(function(){
    va=false;
    da=false;
    if($(this).attr('checked')){
        va=true;
    ...
    tr=$(this).parent().parent().parent().next();
    $(tr).find('input:checkbox.rev_cek_3').attr('checked',va);
    $(tr).find('input:checkbox.appr_cek_3').attr('checked',da);
});
$(".appr_cek_3").change(function(){
    ceckcentang("appr_cek_3","app_all_cek_3","rev_all_cek_3")
});
$(".rev_cek_3").change(function(){
    ceckcentang("rev_cek_3","rev_all_cek_3","app_all_cek_3")
});
...
/*Modify Grid */
    ...
    $grid.jqGrid({
        url: '<?php echo base_url(); ?>processor/plc/kelengkapan/dokumen3/export?action=getdetailsdok&id=<?php echo $idossier_review_id ?>',
        datatype: "json",
        mtype:'GET',
        ...
        colModel: [
            ...
            { label: 'Revisi Oleh IR', name: 'rev_ir'},                
