...
<br>
<label class="lbl_detail">Detail Semua Data UPB </label>
<table class='tb_det'>
	<thead>
		<tr>
			<th>No</th>
...
<label class="lbl_detail">Jumlah UPB Memenuhi Syarat : <?php echo $pembilang ?> UPB</label><br>
<label class="lbl_detail">Jumlah UPB : <?php echo $penyebut; ?></label><br>
<label class="lbl_detail">Rata - Rata  : <?php echo $rat ?> </label>