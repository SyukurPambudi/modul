...
?>
<label class="lbl_detail">Team Marketing : <?php echo $ni; ?></label><br>
<label class="lbl_detail">Rata - Rata  : <?php echo ($c/$cc) ?> </label>