<?php
	...
	foreach ($dkat as $k) {
		...
		$naspek=array_sum($n);
		$s=floatval($k["bobot"])*floatval($naspek);
		$ni[]=$s;
		$o.='<tr>';
		$o.='<td>'.$k["kategori"].'</td>';
...
<script type="text/javascript">
	...
	$('#submit_draft_tab_last_atasan').live('click',function(){
		$.ajax({
			url: base_url+'processor/pk/pk_ts?action=updatenote_ats',
			type: 'post',
			...
			success: function(data) {
				...
				$.get(base_url+'processor/pk/pk/ts?action=update&foreign_key=0&company_id='+company_id+'&idnya='+o.last_id+'&id='+o.last_id+'&group_id='+group_id+'&modul_id='+modul_id, function(data) {
