...
<thead>
	...
	<tr>
		...
		<td><?php
			if(!empty($datacount['t_Mark'])){ 
				echo $datacount['t_Mark']; 
				$rat = $tot_upb/$datacount['t_Mark'];
				if($datacount['t_Mark']==0){
					$rat = 0;
				}
			}else{
				$rat = 0;
...
<br>
<label class="lbl_detail">Rata - rata (Jumlah UPB / Jumlah Groub Marketing) : <?php echo number_format( $rat, 2, '.', '' ); ?> per divisi </label>