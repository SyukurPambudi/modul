...
<table class='tb_det'>
	...
	<tbody>
			...
			foreach ($dataall as $kall => $vall) {
				...
				echo "<td>".$vall['dsubmit_dok']."</td>";  

				$timeEnd = strtotime($vall['dinput_applet']);
				$timeStart = strtotime($vall['dsubmit_dok']);
...
<br>
<label class="lbl_detail">Rata - rata (Total Selisih / Jumlah UBP B) : <?php echo number_format( $rat, 2, '.', '' ); ?> Bulan</label>