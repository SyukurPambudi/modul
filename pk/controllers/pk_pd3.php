<?php if ( ! defined('BASEPATH')) exit('No direct script access allowed');
    class pk_pd3 extends MX_Controller {
  private $sess_auth;
  private $db_erp_pk;
    ...
    /*$skemaPK = $this->lib_utilitas->getSysParam('SKEMA_PK_PD3_MANAGER'); 
    $DIV_PK_PD3 = $this->lib_utilitas->getSysParam('DIV_PK_PD3');

    $grid->setQuery('hrd.employee.iDivisionID in ('.$DIV_PK_PD3.')',null);
    ...
    function saveSupportData(){
      ...
      switch ($parameter) {
        case 'PD3_getParameter6':
          $this->savePD3_getParameter6($_POST);
          break;

        case 'PD3_getParameter7':
          $this->savePD3_getParameter7($_POST);
          break;
    ...
    function savePD3_getParameter6($post){
    ...
    function savePD3_getParameter7($post){
      $iPkTransId = $post['_iPkTransId'];
      $iAspekId   = $post['_iAspekId'];
      $suport_data = $post['klaim_bulan'];
    ...
    function supportData(){
      ...
      switch ($vFunctionLink) {
        case 'PD3_getParameter6':
            $html .= $this->load->view('pd/support_data/PD3_getParameter6',$data, TRUE);
          break;

        case 'PD3_getParameter7':
            $html .= $this->load->view('pd/support_data/PD3_getParameter7',$data, TRUE);
          break;
    ...
    function SaveHasil(){
      ...
      $vEvaKry      = $_POST['pk_pd3_vEvaKry'];
      $vRencana     = $_POST['pk_pd3_vRencana'];
      $vEvaAtasan   = $_POST['pk_pd3_vEvaAtasan'];
      $vSaranAtasan = $_POST['pk_pd3_vSaranAtasan'];
      $vPelatihan   = $_POST['pk_pd3_vPelatihan'];
      

      if (isset($_POST['pk_create_mekanik_engine_iRencana'])){
          $iRencana     = $_POST['pk_pd3_iRencana'];
      }else{
          $iRencana = '';
      }

      $iDivIdTo     = $_POST['pk_pd3_iDivIdTo'];
      $iPostIdTo     = $_POST['pk_pd3_iPostIdTo'];
      $vPertimbangan = $_POST['pk_pd3_vPertimbangan'];
      $nFinal        = $_POST['pk_pd3_nFinal'];
    ...
    function uploadproses(){
      ...
      $files = $_FILES;
      $realname = $files["pk_pd3_lampiran"]["name"];
      $newName= "PK_".$id."_".$realname;
      $newName =  str_replace("/", "_", $newName);
      $upload_dir = "files/hdsystem/".$newName;

      move_uploaded_file($files["pk_pd3_lampiran"]["tmp_name"], $upload_dir);
    ...
    function cekJabatan(){
        ...
        $x_jabpk = explode(",", $this->lib_utilitas->getSysParam('JABATAN_PK_PD3_MGR'));
    ...
    function proses_reject(){
      ...
      $sql    = "SELECT cNip FROM hrd.pk_pd3 
      ...
      $sql = "INSERT INTO hrd.pk_pd3 (iSkemaId,cNip,iStatus,vReason,dDate,iUlang,lDeleted,tCreated,cCreatedBy) VALUES
    ...
    public function listbox_pk_pd3_dPk($value, $id,$field,$rowData) {
    ...
    public function listbox_pk_pd3_iPostId($value, $id,$field,$rowData) {
      $vDescription = $value;
    ...
    public function insertbox_pk_pd3_iPostId($field, $id) {
    ...
    public function updatebox_pk_pd3_iPostId($field, $id,$value,$data) {
    ...
    public function insertbox_pk_pd3_cNip($field, $id) {
      $cNip        =  $this->sess_auth->gNIP;
      $vDescription = $cNip." - ".$this->lib_utilitas->getvName($cNip);

      $url = $this->url;
      $url6 = base_url().'processor/pk/pk/pd3?action=searchcNip';
      $url2 = base_url().'processor/pk/pk/pd3?action=searchSkema';
      $url3 = base_url().'processor/pk/pk/pd3?action=cekJabatan';
      ...
      $o = "<script type='text/javascript'>
              $(document).ready(function() {
                ...
                var akses = cekJabatan('pk_pd3_iSkemaId', '".$iPostId."');
                if (akses=='TIDAK'){
                ...
                loadSkema('pk_pd3_iSkemaId', '".$iPostId."');
                ...
                var config = {
                  ...
                  select: function(event, ui){
                    ...
                    loadSkema('pk_pd3_iSkemaId', ui.item.iPostId);
    ...
    public function updatebox_pk_pd3_cNip($field, $id,$value,$data) {
      $cNip         =  $value;
      $vDescription = $cNip." - ".$this->lib_utilitas->getvName($cNip);
      $url = $this->url;
      $url6 = base_url().'processor/pk/pk/pd3?action=searchcNip';
    ...
    public function insertbox_pk_pd3_cTahun($field, $id) {
      $year = date('Y');
      $y1 = $year - 5;
      $y2 = $year + 5;
    ...
    public function updatebox_pk_pd3_cTahun($field, $id,$value,$data) {
      $year = $value;
    ...
    public function insertbox_pk_pd3_cPeriode($field, $id) {
    ...
    public function updatebox_pk_pd3_cPeriode($field, $id,$value,$data) {
    ...
    public function insertbox_pk_pd3_iSemester($field, $id) {
      
      $url2 = base_url().'processor/pk/pk/pd3?action=cekDataPk';
      $url  = base_url()."processor/pk/pk/pd3?company_id=".$this->input->get('company_id')."&group_id=".$this->input->get('group_id')."&modul_id=".$this->input->get('modul_id');
    ...
    public function updatebox_pk_pd3_iSemester($field, $id,$value,$data) {
      $sms = array(''=>'',1=>1,2=>2);
    ...
    public function insertbox_pk_pd3_dPk($field, $id) {
      $now = date('d-m-Y');
    ...
    public function updatebox_pk_pd3_dPk($field, $id,$value,$data) {
    ...
    public function insertbox_pk_pd3_iProbation($field, $id) {
    ...
    public function updatebox_pk_pd3_iProbation($field, $id,$value,$data) {
      //1=PK Probation, tahun dan semester bisa dikosongkan.
    ...
    public function insertbox_pk_pd3_lampiran($field, $id) {
    ...
    public function updatebox_pk_pd3_lampiran($field, $id,$value,$data) {
      $action = $this->input->get('action');
      $idnya = $data['id'];
      $url = base_url().'processor/pk/pk/pd3?action=uploadproses&id='.$idnya;
      $urlhapus = base_url().'processor/pk/pk/pd3?action=hapus';
      $urlgetLampiran = base_url().'processor/pk/pk/pd3?action=getLampiran';
      $o = '';  
      $o .= '<style>
  ...
  public function insertbox_pk_pd3_iSkemaId($field, $id) {
    ...
    public function updatebox_pk_pd3_iSkemaId($field, $id,$value,$data) {
      $iPostId = $data['iPostId'];
      $url = base_url().'processor/pk/pk/pd3?action=getDetail';
  ...
  public function insertbox_pk_pd3_detail($field, $id) {
...
border: 1px solid aquamarine;' >
  ...
  public function updatebox_pk_pd3_detail($field, $id,$value,$data) {
    $idnya      = $data['iSkemaId'];
    $iPkTransId = $data['id'];
    $cNip       = $data['cNip'];
  ...
  public function updatebox_pk_pd3_Approval($field, $id,$value,$data) {
    $id = $data['id'];
   $o = '<div class="box_cbox">
    ...
    $sql = "SELECT cNip,iStatus,vReason,dDate 
          FROM hrd.pk_pd3 WHERE iSkemaId='".$id."' ORDER BY id ASC";
  ...
  public function manipulate_update_button($button,$rowData) {  
    ...
    $cNipNya = $rowData['cNip'];
      ...
      $btnSave .= "<button type='button'
                ...
                onclick='javascript:update_btn_back_".$this->url."(\"".$this->url."\", \"".base_url()."processor/pk/pk/pd3?company_id=".$this->input->get('company_id')."&group_id=".$this->input->get('group_id')."&modul_id=".$this->input->get('modul_id')."\", this)'>Update 
                </button>";


      $urlsumbit  = base_url().'processor/pk/pk/pd3?action=proses_approve';
      ...
      $btnSubmit .= "<button type='button'
                ...
                id='button_update_".$this->url."'
                class='icon-save ui-button'
                onclick='javascript:btn_submit_".$this->url."(\"".$this->url."\", \"".base_url()."processor/pk/pk/pd3?company_id=".$this->input->get('company_id')."&group_id=".$this->input->get('group_id')."&modul_id=".$this->input->get('modul_id')."\", this)'>Sumbit 
                </button>";
      ...
      $btnApprove .= "<button type='button'
                ...
                id='button_update_".$this->url."'
                class='icon-save ui-button'
                onclick='javascript:btn_submit_".$this->url."(\"".$this->url."\", \"".base_url()."processor/pk/pk/pd3?company_id=".$this->input->get('company_id')."&group_id=".$this->input->get('group_id')."&modul_id=".$this->input->get('modul_id')."\", this)'>Approve 
                </button>";
      ...
      $btn_preview  = '
                      <script type="text/javascript">
                        ...
                        function print_'.$this->url.'() {
                          ...
                          document.getElementById("iframe_preview_ga_'.$this->url.'").src = "'.base_url().'processor/pk/pk/pd3?action=get_preview_report&id="+id+"&vName="+vName;
  ...
  public function manipulate_insert_button($button) {
    ...
    $btnSave  =  "<script type='text/javascript'>               
        ...
        $btnSave .= "<button type='button'
                            ...
                            class='icon-save ui-button'
                            onclick='javascript:save_btn_back_".$this->url."(\"".$this->url."\", \"".base_url()."processor/pk/pk/pd3?company_id=".$this->input->get('company_id')."&group_id=".$this->input->get('group_id')."&modul_id=".$this->input->get('modul_id')."\", this)'>Save
                            </button>";
    $button['save'] = $btnSave;
...
/*
    ...
    $html .= ' </tbody>
     ...
     $urlSD = base_url().'processor/pk/pk/pd3?action=supportData';
     $urlgetValuePk = base_url().'processor/pk/pk/pd3?action=getValuePk';
     $urlDetail = base_url().'processor/pk/pk/pd3?action=showDetail';
     $url = base_url().'processor/pk/pk/pd3?action=SaveNilai';
     $rUrl = base_url()."processor/pk/pk/pd3?company_id=".$this->input->get('company_id')."&group_id=".$this->input->get('group_id')."&modul_id=".$this->input->get('modul_id');

     $html .= "<script>

      $(document).ready(function() {
        $('.pk_pd3_nPointSepakat').autoNumeric('init', {vMin:'0', vMax:'100'});
     
      });

      $('.pk_pd3_nPointSepakat').live('keyup', function() {                
        var ix = $('.pk_pd3_nPointSepakat').index($(this));
      ...
      $('.pk_pd3_nPointSepakat').live('blur', function() {  
            var ix = $('.pk_pd3_nPointSepakat').index($(this));
      ...
      function ".$this->url."_hitungPk(vFunctionLink,iAspekId,tampil,bobot){
          ...
          document.getElementById('vDescription_pk_pd3_'+iAspekId+'_100').style.backgroundColor='#ffffff';
          document.getElementById('vDescription_pk_pd3_'+iAspekId+'_80').style.backgroundColor='#ffffff';
          document.getElementById('vDescription_pk_pd3_'+iAspekId+'_60').style.backgroundColor='#ffffff';
          document.getElementById('vDescription_pk_pd3_'+iAspekId+'_40').style.backgroundColor='#ffffff';
          document.getElementById('vDescription_pk_pd3_'+iAspekId+'_20').style.backgroundColor='#ffffff';

          document.getElementById('vDescription_pk_pd3_'+iAspekId+'_'+point).style.backgroundColor = color;
      ...
      function ".$this->url."_getValuePk(vFunctionLink,iAspekId){
        ...
        var nip = $('#pk_pd3_cNip').val();
        var dPeriode1 = $('#pk_pd3_dPeriode1').val();
        var dPeriode2 = $('#pk_pd3_dPeriode2').val();
        return $.ajax({
            type: 'POST', 
            url: '".$urlgetValuePk."',
  ...
  function generateHasilAkhir($iPkTransId,$cNip,$rowData){
    ...
    $urlHasil = base_url().'processor/pk/pk/pd3?action=SaveHasil';
    $rUrl = base_url()."processor/pk/pk/pd3?company_id=".$this->input->get('company_id')."&group_id=".$this->input->get('group_id')."&modul_id=".$this->input->get('modul_id');
    ...
    $html .= "<script>
                ...
                $(document).ready(function() {  
                  $('#pk_pd3_iDivIdTo').change(function() {
                      groupdeptid = getGroupDeptId($(this).val());
                      loadDataJbt('pk_pd3_iPostIdTo', groupdeptid, groupdeptid);
  ...
  public function searchcNip() {
    ...
    $data = array();
    $divGa = $this->lib_utilitas->getSysParam('DIV_PK_PD3');
    $jabatan  =  $this->lib_utilitas->getSysParam("JABATAN_PK_PD3_MGR");
  ...
  function getDetail(){
      ...
      $html .= "<script>
                  $(document).ready(function() {
                    ...
                    $('.pk_pd3_nResult').autoNumeric('init', {vMin:'0', vMax:'100.00'});
                  });


                  $('.pk_pd3_nResult').live('keyup', function() {            
                    var ix = $('.pk_pd3_nResult').index($(this));
                    
                    var sisa_sblm   = 0;
                    var result  = $('.pk_pd3_nResult').eq(ix).val();
                    var bobot   = $('.pk_pd3_nBobot').eq(ix).val();
                    var nilai   = parseFloat((result * bobot) / 100);

                    $('.pk_pd3_nNilai').eq(ix).val(nilai.toFixed(2));
                    $('.nama_pk_pd3_nNilai').eq(ix).html(nilai.toFixed(2));
                  ...
                  function sum_".$this->url."(){
                    ...
                    $('.pk_pd3_nResult').each(function() {
                      if ($('.pk_pd3_nResult').eq(i).val() != '') {        
                        total += parseFloat($('.pk_pd3_nNilai').eq(i).val());
                    ...
                    $('#pk_pd3_jumlah').html(total.toFixed(2));
                    $('#pk_pd3_nFinal').val(total.toFixed(2));
...
FROM hrd.pk_pkresult AS a WHERE a.iPkTransId='".$iPkTransId."' ";
    ...
    function getValuePk(){
      ...
      $this->lib_pk_pd3->$vFunctionLink($_POST);
    }
