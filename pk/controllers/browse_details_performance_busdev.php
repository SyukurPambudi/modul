...
class browse_details_performance_busdev extends MX_Controller {
    ...
    public function SDMPERFORMANCE_1($imaster_id){
        ...
        $sqlmain = "Select a.id, a.problem_subject, a.iSizeProject, a.dclosePm  
    ...
    public function SDMPERFORMANCE_2($imaster_id){
        ...
        $sqlmain = 
                "Select a.id, a.problem_subject, a.iSizeProject, date(a.dclosePm) dclosePm ,
