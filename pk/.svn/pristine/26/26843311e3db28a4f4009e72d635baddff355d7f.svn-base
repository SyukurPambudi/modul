...
<script type="text/javascript"> 
  ...
  function save_data_pendukung(iAspekId,iPkTransId){
    ...
    $.ajax({
     type: 'POST',
     url: url,
     data: $('#input_support_data_PD1_getParameter7').serialize()+'&_parameter=PD1_getParameter7&_iPkTransId='+iPkTransId+'&_iAspekId='+iAspekId,
...
<form id='input_support_data_PD1_getParameter7' >
