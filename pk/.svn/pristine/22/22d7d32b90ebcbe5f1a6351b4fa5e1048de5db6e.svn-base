<?php if ( ! defined('BASEPATH')) exit('No direct script access allowed');
    class pk_ad extends MX_Controller {
  private $sess_auth;
  private $db_erp_pk;
    ...
    /*$skemaPK = $this->lib_utilitas->getSysParam('SKEMA_PK_AD_MANAGER');

    $DIV_PK_AD = $this->lib_utilitas->getSysParam('DIV_PK_AD');
    $grid->setQuery('hrd.employee.iDivisionID in ('.$DIV_PK_AD.')',null);
    ...
    function SaveHasil(){
      ...
      $vEvaKry      = $_POST['pk_ad_vEvaKry'];
      $vRencana     = $_POST['pk_ad_vRencana'];
      $vEvaAtasan   = $_POST['pk_ad_vEvaAtasan'];
      $vSaranAtasan = $_POST['pk_ad_vSaranAtasan'];
      $vPelatihan   = $_POST['pk_ad_vPelatihan'];
      

      if (isset($_POST['pk_create_mekanik_engine_iRencana'])){
          $iRencana     = $_POST['pk_ad_iRencana'];
      }else{
          $iRencana = '';
      }

      $iDivIdTo     = $_POST['pk_ad_iDivIdTo'];
      $iPostIdTo     = $_POST['pk_ad_iPostIdTo'];
      $vPertimbangan = $_POST['pk_ad_vPertimbangan'];
      $nFinal        = $_POST['pk_ad_nFinal'];
    ...
    function uploadproses(){
      ...
      $files = $_FILES;
      $realname = $files["pk_ad_lampiran"]["name"];
      $newName= "PK_".$id."_".$realname;
      $newName =  str_replace("/", "_", $newName);
      $upload_dir = "files/hdsystem/".$newName;

      move_uploaded_file($files["pk_ad_lampiran"]["tmp_name"], $upload_dir);
    ...
    function cekJabatan(){
        ...
        $x_jabpk = explode(",", $this->lib_utilitas->getSysParam('JABATAN_PK_AD_MGR'));
    ...
    function proses_reject(){
      ...
      $sql    = "SELECT cNip FROM hrd.pk_ad 
      ...
      $sql = "INSERT INTO hrd.pk_ad (iSkemaId,cNip,iStatus,vReason,dDate,iUlang,lDeleted,tCreated,cCreatedBy) VALUES
    ...
    public function listbox_pk_ad_dPk($value, $id,$field,$rowData) {
    ...
    public function listbox_pk_ad_iPostId($value, $id,$field,$rowData) {
      $vDescription = $value;
    ...
    public function insertbox_pk_ad_iPostId($field, $id) {
    ...
    public function updatebox_pk_ad_iPostId($field, $id,$value,$data) {
    ...
    public function insertbox_pk_ad_cNip($field, $id) {
      $cNip        =  $this->sess_auth->gNIP;
      $vDescription = $cNip." - ".$this->lib_utilitas->getvName($cNip);

      $url = $this->url;
      $url6 = base_url().'processor/pk/pk/ad?action=searchcNip';
      $url2 = base_url().'processor/pk/pk/ad?action=searchSkema';
      $url3 = base_url().'processor/pk/pk/ad?action=cekJabatan';
      ...
      $o = "<script type='text/javascript'>
              $(document).ready(function() {
                ...
                var akses = cekJabatan('pk_ad_iSkemaId', '".$iPostId."');
                if (akses=='TIDAK'){
                ...
                loadSkema('pk_ad_iSkemaId', '".$iPostId."');
                ...
                var config = {
                  ...
                  select: function(event, ui){
                    ...
                    loadSkema('pk_ad_iSkemaId', ui.item.iPostId);
    ...
    public function updatebox_pk_ad_cNip($field, $id,$value,$data) {
      $cNip         =  $value;
      $vDescription = $cNip." - ".$this->lib_utilitas->getvName($cNip);
      $url = $this->url;
      $url6 = base_url().'processor/pk/pk/ad?action=searchcNip';
    ...
    public function insertbox_pk_ad_cTahun($field, $id) {
      $year = date('Y');
      $y1 = $year - 5;
      $y2 = $year + 5;
    ...
    public function updatebox_pk_ad_cTahun($field, $id,$value,$data) {
      $year = $value;
    ...
    public function insertbox_pk_ad_cPeriode($field, $id) {
    ...
    public function updatebox_pk_ad_cPeriode($field, $id,$value,$data) {
    ...
    public function insertbox_pk_ad_iSemester($field, $id) {
      
      $url2 = base_url().'processor/pk/pk/ad?action=cekDataPk';
      $url  = base_url()."processor/pk/pk/ad?company_id=".$this->input->get('company_id')."&group_id=".$this->input->get('group_id')."&modul_id=".$this->input->get('modul_id');
    ...
    public function updatebox_pk_ad_iSemester($field, $id,$value,$data) {
      $sms = array(''=>'',1=>1,2=>2);
    ...
    public function insertbox_pk_ad_dPk($field, $id) {
      $now = date('d-m-Y');
    ...
    public function updatebox_pk_ad_dPk($field, $id,$value,$data) {
    ...
    public function insertbox_pk_ad_iProbation($field, $id) {
    ...
    public function updatebox_pk_ad_iProbation($field, $id,$value,$data) {
      //1=PK Probation, tahun dan semester bisa dikosongkan.
    ...
    public function insertbox_pk_ad_lampiran($field, $id) {
    ...
    public function updatebox_pk_ad_lampiran($field, $id,$value,$data) {
      $action = $this->input->get('action');
      $idnya = $data['id'];
      $url = base_url().'processor/pk/pk/ad?action=uploadproses&id='.$idnya;
      $urlhapus = base_url().'processor/pk/pk/ad?action=hapus';
      $urlgetLampiran = base_url().'processor/pk/pk/ad?action=getLampiran';
      $o = '';  
      $o .= '<style>
  ...
  public function insertbox_pk_ad_iSkemaId($field, $id) {
    ...
    public function updatebox_pk_ad_iSkemaId($field, $id,$value,$data) {
      $iPostId = $data['iPostId'];
      $url = base_url().'processor/pk/pk/ad?action=getDetail';
  ...
  public function insertbox_pk_ad_detail($field, $id) {
...
border: 1px solid aquamarine;' >
  ...
  public function updatebox_pk_ad_detail($field, $id,$value,$data) {
    $idnya      = $data['iSkemaId'];
    $iPkTransId = $data['id'];
    $cNip       = $data['cNip'];
  ...
  public function updatebox_pk_ad_Approval($field, $id,$value,$data) {
    $id = $data['id'];
   $o = '<div class="box_cbox">
    ...
    $sql = "SELECT cNip,iStatus,vReason,dDate 
          FROM hrd.pk_ad WHERE iSkemaId='".$id."' ORDER BY id ASC";
  ...
  public function manipulate_update_button($button,$rowData) {  
    ...
    $cNipNya = $rowData['cNip'];
      ...
      $btnSave .= "<button type='button'
                ...
                onclick='javascript:update_btn_back_".$this->url."(\"".$this->url."\", \"".base_url()."processor/pk/pk/ad?company_id=".$this->input->get('company_id')."&group_id=".$this->input->get('group_id')."&modul_id=".$this->input->get('modul_id')."\", this)'>Update 
                </button>";


      $urlsumbit  = base_url().'processor/pk/pk/ad?action=proses_approve';
      ...
      $btnSubmit .= "<button type='button'
                ...
                id='button_update_".$this->url."'
                class='icon-save ui-button'
                onclick='javascript:btn_submit_".$this->url."(\"".$this->url."\", \"".base_url()."processor/pk/pk/ad?company_id=".$this->input->get('company_id')."&group_id=".$this->input->get('group_id')."&modul_id=".$this->input->get('modul_id')."\", this)'>Sumbit 
                </button>";
      ...
      $btnApprove .= "<button type='button'
                ...
                id='button_update_".$this->url."'
                class='icon-save ui-button'
                onclick='javascript:btn_submit_".$this->url."(\"".$this->url."\", \"".base_url()."processor/pk/pk/ad?company_id=".$this->input->get('company_id')."&group_id=".$this->input->get('group_id')."&modul_id=".$this->input->get('modul_id')."\", this)'>Approve 
                </button>";
      ...
      $btn_preview  = '
                      <script type="text/javascript">
                        ...
                        function print_'.$this->url.'() {
                          ...
                          document.getElementById("iframe_preview_ga_'.$this->url.'").src = "'.base_url().'processor/pk/pk/ad?action=get_preview_report&id="+id+"&vName="+vName;
  ...
  public function manipulate_insert_button($button) {
    ...
    $btnSave  =  "<script type='text/javascript'>               
        ...
        $btnSave .= "<button type='button'
                            ...
                            class='icon-save ui-button'
                            onclick='javascript:save_btn_back_".$this->url."(\"".$this->url."\", \"".base_url()."processor/pk/pk/ad?company_id=".$this->input->get('company_id')."&group_id=".$this->input->get('group_id')."&modul_id=".$this->input->get('modul_id')."\", this)'>Save
                            </button>";
    $button['save'] = $btnSave;
...
/*
    ...
    $html .= ' </tbody>
     ...
     $urlSD = base_url().'processor/pk/pk/ad?action=supportData';
     $urlgetValuePk = base_url().'processor/pk/pk/ad?action=getValuePk';
     $urlDetail = base_url().'processor/pk/pk/ad?action=showDetail';
     $url = base_url().'processor/pk/pk/ad?action=SaveNilai';
     $rUrl = base_url()."processor/pk/pk/ad?company_id=".$this->input->get('company_id')."&group_id=".$this->input->get('group_id')."&modul_id=".$this->input->get('modul_id');

     $html .= "<script>

      $(document).ready(function() {
        $('.pk_ad_nPointSepakat').autoNumeric('init', {vMin:'0', vMax:'100'});
     
      });

      $('.pk_ad_nPointSepakat').live('keyup', function() {                
        var ix = $('.pk_ad_nPointSepakat').index($(this));
      ...
      $('.pk_ad_nPointSepakat').live('blur', function() {  
            var ix = $('.pk_ad_nPointSepakat').index($(this));
      ...
      function ".$this->url."_hitungPk(vFunctionLink,iAspekId,tampil,bobot){
          ...
          document.getElementById('vDescription_pk_ad_'+iAspekId+'_80').style.backgroundColor='#ffffff';
          document.getElementById('vDescription_pk_ad_'+iAspekId+'_60').style.backgroundColor='#ffffff';
          document.getElementById('vDescription_pk_ad_'+iAspekId+'_40').style.backgroundColor='#ffffff';
          document.getElementById('vDescription_pk_ad_'+iAspekId+'_20').style.backgroundColor='#ffffff';
  ...
  function generateHasilAkhir($iPkTransId,$cNip,$rowData){
    ...
    $urlHasil = base_url().'processor/pk/pk/ad?action=SaveHasil';
    $rUrl = base_url()."processor/pk/pk/ad?company_id=".$this->input->get('company_id')."&group_id=".$this->input->get('group_id')."&modul_id=".$this->input->get('modul_id');
    ...
    $html .= "<script>
                ...
                $(document).ready(function() {  
                  $('#pk_ad_iDivIdTo').change(function() {
                      groupdeptid = getGroupDeptId($(this).val());
                      loadDataJbt('pk_ad_iPostIdTo', groupdeptid, groupdeptid);
  ...
  public function searchcNip() {
    ...
    $data = array();
    $divGa = $this->lib_utilitas->getSysParam('DIV_PK_ad');
    $jabatan  =  $this->lib_utilitas->getSysParam("JABATAN_PK_ad_MGR");
  ...
  function getDetail(){
      ...
      $html .= "<script>
                  $(document).ready(function() {
                    ...
                    $('.pk_ad_nResult').autoNumeric('init', {vMin:'0', vMax:'100.00'});
                  });


                  $('.pk_ad_nResult').live('keyup', function() {            
                    var ix = $('.pk_ad_nResult').index($(this));
                    
                    var sisa_sblm   = 0;
                    var result  = $('.pk_ad_nResult').eq(ix).val();
                    var bobot   = $('.pk_ad_nBobot').eq(ix).val();
                    var nilai   = parseFloat((result * bobot) / 100);

                    $('.pk_ad_nNilai').eq(ix).val(nilai.toFixed(2));
                    $('.nama_pk_ad_nNilai').eq(ix).html(nilai.toFixed(2));
                  ...
                  function sum_".$this->url."(){
                    ...
                    $('.pk_ad_nResult').each(function() {
                      if ($('.pk_ad_nResult').eq(i).val() != '') {        
                        total += parseFloat($('.pk_ad_nNilai').eq(i).val());
                    ...
                    $('#pk_ad_jumlah').html(total.toFixed(2));
                    $('#pk_ad_nFinal').val(total.toFixed(2));
...
FROM hrd.pk_pkresult AS a WHERE a.iPkTransId='".$iPkTransId."' ";
    ...
    function getValuePk(){
      ...
      $this->lib_pk_ad->$vFunctionLink($_POST);
    }
