...
class lib_pk_assc_pd2
{
    ...
    function pk_pd2_08($post){
        ...
        $x_prd1 = explode("-", $dPeriode1);
        $perode1 = $x_prd1['2']."-".$x_prd1['1']."-".$x_prd1['0'];
        $perode11 = $x_prd1['2']."-".$x_prd1['1']."-".$x_prd1['0'];

        $dPeriode2  = $post['_dPeriode2'];
        $x_prd2 = explode("-", $dPeriode2);
        $perode2 = $x_prd2['2']."-".$x_prd2['1']."-".$x_prd2['0'];
        $perode22 = $x_prd2['2']."-".$x_prd2['1']."-".$x_prd2['0'];
        ...
        $html .= "<table cellspacing='0' cellpadding='3' width='100%'>
            <tr style='width:100%; border: 1px solid #f86609; background: #b5f2a6; border-collapse: collapse;text-align: center;'>
            <td style='border: 1px solid #dddddd;' colspan='11'><b>Dokumen Tambahan HPR</b></td>
            </tr>
            <tr style='width:100%; border: 1px solid #f86609; background: #b5f2a6; border-collapse: collapse;text-align: center;'>
                <td style='border: 1px solid #dddddd;width:15px;' ><b>No</b></td>
                <td style='border: 1px solid #dddddd;' ><b>No UPB </b></td>
                <td style='border: 1px solid #dddddd;' ><b>Nama UPB </b></td> 
                <td style='border: 1px solid #dddddd;' ><b>Nomor Request</b></td>
                <td style='border: 1px solid #dddddd;' ><b>Dokumen</b></td>
                <td style='border: 1px solid #dddddd;' ><b>File Upload Dokumen</b></td>
                <td style='border: 1px solid #dddddd;width:100px;' ><b>Tanggal Submit Request Tambahan Data oleh Busdev (A)</b></td> 
                <td style='border: 1px solid #dddddd;width:100px;' ><b>Tanggal Upload file terakhir dari PD ke Busdev (B)</b></td>  
                <td style='border: 1px solid #dddddd;width:100px;' ><b>Team</b></td>  
                <td style='border: 1px solid #dddddd;width:100px;' ><b>Status</b></td>  
                <td style='border: 1px solid #dddddd;width:50px;' ><b>Selisih (hari)</b></td> 
            </tr>
        ";

        /*Details HPR*/

        $sqlto ="select h1.iupb_id,u.vupb_nomor,u.vupb_nama,h1.vfilename as noreq,
                h2.vnamaDokumen,h3.vfilename,h1.dcreate, h3.dupload, u.ikategoriupb_id , h3.iDone, u.iteampd_id
            from plc2.hprfile1 h1
            join plc2.plc2_upb u on u.iupb_id=h1.iupb_id
            join plc2.hprfile2 h2 on h1.ihprfile1=h2.ihprfile1
            join plc2.hprfile3 h3 on h2.ihprfile2=h3.ihprfile2
            where
            h1.ldelete=0 and h2.ldelete=0 and h3.ldelete=0 
            and h3.iDone=1 
            and h3.irevisi=2
            and h2.vTeamPD='PD'
            and u.iteampd_id=3
            and h1.dcreate is not null
            and h3.dupload is not null
            and h1.dcreate between '".$perode1."' AND '".$perode2."'"; 
        ...
        if(!empty($b)){
            foreach ($b as $v) {
                ...
                /*Selisih HPR*/ 
                $se=$this->selisihnokerja($v['dcreate'], $v['dupload']); 
                ...
                $html .= "<tr style='border: 1px solid #dddddd; border-collapse: collapse;".$color."'> 
                            ...
                            <td style='text-align: center;border: 1px solid #dddddd;'>
                                ".date('d-m-Y',strtotime($v['dcreate']))."</td>
                            <td style='text-align: center;border: 1px solid #dddddd;'>
                                ".date('d-m-Y',strtotime($v['dupload']))."</td> 
                            <td style='text-align: center;border: 1px solid #dddddd;'>
                                ".$tpd."</td>
                            <td style='text-align: center;border: 1px solid #dddddd;'>
                                ".$sts."</td>
        ...
        $html.="<tr style='width:100%; border: 1px solid #f86609; background: #b5f2a6; border-collapse: collapse;text-align: center;'>
            <td style='border: 1px solid #dddddd;' colspan='10'><b>Total Selisih (hari) Dokumen Tambahan HPR</b></td>
            <td style='border: 1px solid #dddddd;'><b>".$jum1."</b></td>
            </tr>";


        $html .="</table>";
        $html .= "<table cellspacing='0' cellpadding='3' width='100%' style='margin-top:20px'>
            <tr style='width:100%; border: 1px solid #f86609; background: #b5f2a6; border-collapse: collapse;text-align: center;'>
            <td style='border: 1px solid #dddddd;' colspan='11'><b>Dokumen Tambahan Applet</b></td>
            </tr>
            <tr style='width:100%; border: 1px solid #f86609; background: #b5f2a6; border-collapse: collapse;text-align: center;'>
                <td style='border: 1px solid #dddddd;width:15px;' ><b>No</b></td>
                <td style='border: 1px solid #dddddd;' ><b>No UPB </b></td>
        ...
        $sqlto ="select h1.iupb_id,u.vupb_nomor,u.vupb_nama,h1.vfilename as noreq,h2.vnamaDokumen,
            h3.vfilename,h1.dcreate, h3.dupload, u.ikategoriupb_id , h3.iDone, u.iteampd_id
            from plc2.appletfile1 h1
            join plc2.plc2_upb u on u.iupb_id=h1.iupb_id
            join plc2.appletfile2 h2 on h1.iappletfile1=h2.iappletfile1
            join plc2.appletfile3 h3 on h2.iappletfile2=h3.iappletfile2
            where
            h1.ldelete=0 and h2.ldelete=0 and h3.ldelete=0 
            and h3.iDone=1 
            and h3.irevisi=2 
            ...
            and h1.dcreate is not null
            and h3.dupload is not null
            and h1.dcreate between '".$perode11."' AND '".$perode22."'"; 
        ...
        if(!empty($b)){
            foreach ($b as $v) {
                ...
                // $offkerjaapp=$this->getHoliday($perode1, $perode2, $cNipNya,'offkerja');
                // $hrliburbruttoapp=$this->getHoliday($perode1, $perode2, $cNipNya,'offbrutto');
                // $holidayapp=$this->getHoliday($perode1, $perode2, $cNipNya);
                // $offapp=$offkerjaapp+$holidayapp;
                // $countapplet[]=$se;
        ...
        $html.="<tr style='width:100%; border: 1px solid #f86609; background: #b5f2a6; border-collapse: collapse;text-align: center;'>
            <td style='border: 1px solid #dddddd;' colspan='10'><b>Total Selisih (hari) Dokumen Tambahan Applet</b></td>
            <td style='border: 1px solid #dddddd;'><b>".$jum2."</b></td>
            </tr>";
        $html .="</table>";
        
        $totalselisih = $jum2+$jum1;
        $totalTD      = $totTD;
        if($totalselisih==0 || $totalTD=="0"){
            $result     = number_format(0,0);
        }else{
            $total      = ($totalselisih/$totalTD)/22;     
        ...
        $html .= "<table align='left' cellspacing='0' cellpadding='3' style='width: 300px;'>
                    ...
                    <tr style='border: 1px solid #dddddd; border-collapse: collapse;'>
                        <td style='width:10%;text-align: left;border: 1px solid #dddddd;'>Jumlah Selisih HPR & Applet (Hari)</td> 
                        <td style='width:10%;text-align: right;border: 1px solid #dddddd;'><b>".$totalselisih."</b></td>
                    </tr>
                    <tr style='border: 1px solid #dddddd; border-collapse: collapse;'>
                        <td style='width:10%;text-align: left;border: 1px solid #dddddd;'>Total TD</td> 
                        <td style='width:10%;text-align: right;border: 1px solid #dddddd;'><b>".$totalTD."</b></td>
                    </tr>
                    <tr style='border: 1px solid #dddddd; border-collapse: collapse;'>
                        <td style='width:10%;text-align: left;border: 1px solid #dddddd;'>Rata-rata Selisih TD HPR & Applet (Bulan)</td> 
    ...
    function pk_pd2_01 ($post){
        ...
        $sql2 = $sql1." GROUP BY u.iGroup_produk";
