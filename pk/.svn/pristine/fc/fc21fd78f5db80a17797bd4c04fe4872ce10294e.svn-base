	...
	<tbody>
			...
			$sel=0;
				foreach ($datas as $data) {
					...
					echo "<td>".$data['ttarget_noreg']."</td>";
					echo "<td>".$data['ttarget_hpr']."</td>";
					echo "<td>".$data['tTd_applet']."</td>";
...
<label class="lbl_detail">Jumlah Selisih Hari : <?php echo $pembilang; ?></label><br>
<label class="lbl_detail">Rata - Rata  : <?php echo $rat ?> Bulan </label>