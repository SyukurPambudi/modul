<?php
    ...
    $url = base_url().'processor/pk/pk/pd3?action=saveSupportData';
?>
<script type="text/javascript"> 
  ...
  function save_data_pendukung(iAspekId,iPkTransId){
    ...
    $.ajax({
     type: 'POST',
     url: url,
     data: $('#input_support_data_PD3_getParameter6').serialize()+'&_parameter=PD3_getParameter6&_iPkTransId='+iPkTransId+'&_iAspekId='+iAspekId,
...
<form id='input_support_data_PD3_getParameter6' >
...
<div class="box_cbox" style="width: 150px">
  ...
  <tr style="width: 60%; border: 1px solid #f86609; background: #d79a20; border-collapse: collapse">
    <th style="border: 1px solid #dddddd;">Jumlah Formulator</th>
  </tr>
  </thead>
  <tbody>
  <?php 
