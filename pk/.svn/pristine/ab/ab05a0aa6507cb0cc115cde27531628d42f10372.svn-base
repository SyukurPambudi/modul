...
class pk_ad1_man_462 extends MX_Controller {
    private $sess_auth;
    private $db_erp_pk;
    function __construct() {
        ...
        $this->url = 'pk_ad1_man_462'; 
        $this->urll= 'pk/'.str_replace("_", "/", $this->url);
        $this->SkemaPKVar='SKEMA_PK_AD1_MAN_462';
        $this->JabatanPKVar='JABATAN_PK_AD1_MAN_462';
        $this->load->library('lib_utilitas');
        $this->load->library('lib_pk_ad1_man_462');
    ...
    function index($action = '') {
        ...
        $grid = new Grid;
        $grid->setTitle('Penilain Kerja Supervisor PD');    
        $grid->setTable('hrd.pk_trans');    
        $grid->setUrl('pk_ad1_man_462');
...
*/
    ...
    function supportData(){
     ...
     /* if ($iAspekId=='118'){
      ...
      switch ($vFunctionLink) {
        case 'TSPERFM_03':
          $data['DataCollect']=$this->lib_pk_ad1_man_462->supportData_TSPERFM_03($data);
    ...
    function SaveHasil(){
      ...
      if(isset($_POST['pk_ad1_man_462_vEvaKry'])){
        $vEvaKry     = $_POST['pk_ad1_man_462_vEvaKry'];
        $this->db_erp_pk->set('vEvaKry',$vEvaKry);
      }
      if(isset($_POST['pk_ad1_man_462_vRencana'])){
        $vRencana     = $_POST['pk_ad1_man_462_vRencana'];
        $this->db_erp_pk->set('vRencana',$vRencana);
      }
      if(isset($_POST['pk_ad1_man_462_vEvaAtasan'])){
        $vEvaAtasan   = $_POST['pk_ad1_man_462_vEvaAtasan'];
        $this->db_erp_pk->set('vEvaAtasan',$vEvaAtasan);
      }
      if(isset($_POST['pk_ad1_man_462_vSaranAtasan'])){
        $vSaranAtasan   = $_POST['pk_ad1_man_462_vSaranAtasan'];
        $this->db_erp_pk->set('vSaranAtasan',$vSaranAtasan);
      }
      if(isset($_POST['pk_ad1_man_462_vPelatihan'])){
        $vPelatihan   = $_POST['pk_ad1_man_462_vPelatihan'];
        $this->db_erp_pk->set('vPelatihan',$vPelatihan);
      }
      if (isset($_POST['pk_ad1_man_462_iRencana'])){
          $iRencana   = $_POST['pk_ad1_man_462_iRencana'];
          $this->db_erp_pk->set('iRencana',$iRencana);
      }
      if (isset($_POST['pk_ad1_man_462_iDivIdTo'])){
          $iDivIdTo   = $_POST['pk_ad1_man_462_iDivIdTo'];
          $this->db_erp_pk->set('iRencana',$iDivIdTo);
      }
      if (isset($_POST['pk_ad1_man_462_iPostIdTo'])){
          $iPostIdTo   = $_POST['pk_ad1_man_462_iPostIdTo'];
          $this->db_erp_pk->set('iRencana',$iPostIdTo);
      }
      if (isset($_POST['pk_ad1_man_462_vPertimbangan'])){
          $vPertimbangan   = $_POST['pk_ad1_man_462_vPertimbangan'];
          $this->db_erp_pk->set('iRencana',$vPertimbangan);
      }
      if (isset($_POST['pk_ad1_man_462_nFinal'])){
          $nFinal   = $_POST['pk_ad1_man_462_nFinal'];
    ...
    function SaveBobot(){
      //print_r($_POST);
      //exit();
      $iPkTransId         = $_POST['pk_ad1_man_462_id'];
    ...
    function SaveNilaiCSE(){
      ...
      $iPkTransId         = $_POST['pk_ad1_man_462_id'];
      $iMsGroupAspekId    = $_POST['_iMsGroupAspekId'];
      $nResult            = $_POST['pk_ad1_man_462_nilaicse'];
      $cNip               =  $this->sess_auth->gNIP;
    ...
    function uploadproses(){
      ...
      $files = $_FILES;
      $realname = $files["pk_ad1_man_462_lampiran"]["name"];
      $newName= "PK_".$id."_".$realname;
      $newName =  str_replace("/", "_", $newName);
      $upload_dir = "files/hdsystem/".$newName;

      move_uploaded_file($files["pk_ad1_man_462_lampiran"]["tmp_name"], $upload_dir);
    ...
    function proses_reject(){
      ...
      $sql    = "SELECT cNip FROM hrd.pk_ad1_man_462
      ...
      $sql = "INSERT INTO hrd.pk_ad1_man_462 (iSkemaId,cNip,iStatus,vReason,dDate,iUlang,lDeleted,tCreated,cCreatedBy) VALUES
    ...
    public function listbox_pk_ad1_man_462_dPk($value, $id,$field,$rowData) {
    ...
    public function listbox_pk_ad1_man_462_iPostId($value, $id,$field,$rowData) {
      $vDescription = $value;
    ...
    public function insertbox_pk_ad1_man_462_iPostId($field, $id) {
      $cNip   =  $this->sess_auth->gNIP;
    ...
    public function updatebox_pk_ad1_man_462_iPostId($field, $id,$value,$data) {
    ...
    public function insertbox_pk_ad1_man_462_cNip($field, $id) {
      $cNip        =  $this->sess_auth->gNIP;
      ...
      $o = "<script type='text/javascript'>
              $(document).ready(function() {
                /*var akses = cekJabatan('pk_ad1_man_462_iSkemaId', '".$iPostId."');
                if (akses=='TIDAK'){
                    custom_alert('Jabatan anda tidak terdaftar untuk input Penilaian Kinerja pada module ini');
                    //$('#form_pk_ad1_man_462').hide();
                    return false;
                }*/

                loadSkema('pk_ad1_man_462_iSkemaId', '".$iPostId."');
                ...
                var config = {
                  ...
                  select: function(event, ui){
                    ...
                    loadSkema('pk_ad1_man_462_iSkemaId', ui.item.iPostId);
    ...
    public function updatebox_pk_ad1_man_462_cNip($field, $id,$value,$data) {
      $cNip         =  $value;
      $vDescription = $cNip." - ".$this->lib_utilitas->getvName($cNip);
      $url = $this->url;
      $url6 = base_url().'processor/'.$this->urll.'?action=searchcNip';
    ...
    public function insertbox_pk_ad1_man_462_cTahun($field, $id) {
      $year = date('Y');
      $y1 = $year - 5;
      $y2 = $year + 5;
    ...
    public function updatebox_pk_ad1_man_462_cTahun($field, $id,$value,$data) {
      $year = $value;
    ...
    public function insertbox_pk_ad1_man_462_cPeriode($field, $id) {
    ...
    public function updatebox_pk_ad1_man_462_cPeriode($field, $id,$value,$data) {
    ...
    public function insertbox_pk_ad1_man_462_iSemester($field, $id) {
    ...
    public function updatebox_pk_ad1_man_462_iSemester($field, $id,$value,$data) {
      $sms = array(''=>'',1=>1,2=>2);
    ...
    public function insertbox_pk_ad1_man_462_dPk($field, $id) {
      $now = date('d-m-Y');
    ...
    public function updatebox_pk_ad1_man_462_dPk($field, $id,$value,$data) {
    ...
    public function insertbox_pk_ad1_man_462_iProbation($field, $id) {
    ...
    public function updatebox_pk_ad1_man_462_iProbation($field, $id,$value,$data) {
      //1=PK Probation, tahun dan semester bisa dikosongkan.
    ...
    public function insertbox_pk_ad1_man_462_lampiran($field, $id) {
    ...
    public function updatebox_pk_ad1_man_462_lampiran($field, $id,$value,$data) {
      $action = $this->input->get('action');
      $idnya = $data['id'];
  ...
  public function insertbox_pk_ad1_man_462_iSkemaId($field, $id) {
    ...
    public function updatebox_pk_ad1_man_462_iSkemaId($field, $id,$value,$data) {
  ...
  public function insertbox_pk_ad1_man_462_detail($field, $id) {
...
border: 1px solid aquamarine;' >
  ...
  public function updatebox_pk_ad1_man_462_detail($field, $id,$value,$data) {
    $idnya      = $data['iSkemaId'];
    $iPkTransId = $data['id'];
    $cNip       = $data['cNip'];
  ...
  public function updatebox_pk_ad1_man_462_Approval($field, $id,$value,$data) {
    $id = $data['id'];
   $o = '<div class="box_cbox">
    ...
    $sql = "SELECT cNip,iStatus,vReason,dDate 
          FROM hrd.pk_ad1_man_462 WHERE iSkemaId='".$id."' ORDER BY id ASC";
    ...
    $html .= "<script>
              ...
              function simpanPointCse(iMsGroupAspekId){
                  ...
                  var iPkTransId = '".$iPkTransId."';
                    var nResult = $('#pk_ad1_man_462_nilaicse').val();
                    if (nResult==''){
  ...
  function generateAspekDivisi($iSkemaId,$iMsGroupAspekId,$iPkTransId,$cNip,$rowData,$lDynamic){
    ...
    $html .= ' </tbody>
     ...
     $html .= "<script>
      ...
      $(document).ready(function() {
        $('.pk_ad1_man_462_nPointSepakat').autoNumeric('init', {vMin:'0', vMax:'100'});
     
      });

      $('.pk_ad1_man_462_nPointSepakat').live('keyup', function() {
        var ix = $('.pk_ad1_man_462_nPointSepakat').index($(this));
      ...
      $('.pk_ad1_man_462_nPointSepakat').live('blur', function() {
            var ix = $('.pk_ad1_man_462_nPointSepakat').index($(this));
        ...
        $.ajax({
           ...
           success: function(data)
           {
                custom_alert(data);
                 $.get('".$rUrl."&action=update&id='+iPkTransId, function(data) {
                      $('div#form_".$this->url."').html(data);
                      var index = $('#pk_ad1_man_462_list_detail a[href=\'#pk_ad1_man_462_'+iMsGroupAspekId+'\']').parent().index();
                      $('#pk_ad1_man_462_list_detail').tabs('option', 'active', index);                  
                  });
      ...
      function simpanDetail(vFunctionLink,iMsGroupAspekId){
        ...
        var iPkTransId = '".$iPkTransId."';
        var nip = $('#pk_ad1_man_462_cNip').val();
      ...
      function ".$this->url."_hitungPk(vFunctionLink,iAspekId,tampil,bobot){
          ...
          document.getElementById('vDescription_pk_ad1_man_462_'+iAspekId+'_100').style.backgroundColor='#ffffff';
          document.getElementById('vDescription_pk_ad1_man_462_'+iAspekId+'_80').style.backgroundColor='#ffffff';
          document.getElementById('vDescription_pk_ad1_man_462_'+iAspekId+'_60').style.backgroundColor='#ffffff';
          document.getElementById('vDescription_pk_ad1_man_462_'+iAspekId+'_40').style.backgroundColor='#ffffff';
          document.getElementById('vDescription_pk_ad1_man_462_'+iAspekId+'_20').style.backgroundColor='#ffffff';

          document.getElementById('vDescription_pk_ad1_man_462_'+iAspekId+'_'+point).style.backgroundColor = color;
      ...
      function ".$this->url."_input_supoortData_ts(iAspekId,iPkTransId){
        load_popup_pk_ad1_man_462_insert('".$urlSD."&iAspekId='+iAspekId+'&iPkTransId='+iPkTransId+'&getaction=".$this->input->get('action')."','Support Data');
      }

     </script>";
     $data['grid']='pk_ad1_man_462';    
     //$html.=$this->load->view('func_tambahan_pk_ad1_man_462_js',$data);
      return $html;
  }
  ...
  function generateHasilAkhir($iPkTransId,$cNip,$rowData){
    ...
    $html .= "<script>
                ...
                $(document).ready(function() {  
                  $('#pk_ad1_man_462_iDivIdTo').change(function() {
                      groupdeptid = getGroupDeptId($(this).val());
                      loadDataJbt('pk_ad1_man_462_iPostIdTo', groupdeptid, groupdeptid);
  ...
  function getDetail(){
      ...
      $html .= "<script>
                  $(document).ready(function() {
                    ...
                    $('.pk_ad1_man_462_nResult').autoNumeric('init', {vMin:'0', vMax:'100.00'});
                  });


                  $('.pk_ad1_man_462_nResult').live('keyup', function() {
                    var ix = $('.pk_ad1_man_462_nResult').index($(this));
                    
                    var sisa_sblm   = 0;
                    var result  = $('.pk_ad1_man_462_nResult').eq(ix).val();
                    var bobot   = $('.pk_ad1_man_462_nBobot').eq(ix).val();
                    var nilai   = parseFloat((result * bobot) / 100);

                    $('.pk_ad1_man_462_nNilai').eq(ix).val(nilai.toFixed(2));
                    $('.nama_pk_ad1_man_462_nNilai').eq(ix).html(nilai.toFixed(2));
                  ...
                  function sum_".$this->url."(){
                    ...
                    $('.pk_ad1_man_462_nResult').each(function() {
                      if ($('.pk_ad1_man_462_nResult').eq(i).val() != '') {
                        total += parseFloat($('.pk_ad1_man_462_nNilai').eq(i).val());
                    ...
                    $('#pk_ad1_man_462_jumlah').html(total.toFixed(2));
                    $('#pk_ad1_man_462_nFinal').val(total.toFixed(2));
...
FROM hrd.pk_pkresult AS a WHERE a.iPkTransId='".$iPkTransId."' ";
    ...
    function getValuePk(){
      ...
      $this->lib_pk_ad1_man_462->$vFunctionLink($_POST);
    }
