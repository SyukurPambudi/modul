...
class lib_sdm
{
    ...
    function SDM_getParameter1($post)
    {
        ...
        $sqlto = "Select distinct a.id, a.problem_subject, a.iSizeProject, a.dcloseGm
                from hrd.ss_raw_problems a
                inner join  hrd.ss_raw_pic b on a.id = b.rawid and b.pic = '" . $cNipNya . "' and iRoleId = 1
                where a.dcloseGm between '" . $perode1 . "' and '" . $perode2 . "' and b.Deleted = 'No' and
                iStatus = 13 ";
            ...
            $q = "SELECT r.*
                      FROM (
                          ...
                          WHERE r.pic LIKE '%$nipchild%' AND r.requestor<>'$nipchild' AND
                            ...
                            r.activity_id=a.activity_id and r.parent_id = 0
                      ) r
