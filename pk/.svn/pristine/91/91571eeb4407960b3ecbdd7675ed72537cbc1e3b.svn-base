...
class pk_softdev extends MX_Controller {
    private $sess_auth;
    private $db_erp_pk;
    function __construct() {
        ...
        $this->load->library('lib_pk_softdev');
    ...
    function index($action = '') {
        ...
        $grid = new Grid;
        $grid->setTitle('Transaksi PK MIS Department');    
        $grid->setTable('hrd.pk_trans');    
        $grid->setUrl('pk_softdev');
...
*/
    ...
    function supportData(){
     ...
     /* if ($iAspekId=='118'){
      ...
      switch ($vFunctionLink) {
        case 'TSPERFM_03':
          $data['DataCollect']=$this->lib_pk_softdev->supportData_TSPERFM_03($data);
    ...
    function SaveHasil(){
      ...
      $vEvaKry      = $_POST['pk_softdev_vEvaKry'];
      $vRencana     = $_POST['pk_softdev_vRencana'];
      $vEvaAtasan   = $_POST['pk_softdev_vEvaAtasan'];
      $vSaranAtasan = $_POST['pk_softdev_vSaranAtasan'];
      $vPelatihan   = $_POST['pk_softdev_vPelatihan'];
      

      if (isset($_POST['pk_softdev_iRencana'])){
          $iRencana     = $_POST['pk_softdev_iRencana'];
      }else{
          $iRencana = '';
      }

      $iDivIdTo     = $_POST['pk_softdev_iDivIdTo'];
      $iPostIdTo     = $_POST['pk_softdev_iPostIdTo'];
      $vPertimbangan = $_POST['pk_softdev_vPertimbangan'];
      $nFinal        = $_POST['pk_softdev_nFinal'];
    ...
    function SaveBobot(){
      //print_r($_POST);
      //exit();
      $iPkTransId         = $_POST['pk_softdev_id'];
    ...
    function SaveNilaiCSE(){
      ...
      $iPkTransId         = $_POST['pk_softdev_id'];
      $iMsGroupAspekId    = $_POST['_iMsGroupAspekId'];
      $nResult            = $_POST['pk_softdev_nilaicse'];
      $cNip               =  $this->sess_auth->gNIP;
    ...
    function uploadproses(){
      ...
      $files = $_FILES;
      $realname = $files["pk_softdev_lampiran"]["name"];
      $newName= "PK_".$id."_".$realname;
      $newName =  str_replace("/", "_", $newName);
      $upload_dir = "files/hdsystem/".$newName;

      move_uploaded_file($files["pk_softdev_lampiran"]["tmp_name"], $upload_dir);
    ...
    function proses_reject(){
      ...
      $sql    = "SELECT cNip FROM hrd.pk_softdev
      ...
      $sql = "INSERT INTO hrd.pk_softdev (iSkemaId,cNip,iStatus,vReason,dDate,iUlang,lDeleted,tCreated,cCreatedBy) VALUES
    ...
    public function listbox_pk_softdev_dPk($value, $id,$field,$rowData) {
    ...
    public function listbox_pk_softdev_iPostId($value, $id,$field,$rowData) {
      $vDescription = $value;
    ...
    public function insertbox_pk_softdev_iPostId($field, $id) {
      $cNip   =  $this->sess_auth->gNIP;
    ...
    public function updatebox_pk_softdev_iPostId($field, $id,$value,$data) {
    ...
    public function insertbox_pk_softdev_cNip($field, $id) {
      $cNip        =  $this->sess_auth->gNIP;
      $vDescription = $cNip." - ".$this->lib_utilitas->getvName($cNip);

      $url = $this->url;
      $url6 = base_url().'processor/pk/pk/softdev?action=searchcNip';
      $url2 = base_url().'processor/pk/pk/softdev?action=searchSkema';
      $url3 = base_url().'processor/pk/pk/softdev?action=cekJabatan';
      ...
      $o = "<script type='text/javascript'>
              $(document).ready(function() {
                /*var akses = cekJabatan('pk_softdev_iSkemaId', '".$iPostId."');
                if (akses=='TIDAK'){
                    custom_alert('Jabatan anda tidak terdaftar untuk input Penilaian Kinerja pada module ini');
                    //$('#form_pk_softdev').hide();
                    return false;
                }*/

                loadSkema('pk_softdev_iSkemaId', '".$iPostId."');
                ...
                var config = {
                  ...
                  select: function(event, ui){
                    ...
                    loadSkema('pk_softdev_iSkemaId', ui.item.iPostId);
    ...
    public function updatebox_pk_softdev_cNip($field, $id,$value,$data) {
      $cNip         =  $value;
      $vDescription = $cNip." - ".$this->lib_utilitas->getvName($cNip);
      $url = $this->url;
      $url6 = base_url().'processor/pk/pk/softdev?action=searchcNip';
    ...
    public function insertbox_pk_softdev_cTahun($field, $id) {
      $year = date('Y');
      $y1 = $year - 5;
      $y2 = $year + 5;
    ...
    public function updatebox_pk_softdev_cTahun($field, $id,$value,$data) {
      $year = $value;
    ...
    public function insertbox_pk_softdev_cPeriode($field, $id) {
    ...
    public function updatebox_pk_softdev_cPeriode($field, $id,$value,$data) {
    ...
    public function insertbox_pk_softdev_iSemester($field, $id) {
      
      $url2 = base_url().'processor/pk/pk/softdev?action=cekDataPk';
      $url  = base_url()."processor/pk/pk/softdev?company_id=".$this->input->get('company_id')."&group_id=".$this->input->get('group_id')."&modul_id=".$this->input->get('modul_id');
    ...
    public function updatebox_pk_softdev_iSemester($field, $id,$value,$data) {
      $sms = array(''=>'',1=>1,2=>2);
    ...
    public function insertbox_pk_softdev_dPk($field, $id) {
      $now = date('d-m-Y');
    ...
    public function updatebox_pk_softdev_dPk($field, $id,$value,$data) {
    ...
    public function insertbox_pk_softdev_iProbation($field, $id) {
    ...
    public function updatebox_pk_softdev_iProbation($field, $id,$value,$data) {
      //1=PK Probation, tahun dan semester bisa dikosongkan.
    ...
    public function insertbox_pk_softdev_lampiran($field, $id) {
    ...
    public function updatebox_pk_softdev_lampiran($field, $id,$value,$data) {
      $action = $this->input->get('action');
      $idnya = $data['id'];
      $url = base_url().'processor/pk/pk/softdev?action=uploadproses&id='.$idnya;
      $urlhapus = base_url().'processor/pk/pk/softdev?action=hapus';
      $urlgetLampiran = base_url().'processor/pk/pk/softdev?action=getLampiran';
      $o = '';  
      $o .= '<style>
  ...
  public function insertbox_pk_softdev_iSkemaId($field, $id) {
    ...
    public function updatebox_pk_softdev_iSkemaId($field, $id,$value,$data) {
      $iPostId = $data['iPostId'];
      $url = base_url().'processor/pk/pk/softdev?action=getDetail';
  ...
  public function insertbox_pk_softdev_detail($field, $id) {
...
border: 1px solid aquamarine;' >
  ...
  public function updatebox_pk_softdev_detail($field, $id,$value,$data) {
    $idnya      = $data['iSkemaId'];
    $iPkTransId = $data['id'];
    $cNip       = $data['cNip'];
    ...
    if ($query->num_rows > 0) {
      foreach($query->result_array() as $line) {
        ...
        if ($iMsGroupAspekId==7 || $iMsGroupAspekId==17){//CSE
  ...
  public function updatebox_pk_softdev_Approval($field, $id,$value,$data) {
    $id = $data['id'];
   $o = '<div class="box_cbox">
    ...
    $sql = "SELECT cNip,iStatus,vReason,dDate 
          FROM hrd.pk_softdev WHERE iSkemaId='".$id."' ORDER BY id ASC";
  ...
  public function manipulate_update_button($button,$rowData) {  
    ...
    $cNipNya = $rowData['cNip'];
      ...
      $btnSave .= "<button type='button'
                ...
                onclick='javascript:update_btn_back_".$this->url."(\"".$this->url."\", \"".base_url()."processor/pk/pk/softdev?company_id=".$this->input->get('company_id')."&group_id=".$this->input->get('group_id')."&modul_id=".$this->input->get('modul_id')."\", this)'>Update
                </button>";


      $urlsumbit  = base_url().'processor/pk/pk/softdev?action=proses_approve';
      ...
      $btnSubmit .= "<button type='button'
                ...
                id='button_update_".$this->url."'
                class='icon-save ui-button'
                onclick='javascript:btn_submit_".$this->url."(\"".$this->url."\", \"".base_url()."processor/pk/pk/softdev?company_id=".$this->input->get('company_id')."&group_id=".$this->input->get('group_id')."&modul_id=".$this->input->get('modul_id')."\", this)'>Submit
                </button>";
      ...
      $btnApprove .= "<button type='button'
                ...
                id='button_update_".$this->url."'
                class='icon-save ui-button'
                onclick='javascript:btn_submit_".$this->url."(\"".$this->url."\", \"".base_url()."processor/pk/pk/softdev?company_id=".$this->input->get('company_id')."&group_id=".$this->input->get('group_id')."&modul_id=".$this->input->get('modul_id')."\", this)'>Approve
                </button>";
      ...
      $btn_preview  = '
                      <script type="text/javascript">
                        ...
                        function print_'.$this->url.'() {
                          ...
                          document.getElementById("iframe_preview_'.$this->url.'").src = "'.base_url().'processor/pk/pk/softdev?action=get_preview_report&id="+id+"&vName="+vName;
  ...
  public function manipulate_insert_button($button) {
    ...
    $btnSave  =  "<script type='text/javascript'>               
        ...
        $btnSave .= "<button type='button'
                            ...
                            class='icon-save ui-button'
                            onclick='javascript:save_btn_back_".$this->url."(\"".$this->url."\", \"".base_url()."processor/pk/pk/softdev?company_id=".$this->input->get('company_id')."&group_id=".$this->input->get('group_id')."&modul_id=".$this->input->get('modul_id')."\", this)'>Save
                            </button>";
    $button['save'] = $btnSave;
  ...
  function generateCse($iSkemaId,$iMsGroupAspekId,$iPkTransId,$cNip,$rowData){
    ...
    $url = base_url().'processor/pk/pk/softdev?action=SaveNilaiCSE';
    $rUrl = base_url()."processor/pk/pk/softdev?company_id=".$this->input->get('company_id')."&group_id=".$this->input->get('group_id')."&modul_id=".$this->input->get('modul_id');
    ...
    $html .= "<script>
              ...
              function simpanPointCse(iMsGroupAspekId){
                  ...
                  var iPkTransId = '".$iPkTransId."';
                    var nResult = $('#pk_softdev_nilaicse').val();
                    if (nResult==''){
  ...
  function generateAspekDivisi($iSkemaId,$iMsGroupAspekId,$iPkTransId,$cNip,$rowData,$lDynamic){
    ...
    $html .= ' </tbody>
     ...
     $urlSD = base_url().'processor/pk/pk/softdev?action=supportData';
     $urlgetValuePk = base_url().'processor/pk/pk/softdev?action=getValuePk';
      $urlgetPerformanceObjective = base_url().'processor/pk/pk/softdev?action=getPerformanceObjective';
     $urlDetail = base_url().'processor/pk/pk/softdev?action=showDetail';
     $url = base_url().'processor/pk/pk/softdev?action=SaveNilai';
     $urlBobot = base_url().'processor/pk/pk/softdev?action=SaveBobot';
     $rUrl = base_url()."processor/pk/pk/softdev?company_id=".$this->input->get('company_id')."&group_id=".$this->input->get('group_id')."&modul_id=".$this->input->get('modul_id');

     $html .= "<script>

      $(document).ready(function() {
        $('.pk_softdev_nPointSepakat').autoNumeric('init', {vMin:'0', vMax:'100'});
     
      });

      $('.pk_softdev_nPointSepakat').live('keyup', function() {
        var ix = $('.pk_softdev_nPointSepakat').index($(this));
      ...
      $('.pk_softdev_nPointSepakat').live('blur', function() {
            var ix = $('.pk_softdev_nPointSepakat').index($(this));
        ...
        $.ajax({
           ...
           success: function(data)
           {
                custom_alert(data);
                 $.get('".$rUrl."&action=update&id='+iPkTransId, function(data) {
                      $('div#form_".$this->url."').html(data);
                      var index = $('#pk_softdev_list_detail a[href=\'#pk_softdev_'+iMsGroupAspekId+'\']').parent().index();
                      $('#pk_softdev_list_detail').tabs('option', 'active', index);                  
                  });
      ...
      function ".$this->url."_hitungPk(vFunctionLink,iAspekId,tampil,bobot){
          ...
          document.getElementById('vDescription_pk_softdev_'+iAspekId+'_100').style.backgroundColor='#ffffff';
          document.getElementById('vDescription_pk_softdev_'+iAspekId+'_80').style.backgroundColor='#ffffff';
          document.getElementById('vDescription_pk_softdev_'+iAspekId+'_60').style.backgroundColor='#ffffff';
          document.getElementById('vDescription_pk_softdev_'+iAspekId+'_40').style.backgroundColor='#ffffff';
          document.getElementById('vDescription_pk_softdev_'+iAspekId+'_20').style.backgroundColor='#ffffff';

          document.getElementById('vDescription_pk_softdev_'+iAspekId+'_'+point).style.backgroundColor = color;
      ...
      function ".$this->url."_input_supoortData_ts(iAspekId,iPkTransId){
        load_popup_pk_softdev_insert('".$urlSD."&iAspekId='+iAspekId+'&iPkTransId='+iPkTransId+'&getaction=".$this->input->get('action')."','Support Data');
      }

     </script>";
     $data['grid']='pk_softdev';    
     //$html.=$this->load->view('func_tambahan_pk_softdev_js',$data);
      return $html;
  }
  ...
  function generateHasilAkhir($iPkTransId,$cNip,$rowData){
    ...
    //$readonly=$this->input->get('action')!='view'?'':'readonly="readonly"';
    $manager = $listaybs;
    $iStatus     = $rowData['iStatus'];
    ...
    $urlHasil = base_url().'processor/pk/pk/softdev?action=SaveHasil';
    $rUrl = base_url()."processor/pk/pk/softdev?company_id=".$this->input->get('company_id')."&group_id=".$this->input->get('group_id')."&modul_id=".$this->input->get('modul_id');
    ...
    $html .= "<script>
                ...
                $(document).ready(function() {  
                  $('#pk_softdev_iDivIdTo').change(function() {
                      groupdeptid = getGroupDeptId($(this).val());
                      loadDataJbt('pk_softdev_iPostIdTo', groupdeptid, groupdeptid);
  ...
  public function searchcNip() {
    ...
    $jabatan  =  $this->lib_utilitas->getSysParam("JABATAN_pk_softdev_MANAGER");
  ...
  function getDetail(){
      ...
      $html .= "<script>
                  $(document).ready(function() {
                    ...
                    $('.pk_softdev_nResult').autoNumeric('init', {vMin:'0', vMax:'100.00'});
                  });


                  $('.pk_softdev_nResult').live('keyup', function() {
                    var ix = $('.pk_softdev_nResult').index($(this));
                    
                    var sisa_sblm   = 0;
                    var result  = $('.pk_softdev_nResult').eq(ix).val();
                    var bobot   = $('.pk_softdev_nBobot').eq(ix).val();
                    var nilai   = parseFloat((result * bobot) / 100);

                    $('.pk_softdev_nNilai').eq(ix).val(nilai.toFixed(2));
                    $('.nama_pk_softdev_nNilai').eq(ix).html(nilai.toFixed(2));
                  ...
                  function sum_".$this->url."(){
                    ...
                    $('.pk_softdev_nResult').each(function() {
                      if ($('.pk_softdev_nResult').eq(i).val() != '') {
                        total += parseFloat($('.pk_softdev_nNilai').eq(i).val());
                    ...
                    $('#pk_softdev_jumlah').html(total.toFixed(2));
                    $('#pk_softdev_nFinal').val(total.toFixed(2));
...
FROM hrd.pk_pkresult AS a WHERE a.iPkTransId='".$iPkTransId."' ";
    ...
    function getValuePk(){
      ...
      $this->lib_pk_softdev->$vFunctionLink($_POST);
    }
