...
?>
        ...
        <label class="lbl_detail">Target Finish : <?php echo $tglawal; ?></label>
        <br />
        <label class="lbl_detail">Actual Finish : <?php echo $tglakhir; ?></label>
        <br />
        <label class="lbl_detail">Selisih : <?php echo $hasil; ?> hari</label>
