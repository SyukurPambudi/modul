...
class v2_export_protokol_moa extends MX_Controller {
    function __construct() {
		...
		$datagrid['setQuery']=array(
			...
			//1 => array('vall' => 'reformulasi_team.cDeptId', 'nilai' => 1),
		);
		...
		$datagrid['jointableinner'] = array(
			...
			//3 => $arrayName = array( 'reformulasi.reformulasi_team' => 'export_protokol_moa.cpic_protokolmoa = reformulasi_team.vnip '),
