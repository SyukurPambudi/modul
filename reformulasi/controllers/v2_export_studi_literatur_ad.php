...
class v2_export_studi_literatur_ad extends MX_Controller {
    function __construct() {
		...
		$this->title 		= 'Studi Literatur AD';
		$this->url 			= 'v2_export_studi_literatur_ad';
		$this->urlpath 		= 'reformulasi/'.str_replace("_","/", $this->url);


		$this->maintable 	= 'reformulasi.export_refor_studi_literatur_ad';	
		$this->main_table 	= $this->maintable;	
		$this->main_table_pk= 'iexport_refor_studi_literatur_ad';	
		...
		$datagrid['islist'] = array(
            ...
            'dmulaistudiAD'	=> array('label' => 'Tgl Mulai','width' => 100,	'align' => 'center', 'search' => true),
            'dselesaistudiAD' => array('label' => 'Tgl Selesai',	'width' => 100,	'align' => 'center', 'search' => true),
			'cPicstudiAD' => array('label' => 'NIP PIC','width' => 110,	'align' => 'center', 'search' => true),
			...
			'iappAd' => array('label' => 'Approval','width' => 110,	'align' => 'center', 'search' => false),
		);		

		$datagrid['setQuery']=array(
			0 => array('vall' => 'export_refor_studi_literatur_ad.lDeleted', 'nilai' => 0),
			
		);

		$datagrid['jointableinner'] = array(
			0 => $arrayName = array( 'reformulasi.export_req_refor' => 'export_refor_studi_literatur_ad.iexport_req_refor =export_req_refor.iexport_req_refor '),
			1 => array('hrd.employee' => 'employee.cNip = export_refor_studi_literatur_ad.cPicstudiAD'),
		...
		$datagrid['shortBy']=array("export_refor_studi_literatur_ad.iexport_refor_studi_literatur_ad" => "DESC");
    ...
    function index($action = '') {
      ...
      /*  $grid->changeSearch('dPermintaan_req_export','between');*/
		/*$grid->changeSearch('cPicstudiAD','combobox');*/

        $grid->changeFieldType('iSubmit', 'combobox','',array(''=>'--select--',0=>'Draft - Need to be Submit', 1=>'Submited'));
		$grid->changeFieldType('iappAd', 'combobox','',array(''=>'--select--',0=>'Waiting for approval',1=>'Rejected', 2=>'Approved'));
    ...
    function get_data_prev(){
        ...
        function listBox_v2_export_studi_literatur_ad_iapppr($value) {
        ...
        function listBox_Action($row, $actions) {
            ...
            $peka = $row->iexport_refor_studi_literatur_ad;
        ...
        function insertBox_v2_export_studi_literatur_ad_form_detail($field,$id){
            $get=$this->input->get();
            $post=$this->input->post();
        ...
        function updateBox_v2_export_studi_literatur_ad_form_detail($field,$id,$value,$rowData){
            $get=$this->input->get();
            $post=$this->input->post();
            foreach ($get as $kget => $vget) {
                if($kget!="action"){
            ...
            function approve_view() { 
                             ...
                             function submit_ajax(form_id) {
                                return $.ajax({
                                    ...
                                    success: function(data) {
                                        ...
                                        var url = "'.base_url().'processor/reformulasi/v2_export_studi_literatur_ad";                             
                                        if(o.status == true) { 
                                            $("#alert_dialog_form").dialog("close");
                                                 $.get(url+"?action=update&id="+last_id+"&foreign_key=0&company_id=3&group_id="+group_id+"&modul_id="+modul_id, function(data) {
                                                 $("div#form_v2_export_studi_literatur_ad").html(data);
                                                 
                                            });
                                            
                                        }
                                            reload_grid("grid_v2_export_studi_literatur_ad");
                                    }
                ...
                $echo .= '<form id="form_v2_export_studi_literatur_ad_approve" action="'.base_url().'processor/reformulasi/v2_export_studi_literatur_ad?action=approve_process" method="post">';
                ...
                <button type="button" onclick="submit_ajax(\'form_v2_export_studi_literatur_ad_approve\')">Approve</button>';
        ...
        function approve_process() {
            ...
            function confirm_view() { 
                ...
                $echo .= '<form id="form_v2_export_studi_literatur_ad_confirm" action="'.base_url().'processor/reformulasi/v2_export_studi_literatur_ad?action=confirm_process" method="post">';
                $echo .= '<div style="vertical-align: top;">';
                $echo .= 'Remark : 
                        <input type="hidden" name="'.$this->main_table_pk.'" value="'.$this->input->get($this->main_table_pk).'" />
                        <input type="hidden" name="modul_id" value="'.$this->input->get('modul_id').'" />
                        ...
                        <textarea name="vRemark"></textarea>
                <button type="button" onclick="submit_ajax(\'form_v2_export_studi_literatur_ad_confirm\')">Confirm</button>';
            ...
            function reject_view() {
                $echo = '<script type="text/javascript">
                             function submit_ajax(form_id) {
                                var remark = $("#v2_export_studi_literatur_ad_remark").val();
                                if (remark=="") {
                ...
                $echo .= '<form id="form_v2_export_studi_literatur_ad_reject" action="'.base_url().'processor/reformulasi/v2_export_studi_literatur_ad?action=reject_process" method="post">';
                $echo .= '<div style="vertical-align: top;">';
                $echo .= 'Remark : 
                        <input type="hidden" name="'.$this->main_table_pk.'" value="'.$this->input->get($this->main_table_pk).'" />
                        <input type="hidden" name="modul_id" value="'.$this->input->get('modul_id').'" />
                        ...
                        <textarea name="vRemark" id="reject_v2_export_studi_literatur_ad_remark"></textarea>
                <button type="button" onclick="submit_ajax(\'form_v2_export_studi_literatur_ad_reject\')">Reject</button>';
    ...
    function manipulate_insert_buttond($buttons){
        ...
        $save_draft = '<button onclick="javascript:save_draft_btn_multiupload(\'export_studi_literatur_ad\', \''.base_url().'processor/reformulasi/export/studi/literatur/ad?draft=true\', this, true)" class="ui-button-text icon-save" id="button_save_draft_export_studi_literatur_pd_js">Save as Draft</button>';
        $save = '<button onclick="javascript:save_btn_multiupload(\'export_studi_literatur_ad\', \''.base_url().'processor/reformulasi/export/studi/literatur/ad?company_id='.$this->input->get('company_id').'&group_id='.$this->input->get('group_id').'&modul_id='.$this->input->get('modul_id').'\', this)" class="ui-button-text icon-save" id="button_save_export_studi_literatur_pd_js">Save &amp Submit</button>';
 ...
 function manipulate_update_button($buttons, $rowData) { 
        ...
        $iframe = '<iframe name="v2_export_studi_literatur_ad" id="v2_export_studi_literatur_ad" height="0" width="0"></iframe>';
        ...
        if ($this->input->get('action') == 'view') {
            unset($buttons['update']);
                ...
                if($isOpenEditing){
                    $update_draft = '<button onclick="javascript:update_draft_btn(\'v2_export_studi_literatur_ad\', \' '.base_url().'processor/reformulasi/v2_export_studi_literatur_ad?draft=true \',this,true )"  id="button_update_draft_v2_export_studi_literatur_ad"  class="ui-button-text icon-save" >Update open Editing</button>';
                    ...
                    foreach ($activities as $act) {
                        $update_draft = '<button onclick="javascript:update_draft_btn(\'v2_export_studi_literatur_ad\', \' '.base_url().'processor/reformulasi/v2_export_studi_literatur_ad?draft=true&modul_id='.$this->input->get('modul_id').'&iM_modul_activity='.$act['iM_modul_activity'].' \',this,true )"  id="button_update_draft_v2_export_studi_literatur_ad"  class="ui-button-text icon-save" >Update as Draft</button>';
                        $update = '<button onclick="javascript:update_btn_back(\'v2_export_studi_literatur_ad\', \' '.base_url().'processor/reformulasi/v2_export_studi_literatur_ad?company_id='.$this->input->get('company_id').'&modul_id='.$this->input->get('modul_id').'&iM_modul_activity='.$act['iM_modul_activity'].'&group_id='.$this->input->get('group_id').'modul_id='.$this->input->get('modul_id').' \',this,false )"  id="button_update_submit_v2_export_studi_literatur_ad"  class="ui-button-text icon-save" >Update &amp; Submit</button>';

                        $approve = '<button onclick="javascript:load_popup(\' '.base_url().'processor/reformulasi/v2_export_studi_literatur_ad?action=approve&iM_modul_activity='.$act['iM_modul_activity'].'&iM_activity='.$act['iM_activity'].'&'.$this->main_table_pk.'='.$peka.'&iupb_id='.$iupb_id.'&company_id='.$this->input->get('company_id').'&group_id='.$this->input->get('group_id').'&modul_id='.$this->input->get('modul_id').' \')"  id="button_approve_v2_export_studi_literatur_ad"  class="ui-button-text icon-save" >Approve</button>';
                        $reject = '<button onclick="javascript:load_popup(\' '.base_url().'processor/reformulasi/v2_export_studi_literatur_ad?action=reject&iM_modul_activity='.$act['iM_modul_activity'].'&iM_activity='.$act['iM_activity'].'&'.$this->main_table_pk.'='.$peka.'&iupb_id='.$iupb_id.'&company_id='.$this->input->get('company_id').'&group_id='.$this->input->get('group_id').'&modul_id='.$this->input->get('modul_id').' \' )"  id="button_reject_v2_export_studi_literatur_ad"  class="ui-button-text icon-save" >Reject</button>';

                        $confirm = '<button onclick="javascript:load_popup(\' '.base_url().'processor/reformulasi/v2_export_studi_literatur_ad?action=confirm&iM_modul_activity='.$act['iM_modul_activity'].'&iM_activity='.$act['iM_activity'].'&'.$this->main_table_pk.'='.$peka.'&iupb_id='.$iupb_id.'&company_id='.$this->input->get('company_id').'&group_id='.$this->input->get('group_id').'&modul_id='.$this->input->get('modul_id').' \')"  id="button_approve_v2_export_studi_literatur_ad"  class="ui-button-text icon-save" >Confirm</button>';
