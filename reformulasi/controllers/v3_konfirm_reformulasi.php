...
class v3_konfirm_reformulasi extends MX_Controller {
    function __construct() {
		...
		$this->url = 'v3_konfirm_reformulasi';
	...
	/*List Box*/
	function listBox_v3_konfirm_reformulasi_cPIC_AD($value, $pk, $name, $rowData) {
	...
	function listBox_v3_konfirm_reformulasi_dossier_upd_iteampd_id($value, $pk, $name, $rowData) {
	...
	function insertBox_v3_konfirm_reformulasi_form_detail($field,$id){
            $get=$this->input->get();
            $post=$this->input->post();
        ...
        function updateBox_v3_konfirm_reformulasi_form_detail($field,$id,$value,$rowData){
            $get=$this->input->get();
            $post=$this->input->post();
            foreach ($get as $kget => $vget) {
                if($kget!="action"){
