<?php 
	...
	if ($act == 'create'){
	    ...
	    $url2   	= base_url().'processor/reformulasi/v3/export/stabilita/lab/fisik/';
	    $urlParam 	= $url2.'?iexport_stabilita_lab='.$rowDataH['iexport_stabilita_lab'].'&company_id='.$this->input->get('company_id').'&modul_id='.$this->input->get('modul_id').'&group_id='.$this->input->get('group_id'); 
