        ...
        /* Location: ./modules/reformulasi/controllers/lokal_skala_lab.php */
        /* Please DO NOT modify this information : */ 
         
        if ( ! defined('BASEPATH')) exit('No direct script access allowed');
        class lokal_skala_lab extends MX_Controller {
            ...
            function index($action = '') {
                ...
                $grid = new Grid;
                $grid->setTitle('Lokal Skala Lab');
                $grid->setTable('reformulasi.lokal_refor_skala_lab');      
                $grid->setUrl('lokal_skala_lab');

                //List Table
                //$grid->addList('vnoFormulasi','local_req_refor.vNo_req_refor','itemas.c_itnam','local_req_refor.vBatch_no','isubmit_trial','iksm_skala_lab','iappd'); 
                //Revisi 2018-01-15 by : Achmad Aries Pirnando
                $grid->addList('vnoFormulasi','local_req_refor.vNo_req_refor','itemas.c_itnam','isubmit_trial','iksm_skala_lab','iappd'); 
                
                $grid->setSortBy('ilokal_refor_skala_lab');
                $grid->setSortOrder('desc');  

                //List field
                $grid->addFields('iLocal_req_refor','vnoFormulasi','dstart_skala_lab','dfinish_skala_lab','cpic_skala_lab','iuploadtrial','dstart_kimiawi','dfinish_kimiawi','cpic_kimiawi','iksm_kimiawi','dksm_kimiawi','iuploadkimiawi',
                    'dstart_disolusi','dfinish_disolusi','cpic_disolusi','iksm_disolusi','dksm_disolusi',
                    'iuploaddisolusi','iksm_skala_lab','dtrial_ks','iappd'); 
                ...
                */
                ...
                $grid->setLabel('dtrial_ks','Tgl Hasil Skala Lab');
                ...
                $grid->setWidth('dstart_skala_lab', '100');
                $grid->setAlign('dstart_skala_lab', 'left');
                $grid->setLabel('dstart_skala_lab','Tgl Mulai Orientasi Skala Lab');
            
                $grid->setWidth('dfinish_skala_lab', '100');
                $grid->setAlign('dfinish_skala_lab', 'left');
                $grid->setLabel('dfinish_skala_lab','Tgl Selesai Orientasi Skala Lab');
            
                $grid->setWidth('iksm_skala_lab', '150');
                $grid->setAlign('iksm_skala_lab', 'left');
                $grid->setLabel('iksm_skala_lab','Kesimpulan Skala Lab');
                ...
                $grid->changeFieldType('iksm_skala_lab','combobox','',array(''=>'--Selected--',0=>'Tidak Memenuhi Syarat',1=>'Memenuhi Syarat'));
                $grid->setJoinTable('reformulasi.local_req_refor', 'local_req_refor.iLocal_req_refor = lokal_refor_skala_lab.iLocal_req_refor', 'inner');
                ...
                */
                ...
                $grid->setQuery('lokal_refor_skala_lab.lDeleted = 0 ', null);
                //set search
                $grid->setSearch('vnoFormulasi','itemas.c_itnam','local_req_refor.vBatch_no','isubmit_trial'); 
                //$grid->setSearch('dCreate','cCreated','dupdate','cUpdate','lDeleted','iappd','cappd','tappd','dappd','vnoFormulasi','cpic_skala_lab','dstart_skala_lab','dfinish_skala_lab','iksm_skala_lab','cpic_kimiawi','iksm_kimiawi','dksm_kimiawi','dstart_kimiawi','dfinish_kimiawi','cpic_disolusi','iksm_disolusi','dksm_disolusi','dstart_disolusi','dfinish_disolusi');
                
                //set required
                $grid->setRequired('cCreated','dupdate','cUpdate','lDeleted','iappd','cappd','tappd','dappd',
                    'vnoFormulasi','cpic_skala_lab','dstart_skala_lab','dfinish_skala_lab',
                    'iksm_skala_lab'); 
                ...
                switch ($action) {
                    ...
                    case 'createproses':
                            ...
                            if($isUpload) { 
                                ...
                                /* Upload Trial */ 
                                if(!file_exists($path."/"."local/skala_lab/trial"."/".$lastId)){
                                    if (!mkdir($path."/"."local/skala_lab/trial"."/".$lastId, 0777, true)) { 
                                        die('Failed upload, try again!');
                                    }
                                } 
                                $fileketerangan = array();
                                foreach($_POST as $key=>$value) {                       
                                    if ($key == 'fileketerangan_lokal_skala_lab_file') {
                                ...
                                $i=0;
                                 $sql = array();
                                foreach ($_FILES['fileid_lokal_skala_lab_file_upload_lokal_skala_lab_file']["error"] as $key => $error) {
                                    if ($error == UPLOAD_ERR_OK) {
                                        $tmp_name = $_FILES['fileid_lokal_skala_lab_file_upload_lokal_skala_lab_file']["tmp_name"][$key];
                                        $name =$_FILES['fileid_lokal_skala_lab_file_upload_lokal_skala_lab_file']["name"][$key];
                                        $data['filename'] = $name;
                                        $data['dInsertDate'] = date('Y-m-d H:i:s');

                                            if(move_uploaded_file($tmp_name, $path."/"."local/skala_lab/trial"."/".$lastId."/".$name)) {
                                                $sql[]="INSERT INTO reformulasi.local_refor_skala_lab_file(ilokal_refor_skala_lab, 
                                ...
                                /* Upload Kimiawi */ 
                                if(!file_exists($path."/"."local/skala_lab/kimiawi"."/".$lastId)){
                                    if (!mkdir($path."/"."local/skala_lab/kimiawi"."/".$lastId, 0777, true)) { 
                                        die('Failed upload, try again!');
                                    }
                                } 
                                $fileketerangan = array();
                                foreach($_POST as $key=>$value) {                       
                                    if ($key == 'fileketerangan_lokal_skala_lab_file_kimiawi') {
                                        foreach($value as $k=>$v) {
                                            $fileketerangan[$k] = $v;
                                        }
                                    }
                                ...
                                $i=0;
                                 $sql = array();
                                foreach ($_FILES['fileid_lokal_skala_lab_file_kimiawi_upload_lokal_skala_lab_file_kimiawi']["error"] as $key => $error) {
                                    if ($error == UPLOAD_ERR_OK) {
                                        $tmp_name = $_FILES['fileid_lokal_skala_lab_file_kimiawi_upload_lokal_skala_lab_file_kimiawi']["tmp_name"][$key];
                                        $name =$_FILES['fileid_lokal_skala_lab_file_kimiawi_upload_lokal_skala_lab_file_kimiawi']["name"][$key];
                                        $data['filename'] = $name;
                                        $data['dInsertDate'] = date('Y-m-d H:i:s');

                                            if(move_uploaded_file($tmp_name, $path."/"."local/skala_lab/kimiawi"."/".$lastId."/".$name)) {
                                                $sql[]="INSERT INTO reformulasi.local_refor_skala_lab_file(ilokal_refor_skala_lab, 
                                                        vFilename, dCreate, cCreated, 
                                                        tKeterangan,iJenisfile) 
                                                        VALUES (".$lastId.",'".$data['filename']."',
                                ...
                                /* Upload disolusi */ 
                                if(!file_exists($path."/"."local/skala_lab/disolusi"."/".$lastId)){
                                    if (!mkdir($path."/"."local/skala_lab/disolusi"."/".$lastId, 0777, true)) { 
                                        die('Failed upload, try again!');
                                    }
                                } 
                                $fileketerangan = array();
                                foreach($_POST as $key=>$value) {                       
                                    if ($key == 'fileketerangan_lokal_skala_lab_file_disolusi') {
                                        foreach($value as $k=>$v) {
                                            $fileketerangan[$k] = $v;
                                        }
                                    }
                                ...
                                $i=0;
                                 $sql = array();
                                foreach ($_FILES['fileid_lokal_skala_lab_file_disolusi_upload_lokal_skala_lab_file_disolusi']["error"] as $key => $error) {
                                    if ($error == UPLOAD_ERR_OK) {
                                        $tmp_name = $_FILES['fileid_lokal_skala_lab_file_disolusi_upload_lokal_skala_lab_file_disolusi']["tmp_name"][$key];
                                        $name =$_FILES['fileid_lokal_skala_lab_file_disolusi_upload_lokal_skala_lab_file_disolusi']["name"][$key];
                                        $data['filename'] = $name;
                                        $data['dInsertDate'] = date('Y-m-d H:i:s');

                                            if(move_uploaded_file($tmp_name, $path."/"."local/skala_lab/disolusi"."/".$lastId."/".$name)) {
                                                $sql[]="INSERT INTO reformulasi.local_refor_skala_lab_file(ilokal_refor_skala_lab, 
                                                        vFilename, dCreate, cCreated, 
                                                        tKeterangan,iJenisfile) 
                                                        VALUES (".$lastId.",'".$data['filename']."',
                    ...
                    case 'updateproses':
                            ...
                            $lastId=$post['ilokal_refor_skala_lab'];
                            $path = realpath("files/reformulasi/"); 
                            if($isUpload) {
                                ...
                                $fileid1='';
                                foreach($_POST as $key=>$value) {
                                    if ($key == 'fileid_lokal_skala_lab_file') {
                                        $i=0;
                                        foreach($value as $k=>$v) {
                                            if($i==0){
                                                $fileid1 .= "'".$v."'";
                                ...
                                $sql1="update reformulasi.local_refor_skala_lab_file set lDeleted=1, 
                                    dupdate='".$tgl."', cUpdate='".$this->user->gNIP."' where 
                                    ilokal_refor_skala_lab='".$lastId."' and iJenisfile =1 and
                                    ilocal_refor_skala_lab_file not in (".$fileid1.")";
                                $this->db->query($sql1); 
                                ...
                                $fileid1='';
                                foreach($_POST as $key=>$value) {
                                    if ($key == 'fileid_lokal_skala_lab_file_kimiawi') {
                                        $i=0;
                                        foreach($value as $k=>$v) {
                                            if($i==0){
                                                $fileid1 .= "'".$v."'";
                                ...
                                $sql1="update reformulasi.local_refor_skala_lab_file set lDeleted=1, 
                                    dupdate='".$tgl."', cUpdate='".$this->user->gNIP."' where 
                                    ilokal_refor_skala_lab='".$lastId."' and iJenisfile =2 and
                                    ilocal_refor_skala_lab_file not in (".$fileid1.")";
                                $this->db->query($sql1); 
                                ...
                                $fileid1='';
                                foreach($_POST as $key=>$value) {
                                    if ($key == 'fileid_lokal_skala_lab_file_disolusi') {
                                        $i=0;
                                        foreach($value as $k=>$v) {
                                            if($i==0){
                                                $fileid1 .= "'".$v."'";
                                ...
                                $sql1="update reformulasi.local_refor_skala_lab_file set lDeleted=1, 
                                    dupdate='".$tgl."', cUpdate='".$this->user->gNIP."' where 
                                    ilokal_refor_skala_lab='".$lastId."' and iJenisfile =3 and
                                    ilocal_refor_skala_lab_file not in (".$fileid1.")";
                                $this->db->query($sql1); 
            ...
            function listBox_lokal_skala_lab_iappd($value) {
            ...
            function insertBox_lokal_skala_lab_dtrial_ks($field, $id) {
            ...
            function updateBox_lokal_skala_lab_dtrial_ks($field, $id, $value, $rowData) {
            ...
            function insertBox_lokal_skala_lab_iuploadkimiawi($field, $id) {
                $data['rows']=array();
                $return = $this->load->view('local/lokal_skala_lab_file_kimiawi',$data,TRUE);
                return $return;
            }
            function insertBox_lokal_skala_lab_iuploadtrial($field, $id) {
                $data['rows']=array();
                $return = $this->load->view('local/lokal_skala_lab_file',$data,TRUE);
                return $return;
            }
            function insertBox_lokal_skala_lab_iuploaddisolusi($field, $id) {
                $data['rows']=array();
                $return = $this->load->view('local/lokal_skala_lab_file_disolusi',$data,TRUE);
                return $return;
            }

            function updateBox_lokal_skala_lab_iuploadkimiawi($field, $id, $value, $rowData) {
                $sq = "SELECT * FROM reformulasi.`local_refor_skala_lab_file` lr WHERE lr.`lDeleted` = 0 AND 
                    lr.`iJenisfile` = 2 AND lr.`ilokal_refor_skala_lab` ='".$rowData['ilokal_refor_skala_lab']."'";
                $data['rows']=$this->db->query($sq)->result_array();
                $return = $this->load->view('local/lokal_skala_lab_file_kimiawi',$data,TRUE);
                return $return;
            }
            function updateBox_lokal_skala_lab_iuploadtrial($field, $id, $value, $rowData) {
                $sq = "SELECT * FROM reformulasi.`local_refor_skala_lab_file` lr WHERE lr.`lDeleted` = 0 AND 
                    lr.`iJenisfile` = 1 AND lr.`ilokal_refor_skala_lab` ='".$rowData['ilokal_refor_skala_lab']."'";
                $data['rows']=$this->db->query($sq)->result_array();
                $return = $this->load->view('local/lokal_skala_lab_file',$data,TRUE);
                return $return;
            }
            function updateBox_lokal_skala_lab_iuploaddisolusi($field, $id, $value, $rowData) {
                $sq = "SELECT * FROM reformulasi.`local_refor_skala_lab_file` lr WHERE lr.`lDeleted` = 0 AND 
                    lr.`iJenisfile` = 3 AND lr.`ilokal_refor_skala_lab` ='".$rowData['ilokal_refor_skala_lab']."'";
                $data['rows']=$this->db->query($sq)->result_array();
                $return = $this->load->view('local/lokal_skala_lab_file_disolusi',$data,TRUE);
                return $return;
            }
            ...
            function insertBox_lokal_skala_lab_iLocal_req_refor($field, $id) {     
                $uri = 'lokal_skala_lab';
                $o = "";  
                $o   .= "<div style='
                                padding: 3px;
                ...
                $o .= '         &nbsp;<button class="icon_pop"  onclick="browse(\''.base_url().'processor/reformulasi/browse/skala/lab/?field=lokal_skala_lab\',\'Request Reformulasi\')" type="button">Browse</button>';  
                $o  .="             </td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td>:</td>
                                    <td width='75%'> 
                                        <span class='".$uri."_vBatch_no' id='".$uri."_vBatch_no'></span> 
                                    </td>
                                </tr>
            ...
            function updateBox_lokal_skala_lab_iLocal_req_refor($field, $id, $value, $rowData) {
                ...
                if(!empty($dt['iLocal_req_refor'])){
                        ...
                        $_iupload_f =  $this->load->view('local/lokal_skala_lab_ref_file',$data,TRUE);
            ...
            function insertBox_lokal_skala_lab_dupdate($field, $id) {
                $return = '<input type="text" name="'.$field.'"  id="'.$id.'"  class="input_rows1 required" size="30" />';
                $return .= '<script>
                                $("#'.$id.'").datepicker({  changeMonth:true,
                                        changeYear:true,
            ...
            function updateBox_lokal_skala_lab_dupdate($field, $id, $value, $rowData) {
                if ($this->input->get('action') == 'view') {
                     $return= $value; 
                }else{
                $return = '<input type="text" name="'.$field.'"  id="'.$id.'"  class="input_rows1 required" size="30" value="'.$value.'"/>';
            ...
            function insertBox_lokal_skala_lab_cUpdate($field, $id) {
            ...
            function updateBox_lokal_skala_lab_cUpdate($field, $id, $value, $rowData) {
                if ($this->input->get('action') == 'view') {
                     $return= $value; 
                }else{
            ...
            function insertBox_lokal_skala_lab_lDeleted($field, $id) {
                $return = '<input type="text" name="'.$field.'"  id="'.$id.'"  class="input_rows1 required" size="30" />';
                $return .= '<script>
                                $("#'.$id.'").keyup(function() {
            ...
            function updateBox_lokal_skala_lab_lDeleted($field, $id, $value, $rowData) {
                if ($this->input->get('action') == 'view') {
                     $return= $value; 
                }else{
                $return = '<input type="text" name="'.$field.'"  id="'.$id.'"  class="input_rows1 required" size="30" value="'.$value.'"/>';
            ...
            function insertBox_lokal_skala_lab_iappd($field, $id) {
                $return ='';
                $return .= '
            ...
            function updateBox_lokal_skala_lab_iappd($field, $id, $value, $rowData) {
                if(($value <> 0) || (!empty($value))){
                    $sql_dtapp = "SELECT * FROM reformulasi.`lokal_refor_skala_lab` a JOIN hrd.employee b on b.cNip=a.cappd
                    WHERE a.`lDeleted` = 0 AND a.ilokal_refor_skala_lab = '".$rowData['ilokal_refor_skala_lab']."'";
            ...
            function insertBox_lokal_skala_lab_cappd($field, $id) {
                $return = '<input type="text" name="'.$field.'"  id="'.$id.'"  class="input_rows1 required" size="30" maxlength = "50" />';
                $return .= '<script>
                                $("#'.$id.'").keyup(function() {
                                    var len = this.value.length;
            ...
            function updateBox_lokal_skala_lab_cappd($field, $id, $value, $rowData) {
                if ($this->input->get('action') == 'view') {
                     $return= $value; 
                }else{
                $return = '<input type="text" name="'.$field.'"  id="'.$id.'"  class="input_rows1 required" size="30" maxlength = "50"  value="'.$value.'"/>';
            ...
            function insertBox_lokal_skala_lab_tappd($field, $id) {
            ...
            function updateBox_lokal_skala_lab_tappd($field, $id, $value, $rowData) {
                if ($this->input->get('action') == 'view') {
            ...
            function insertBox_lokal_skala_lab_dappd($field, $id) {
                $return = '<input type="text" name="'.$field.'"  id="'.$id.'"  class="input_rows1 required" size="30" />';
                $return .= '<script>
                                $("#'.$id.'").datepicker({  changeMonth:true,
                                        changeYear:true,
            ...
            function updateBox_lokal_skala_lab_dappd($field, $id, $value, $rowData) {
                if ($this->input->get('action') == 'view') {
                     $return= $value; 
                }else{
                $return = '<input type="text" name="'.$field.'"  id="'.$id.'"  class="input_rows1 required" size="30" value="'.$value.'"/>';
            ...
            function insertBox_lokal_skala_lab_vnoFormulasi($field, $id) {
                $return = '<input readonly type="text" name="'.$field.'"  id="'.$id.'"  class="'.$id.' input_rows1 required" size="30" maxlength = "50" />';
                $return .= '';
                return $return;
            }
            function updateBox_lokal_skala_lab_vnoFormulasi($field, $id, $value, $rowData) {
                if ($this->input->get('action') == 'view') {
                     $return= $value; 
                }else{
            ...
            function insertBox_lokal_skala_lab_cpic_skala_lab($field, $id) {  
                $url6 = base_url().'processor/reformulasi/lokal/skala/lab?action=searchcNip'; 
            ...
            function updateBox_lokal_skala_lab_cpic_skala_lab($field, $id, $value, $rowData) {
            ...
            function insertBox_lokal_skala_lab_dstart_skala_lab($field, $id) {
                $return = '<input type="text" name="'.$field.'"  id="'.$id.'"  class="input_rows1 required" size="30" />';
                $return .= '<script>
                                $("#'.$id.'").datepicker({  changeMonth:true,
                                        changeYear:true,
            ...
            function updateBox_lokal_skala_lab_dstart_skala_lab($field, $id, $value, $rowData) {
                if ($this->input->get('action') == 'view') {
                     $return= $value; 
                }else{
                $return = '<input type="text" name="'.$field.'"  id="'.$id.'"  class="input_rows1 required" size="30" value="'.$value.'"/>';
            ...
            function insertBox_lokal_skala_lab_dfinish_skala_lab($field, $id) {
                $return = '<input type="text" name="'.$field.'"  id="'.$id.'"  class="input_rows1 required" size="30" />';
                $return .= '<script>
                                $("#'.$id.'").datepicker({  changeMonth:true,
                                        changeYear:true,
            ...
            function updateBox_lokal_skala_lab_dfinish_skala_lab($field, $id, $value, $rowData) {
                if ($this->input->get('action') == 'view') {
                     $return= $value; 
                }else{
                $return = '<input type="text" name="'.$field.'"  id="'.$id.'"  class="input_rows1 required" size="30" value="'.$value.'"/>';
            ...
            function insertBox_lokal_skala_lab_iksm_skala_lab($field, $id) {
            ...
            function updateBox_lokal_skala_lab_iksm_skala_lab($field, $id, $value, $rowData) {
            ...
            function insertBox_lokal_skala_lab_cpic_kimiawi($field, $id) {
                $url6 = base_url().'processor/reformulasi/lokal/skala/lab?action=searchcNip'; 
                $o = "<script type='text/javascript'>
                                $(document).ready(function() { 
                                    $('#".$id."_').live('keyup', function(e) {
            ...
            function updateBox_lokal_skala_lab_cpic_kimiawi($field, $id, $value, $rowData) {
                $vn = "SELECT e.`vName` FROM hrd.`employee` e WHERE e.`cNip` = '".$value."'";
                $vName = $this->db->query($vn)->row_array();
                if(empty($vName['vName'])){
                    $vName['vName'] = '-';
            ...
            function insertBox_lokal_skala_lab_iksm_kimiawi($field, $id) {
                $return = '<select id="'.$id.'" class="combobox" name="'.$field.'">
                            <option value="">--Select--</option>
                            <option value="0">TMS</option>
                            <option value="1">MS</option>
            ...
            function updateBox_lokal_skala_lab_iksm_kimiawi($field, $id, $value, $rowData) {
                $ast = array(''=>'--Select--','0'=>'TMS','1'=>'MS'); 
            ...
            function insertBox_lokal_skala_lab_dksm_kimiawi($field, $id) {
            ...
            function updateBox_lokal_skala_lab_dksm_kimiawi($field, $id, $value, $rowData) {
                if ($this->input->get('action') == 'view') {
                     $return= $value; 
                }else{
            ...
            function insertBox_lokal_skala_lab_dstart_kimiawi($field, $id) {
                $return = '<input type="text" name="'.$field.'"  id="'.$id.'"  class="input_rows1 " size="30" />';
                $return .= '<script>
                                $("#'.$id.'").datepicker({  changeMonth:true,
                                        changeYear:true,
            ...
            function updateBox_lokal_skala_lab_dstart_kimiawi($field, $id, $value, $rowData) {
                if ($this->input->get('action') == 'view') {
                     $return= $value; 
                }else{
                $return = '<input type="text" name="'.$field.'"  id="'.$id.'"  class="input_rows1 " size="30" value="'.$value.'"/>';
            ...
            function insertBox_lokal_skala_lab_dfinish_kimiawi($field, $id) {
                $return = '<input type="text" name="'.$field.'"  id="'.$id.'"  class="input_rows1 " size="30" />';
                $return .= '<script>
                                $("#'.$id.'").datepicker({  changeMonth:true,
                                        changeYear:true,
            ...
            function updateBox_lokal_skala_lab_dfinish_kimiawi($field, $id, $value, $rowData) {
                if ($this->input->get('action') == 'view') {
                     $return= $value; 
                }else{
                $return = '<input type="text" name="'.$field.'"  id="'.$id.'"  class="input_rows1 " size="30" value="'.$value.'"/>';
            ...
            function insertBox_lokal_skala_lab_cpic_disolusi($field, $id) {
                $url6 = base_url().'processor/reformulasi/lokal/skala/lab?action=searchcNip'; 
                $o = "<script type='text/javascript'>
                                $(document).ready(function() { 
                                    $('#".$id."_').live('keyup', function(e) {
            ...
            function updateBox_lokal_skala_lab_cpic_disolusi($field, $id, $value, $rowData) {
                $vn = "SELECT e.`vName` FROM hrd.`employee` e WHERE e.`cNip` = '".$value."'";
                $vName = $this->db->query($vn)->row_array();
                if(empty($vName['vName'])){
                    $vName['vName'] = '-';
            ...
            function insertBox_lokal_skala_lab_iksm_disolusi($field, $id) {
                 $return = '<select id="'.$id.'" class="combobox" name="'.$field.'">
                            <option value="">--Select--</option>
                            <option value="0">TMS</option>
                            <option value="1">MS</option>
            ...
            function updateBox_lokal_skala_lab_iksm_disolusi($field, $id, $value, $rowData) {
                $ast = array(''=>'--Select--','0'=>'TMS','1'=>'MS'); 
            ...
            function insertBox_lokal_skala_lab_dksm_disolusi($field, $id) {
                $return = '<input type="text" name="'.$field.'"  id="'.$id.'"  class="input_rows1" size="30" />';
                $return .= '<script>
                                $("#'.$id.'").datepicker({  changeMonth:true,
                                        changeYear:true,
            ...
            function updateBox_lokal_skala_lab_dksm_disolusi($field, $id, $value, $rowData) {
                if ($this->input->get('action') == 'view') {
                     $return= $value; 
                }else{
                $return = '<input type="text" name="'.$field.'"  id="'.$id.'"  class="input_rows1" size="30" value="'.$value.'"/>';
            ...
            function insertBox_lokal_skala_lab_dstart_disolusi($field, $id) {
                $return = '<input type="text" name="'.$field.'"  id="'.$id.'"  class="input_rows1" size="30" />';
                $return .= '<script>
                                $("#'.$id.'").datepicker({  changeMonth:true,
                                        changeYear:true,
            ...
            function updateBox_lokal_skala_lab_dstart_disolusi($field, $id, $value, $rowData) {
                if ($this->input->get('action') == 'view') {
                     $return= $value; 
                }else{
                $return = '<input type="text" name="'.$field.'"  id="'.$id.'"  class="input_rows1" size="30" value="'.$value.'"/>';
                ...
                $return .= '<input type="hidden" name="ilokal_refor_skala_lab"  id="ilokal_refor_skala_lab"  
                            class="input_rows1" size="30" value="'.$rowData['ilokal_refor_skala_lab'].'"/>';
                
                } 
                return $return;
            }   
            
            function insertBox_lokal_skala_lab_dfinish_disolusi($field, $id) {
                $return = '<input type="text" name="'.$field.'"  id="'.$id.'"  class="input_rows1" size="30" />';
                $return .= '<script>
                                $("#'.$id.'").datepicker({  changeMonth:true,
                                        changeYear:true,
            ...
            function updateBox_lokal_skala_lab_dfinish_disolusi($field, $id, $value, $rowData) {
                if ($this->input->get('action') == 'view') {
                     $return= $value; 
                }else{
                $return = '<input type="text" name="'.$field.'"  id="'.$id.'"  class="input_rows1" size="30" value="'.$value.'"/>';
                ...
                function approve_view() {
                                 ...
                                 function submit_ajax(form_id) {
                                    return $.ajax({
                                        ...
                                        success: function(data) {
                                            ...
                                            var url = "'.base_url().'processor/reformulasi/lokal_skala_lab";                             
                                            if(o.status == true) { 
                                                $("#alert_dialog_form").dialog("close");
                                                     $.get(url+"?action=update&id="+last_id, function(data) {
                                                     $("div#form_lokal_skala_lab").html(data);
                                                     
                                                });
                                                
                                            }
                                                reload_grid("grid_lokal_skala_lab");
                                        }
                    ...
                    $echo .= '<form id="form_lokal_skala_lab_approve" action="'.base_url().'processor/reformulasi/lokal_skala_lab?action=approve_process" method="post">';
                    $echo .= '<div style="vertical-align: top;">';
                    $echo .= 'Remark : 
                            <input type="hidden" name="ilokal_refor_skala_lab" value="'.$this->input->get('ilokal_refor_skala_lab').'" />
                            <input type="hidden" name="lvl" value="'.$this->input->get('lvl').'" />
                            <input type="hidden" name="group_id" value="'.$this->input->get('group_id').'" />
                            <input type="hidden" name="modul_id" value="'.$this->input->get('modul_id').'" />
                            <textarea name="vRemark"></textarea>
                    <button type="button" onclick="submit_ajax(\'form_lokal_skala_lab_approve\')">Approve</button>';
                ...
                function approve_process() {
                    ...
                    $ilokal_refor_skala_lab = $post['ilokal_refor_skala_lab'];
                    ...
                    $this->db->where('ilokal_refor_skala_lab', $post['ilokal_refor_skala_lab']);
                    $this->db->update('reformulasi.lokal_refor_skala_lab', array('iappd'=>2,'cappd'=>$nip,'dappd'=>$skg,'tappd'=>$vRemark));

                    $to = $cc = '';  
                    $sql = "SELECT * FROM 
                            reformulasi.`lokal_refor_skala_lab` st WHERE st.`lDeleted` = 0 
                            AND st.`ilokal_refor_skala_lab` = '".$post['ilokal_refor_skala_lab']."'";

                    $dtm = $this->db->query($sql)->row_array();

                    if($dtm['iksm_skala_lab']==0){
                        //Update Skala Trial
                    ...
                    $iAm3 = $this->whoAmI($dtm['cpic_skala_lab']); 
                    ...
                    $subject="Approval Skala Lab: No Formula ".$dtm['vnoFormulasi']; 
                        $content="
                        Diberitahukan bahwa telah ada Approval Skala Lab, 
                            ...
                            <table border='0' style='width: 600px;'>
                                ...
                                <tr>
                                        ...
                                        <td>".$arr[$dtm['iksm_skala_lab']]."</td>
                                </tr>  
                            </table> 
                        <br/> 
                        Link Aplikasi : www.npl-net.com/erp <br>
                        Menu : Reformulasi - Transaksi - Skala Lab
                        <br/> <br/>
                    ...
                    $data['status']  = true;
                    $data['last_id'] = $post['ilokal_refor_skala_lab'];
                ...
                function reject_view() {
                    $echo = '<script type="text/javascript">
                                 function submit_ajax(form_id) {
                                    var remark = $("#lokal_skala_lab_remark").val();
                                    if (remark=="") {
                    ...
                    $echo .= '<form id="form_lokal_skala_lab_reject" action="'.base_url().'processor/reformulasi/lokal_skala_lab?action=reject_process" method="post">';
                    $echo .= '<div style="vertical-align: top;">';
                    $echo .= 'Remark : 
                            <input type="hidden" name="ilokal_refor_skala_lab" value="'.$this->input->get('ilokal_refor_skala_lab').'" />
                            <input type="hidden" name="lvl" value="'.$this->input->get('lvl').'" />
                            <input type="hidden" name="group_id" value="'.$this->input->get('group_id').'" />
                            <input type="hidden" name="modul_id" value="'.$this->input->get('modul_id').'" />
                            <textarea name="vRemark" id="reject_lokal_skala_lab_remark"></textarea>
                    <button type="button" onclick="submit_ajax(\'form_lokal_skala_lab_reject\')">Reject</button>';
                ...
                function reject_process() {
                    ...
                    $skg=date('Y-m-d H:i:s'); 
                    $this->db->where('ilokal_refor_skala_lab', $post['ilokal_refor_skala_lab']);
                    $this->db->update('reformulasi.lokal_refor_skala_lab', array('iappd'=>1,'cappd'=>$nip,'dappd'=>$skg,'tappd'=>$vRemark));
            ...
            function after_insert_processor($fields, $id, $postData) {
                ...
                */
                ...
                if($postData['isubmit_trial']==1){
                    ...
                    $sql = "SELECT * FROM 
                            reformulasi.`lokal_refor_skala_lab` st WHERE st.`lDeleted` = 0 
                            AND st.`ilokal_refor_skala_lab` = '".$id."'";   
                    $dtm = $this->db->query($sql)->row_array();
                    ...
                    $subject="Submited Skala Lab: No Formula ".$dtm['vnoFormulasi']; 
                        $content="
                        Diberitahukan bahwa telah ada Submited Skala Lab, 
                            dengan rincian sebagai berikut :<br><br>  
                            <table border='0' style='width: 600px;'>
                                <tr>
                                        <td style='width: 110px;'><b>No Formulasi </b></td><td style='width: 20px;'> : </td>
            ...
            function manipulate_insert_button($buttons) {
                unset($buttons['save']);
                $js = $this->load->view('local/js/lokal_skala_lab_js'); 

                $save_draft = '<button onclick="javascript:save_draft_btn_multiupload(\'lokal_skala_lab\', \''.base_url().'processor/reformulasi/lokal/skala/lab?draft=true\', this, true)" class="ui-button-text icon-save" id="button_save_draft_lokal_skala_lab_js">Save as Draft</button>';
                $save = '<button onclick="javascript:save_btn_multiupload(\'lokal_skala_lab\', \''.base_url().'processor/reformulasi/lokal/skala/lab?company_id='.$this->input->get('company_id').'&group_id='.$this->input->get('group_id').'&modul_id='.$this->input->get('modul_id').'\', this)" class="ui-button-text icon-save" id="button_save_lokal_skala_lab_js">Save &amp Submit</button>';
            ...
            function manipulate_update_button($buttons, $rowData) { 
                ...
                if ($this->input->get('action') == 'view') {
                    ...
                    $js = $this->load->view('local/js/lokal_skala_lab_js'); 
                    $update = '<button onclick="javascript:update_btn_back(\'lokal_skala_lab\', \''.base_url().'processor/reformulasi/lokal/skala/lab?company_id='.$this->input->get('company_id').'&group_id='.$this->input->get('group_id').'&modul_id='.$this->input->get('modul_id').'\', this)" class="ui-button-text icon-save" id="button_update_lokal_skala_lab">Update & Submit</button>';
                    $updatedraft = '<button onclick="javascript:update_draft_btn(\'lokal_skala_lab\', \''.base_url().'processor/reformulasi/lokal/skala/lab?company_id='.$this->input->get('company_id').'&draft=true&group_id='.$this->input->get('group_id').'&modul_id='.$this->input->get('modul_id').'\', this, true)" class="ui-button-text icon-save" id="button_save_lokal_skala_lab">Update as Draft</button>';
                    
                    $approve = '<button onclick="javascript:load_popup(\''.base_url().'processor/reformulasi/lokal/skala/lab?action=approve&ilokal_refor_skala_lab='.$rowData['ilokal_refor_skala_lab'].'&cNip='.$cNip.'&lvl=1&status=1&group_id='.$this->input->get('group_id').'&modul_id='.$this->input->get('modul_id').'\')" class="ui-button-text icon-save" id="button_approve_lokal_skala_lab">Approve</button>';
                    $reject = '<button onclick="javascript:load_popup(\''.base_url().'processor/reformulasi/lokal/skala/lab?action=reject&ilokal_refor_skala_lab='.$rowData['ilokal_refor_skala_lab'].'&cNip='.$cNip.'&lvl=1&status=2&group_id='.$this->input->get('group_id').'&modul_id='.$this->input->get('modul_id').'\')" class="ui-button-text icon-save" id="button_reject_lokal_skala_lab">Reject</button>';
            ...
            function download($filename) {
                ...
                $id = $_GET['id'];
                $file = $_GET['filepath'];
                $path = file_get_contents('./files/reformulasi/local/skala_lab/'.$file.'/'.$id.'/'.$name);   
