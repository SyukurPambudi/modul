        ...
        /* Location: ./modules/reformulasi/controllers/terima_request.php */
        /* Please DO NOT modify this information : */ 
         
        if ( ! defined('BASEPATH')) exit('No direct script access allowed');
        class terima_request extends MX_Controller {
            ...
            function index($action = '') {
                ...
                $grid = new Grid;
                $grid->setTitle('Terima Request Reformulasi');
                $grid->setTable('plc2.req_refor');      
                $grid->setUrl('terima_request');
                ...
                //List field
                $grid->addFields('istatus_terima_req','vNo_req_refor','tTanggal_usulan_refor','vNo_deviasi','vbatch_no','iNo_usulan','iKey','cNIP','idept_id','iteam_pd','vAlasan_refor','vFile','cformulator','vreason_terima'); 
                ...
                */
                ...
                $grid->setLabel('istatus_terima_req','Status Terima Refor');
                ...
                */
                ...
                //set required
                $grid->setRequired('vNo_req_refor','vNo_deviasi','iNo_usulan','iKey','vbatch_no','cNIP','idept_id','tTanggal_usulan_refor','vAlasan_refor','iteam_pd','iStatus','iSubmit','cApproved','vreason_approved','cformulator','istatus_terima_req','cApproved_terima','dApproved_terima','dTgl_rev_mbr','vNo_cc','dPengajuan_cc','iStatus_cc','dApproved_cc','cApproved_cc','dUji_BE','dSelesai_uji_BE','vNo_hasil_uji_BE','vHasil_uji_BE','iStatus_uji_BE','dApproved_uji_BE','cApproved_uji_BE','dCreate','cCreated','dupdate','cUpdate','lDeleted'); 
                ...
                switch ($action) {
                    ...
                    case 'createproses':
                            ...
                            if($isUpload) {
                                ...
                                $path = realpath("files/reformulasi/terima_request");
                    ...
                    case 'updateproses':
                            ...
                            if (!file_exists( $path."/".$this->input->post('terima_request_Req_refor_ID') )) {
                                mkdir($path."/".$this->input->post('terima_request_Req_refor_ID'), 0777, true);                      
                            }
                            ...
                            if($isUpload) {
                                ...
                                if (isset($_FILES['fileupload'])) {
                                    $this->hapusfile($path, $file_name, 'req_refor_file', $this->input->post('terima_request_Req_refor_ID'));
                                    foreach ($_FILES['fileupload']["error"] as $key => $error) {    
                                        if ($error == UPLOAD_ERR_OK) {
                                            $tmp_name = $_FILES['fileupload']["tmp_name"][$key];
                                            $name = $_FILES['fileupload']["name"][$key];
                                            $data['vFilename'] = $name;
                                            $data['id']=$this->input->post('terima_request_Req_refor_ID');
                                            $data['nip']=$this->user->gNIP;
                                            $data['dCreate'] = date('Y-m-d H:i:s');
                                            //$file_tanggal[$i] = date('l, F jS, Y', strtotime($file_tanggal[$i]));     
                                            if(move_uploaded_file($tmp_name, $path."/".$this->input->post('terima_request_Req_refor_ID')."/".$name)) 
                                            {                                   
            ...
            function listBox_Action($row, $actions) {
                $istatus_terima_req = $row->istatus_terima_req;
            ...
            function insertBox_terima_request_vNo_req_refor($field, $id) {
            ...
            function updateBox_terima_request_vNo_req_refor($field, $id, $value, $rowData) {
            ...
            function insertBox_terima_request_vNo_deviasi($field, $id) {
            ...
            function updateBox_terima_request_vNo_deviasi($field, $id, $value, $rowData) {
            ...
            function insertBox_terima_request_iNo_usulan($field, $id) {
                $return = '<script>
                ...
                $return .= '&nbsp;<button class="icon_pop"  onclick="browse(\''.base_url().'processor/reformulasi/browse/request/product?field=terima_request\',\'List Product\')" type="button">&nbsp;</button>';                
                
                return $return;
            }

            function updateBox_terima_request_iNo_usulan($field, $id, $value, $rowData) {
                $sqlD = ' select * from (
            ...
            function insertBox_terima_request_iKey($field, $id) {
            ...
            function updateBox_terima_request_iKey($field, $id, $value, $rowData) {
                if ($value==1) {
                    $pField =  'Refor Local';
                }else if ($value==2){
                    $pField =  'Refor Export';
                ...
                if ($this->input->get('action') == 'view') {
                    ...
                    $return .= '<input type="hidden"   id="'.$id.'_dis" readonly="readony" class="input_rows1 required" size="10" value="'.$pField.'" />';
              
                } 
                return $return;
            } 

            function insertBox_terima_request_vbatch_no($field, $id) {
                $return = '<script>
                                $( "button.icon_pop" ).button({
                                    icons: {
                                        primary: "ui-icon-newwin"
                ...
                $return .= '<input type="hidden" name="'.$field.'" id="'.$id.'" class="input_rows1 required" />
                            ';
                $return .= '<input type="text" name="'.$id.'_dis" class="required" disabled="TRUE" id="'.$id.'_dis" class="input_rows1" size="45" />';
                $return .= '&nbsp;<button class="icon_pop"  onclick="browse(\''.base_url().'processor/reformulasi/browse/request/batch?field=terima_request\',\'List Batch\')" type="button">&nbsp;</button>';                
                
                return $return;
            }

            function updateBox_terima_request_vbatch_no($field, $id, $value, $rowData) {
            ...
            function insertBox_terima_request_vbatch_nox($field, $id) {
                $return = '<input type="text" name="'.$field.'"  id="'.$id.'"  class="input_rows1 required" size="30" maxlength = "50" />';
                $return .= '<script>
                                $("#'.$id.'").keyup(function() {
                                    var len = this.value.length;
            ...
            function updateBox_terima_request_vbatch_nox($field, $id, $value, $rowData) {
                if ($this->input->get('action') == 'view') {
                     $return= $value; 
                }else{
            ...
            function insertBox_terima_request_cNIP($field, $id) {
            ...
            function updateBox_terima_request_cNIP($field, $id, $value, $rowData) {
            ...
            function insertBox_terima_request_idept_id($field, $id) {
                $iAm = $this->whoAmI($this->user->gNIP);
            ...
            function updateBox_terima_request_idept_id($field, $id, $value, $rowData) {
            ...
            function insertBox_terima_request_iteam_pd($field, $id) {
                $sql = "SELECT t.* FROM plc2.plc2_upb_team t
                        WHERE t.vtipe = 'PD' AND t.ldeleted = '0' AND t.iteam_id IN (1,2,3)";
            ...
            function updateBox_terima_request_iteam_pd($field, $id, $value, $rowData) {
                $sql = "SELECT t.* FROM plc2.plc2_upb_team t
                        WHERE t.vtipe = 'PD' AND t.ldeleted = '0' and t.iteam_id IN (".$value.")";
            ...
            function insertBox_terima_request_tTanggal_usulan_refor($field, $id) {
                $return = '<input type="text" name="'.$field.'" value="'.date('Y-m-d').'" readonly="readonly" id="'.$id.'" class="  input_rows1 required" size="8" />';
                return $return;
            }

            function updateBox_terima_request_tTanggal_usulan_refor($field, $id, $value, $rowData) {
                if ($this->input->get('action') == 'view') {
                    $return= $value;
            ...
            function insertBox_terima_request_vAlasan_refor($field, $id) {
            ...
            function updateBox_terima_request_vAlasan_refor($field, $id, $value, $rowData) {
                if ($this->input->get('action') == 'view') {
            ...
            function insertBox_terima_request_istatus_terima_req($field, $id) {
                $o='-';
                $o.='
            ...
            function updateBox_terima_request_istatus_terima_req($field, $id, $value, $rowData) {
                if(($value <> 0) || (!empty($value))){
                    $sql_dtapp = 'select * 
                                from plc2.req_refor a 
                                join hrd.employee b on b.cNip=a.cApproved_terima
                                where
                                a.lDeleted = 0
                                and  a.Req_refor_ID = "'.$rowData['Req_refor_ID'].'"';
                    $row = $this->db->query($sql_dtapp)->row_array();
                    if($value==1){
                        $st='<p style="color:green;font-size:120%;">Diterima';
                        $ret= $st.' oleh '.$row['vName'].' pada '.$row['dApproved_terima'].'</br> Alasan: '.$row['vreason_terima'].'</p>';
                    }
                    elseif($value==2){
            ...
            function insertBox_terima_request_iSubmit($field, $id) {
            ...
            function updateBox_terima_request_iSubmit($field, $id, $value, $rowData) {
                if ($this->input->get('action') == 'view') {
                     $return= $value; 
                }else{
            ...
            function insertBox_terima_request_cApproved($field, $id) {
                $return = '<input type="text" name="'.$field.'"  id="'.$id.'"  class="input_rows1 required" size="30" maxlength = "50" />';
                $return .= '<script>
                                $("#'.$id.'").keyup(function() {
                                    var len = this.value.length;
            ...
            function updateBox_terima_request_cApproved($field, $id, $value, $rowData) {
                if ($this->input->get('action') == 'view') {
                     $return= $value; 
                }else{
                $return = '<input type="text" name="'.$field.'"  id="'.$id.'"  class="input_rows1 required" size="30" maxlength = "50"  value="'.$value.'"/>';
            ...
            function insertBox_terima_request_vreason_approved($field, $id) {
            ...
            function updateBox_terima_request_vreason_approved($field, $id, $value, $rowData) {
                if ($this->input->get('action') == 'view') {
                     $return= $value; 
                }else{
            ...
            function insertBox_terima_request_istatus_terima_reqx($field, $id) {
                $return = '<input type="text" name="'.$field.'"  id="'.$id.'"  class="input_rows1 required" size="30" />';
                $return .= '<script>
                                $("#'.$id.'").keyup(function() {
                                     this.value = this.value.replace(/[^0-9\.]/g,"");
            ...
            function updateBox_terima_request_istatus_terima_reqx($field, $id, $value, $rowData) {
                if ($this->input->get('action') == 'view') {
                     $return= $value; 
                }else{
                $return = '<input type="text" name="'.$field.'"  id="'.$id.'"  class="input_rows1 required" size="30" value="'.$value.'"/>';
            ...
            function insertBox_terima_request_cApproved_terima($field, $id) {
                $return = '<input type="text" name="'.$field.'"  id="'.$id.'"  class="input_rows1 required" size="30" maxlength = "50" />';
                $return .= '<script>
                                $("#'.$id.'").keyup(function() {
                                    var len = this.value.length;
            ...
            function updateBox_terima_request_cApproved_terima($field, $id, $value, $rowData) {
                if ($this->input->get('action') == 'view') {
                     $return= $value; 
                }else{
                $return = '<input type="text" name="'.$field.'"  id="'.$id.'"  class="input_rows1 required" size="30" maxlength = "50"  value="'.$value.'"/>';
            ...
            function insertBox_terima_request_dApproved_terima($field, $id) {
                $return = '<input type="text" name="'.$field.'"  id="'.$id.'"  class="input_rows1 required" size="30" />';
                $return .= '<script>
            ...
            function updateBox_terima_request_dApproved_terima($field, $id, $value, $rowData) {
                if ($this->input->get('action') == 'view') {
                     $return= $value; 
                }else{
                $return = '<input type="text" name="'.$field.'"  id="'.$id.'"  class="input_rows1 required" size="30" value="'.$value.'"/>';
            ...
            function insertBox_terima_request_vreason_terima($field, $id) {
                $return = '<input type="text" name="'.$field.'"  id="'.$id.'"  class="input_rows1 required" size="30" maxlength = "200" />';
                return $return;
            }
            function updateBox_terima_request_vreason_terima($field, $id, $value, $rowData) {
                if ($this->input->get('action') == 'view') {
                     $return= nl2br($value); 
                }else{
                    $return = '<textarea name="'.$field.'"  id="'.$id.'" class="input_rows1 required" >'.nl2br($value).' </textarea>';
                } 
                return $return;
            }   
            
            function insertBox_terima_request_dTgl_rev_mbr($field, $id) {
                $return = '<input type="text" name="'.$field.'"  id="'.$id.'"  class="input_rows1 required" size="30" />';
                $return .= '<script>
                                $("#'.$id.'").datepicker({  changeMonth:true,
                                        changeYear:true,
            ...
            function updateBox_terima_request_dTgl_rev_mbr($field, $id, $value, $rowData) {
                if ($this->input->get('action') == 'view') {
                     $return= $value; 
                }else{
                $return = '<input type="text" name="'.$field.'"  id="'.$id.'"  class="input_rows1 required" size="30" value="'.$value.'"/>';
            ...
            function insertBox_terima_request_vNo_cc($field, $id) {
                $return = '<input type="text" name="'.$field.'"  id="'.$id.'"  class="input_rows1 required" size="30" maxlength = "50" />';
                $return .= '<script>
                                $("#'.$id.'").keyup(function() {
                                    var len = this.value.length;
            ...
            function updateBox_terima_request_vNo_cc($field, $id, $value, $rowData) {
                if ($this->input->get('action') == 'view') {
                     $return= $value; 
                }else{
                $return = '<input type="text" name="'.$field.'"  id="'.$id.'"  class="input_rows1 required" size="30" maxlength = "50"  value="'.$value.'"/>';
            ...
            function insertBox_terima_request_dPengajuan_cc($field, $id) {
                $return = '<input type="text" name="'.$field.'"  id="'.$id.'"  class="input_rows1 required" size="30" />';
                $return .= '<script>
                                $("#'.$id.'").datepicker({  changeMonth:true,
                                        changeYear:true,
            ...
            function updateBox_terima_request_dPengajuan_cc($field, $id, $value, $rowData) {
                if ($this->input->get('action') == 'view') {
                     $return= $value; 
                }else{
                $return = '<input type="text" name="'.$field.'"  id="'.$id.'"  class="input_rows1 required" size="30" value="'.$value.'"/>';
            ...
            function insertBox_terima_request_iStatus_cc($field, $id) {
                $return = '<input type="text" name="'.$field.'"  id="'.$id.'"  class="input_rows1 required" size="30" />';
                $return .= '<script>
                                $("#'.$id.'").keyup(function() {
                                     this.value = this.value.replace(/[^0-9\.]/g,"");
            ...
            function updateBox_terima_request_iStatus_cc($field, $id, $value, $rowData) {
                if ($this->input->get('action') == 'view') {
                     $return= $value; 
                }else{
                $return = '<input type="text" name="'.$field.'"  id="'.$id.'"  class="input_rows1 required" size="30" value="'.$value.'"/>';
            ...
            function insertBox_terima_request_dApproved_cc($field, $id) {
                $return = '<input type="text" name="'.$field.'"  id="'.$id.'"  class="input_rows1 required" size="30" />';
                $return .= '<script>
                                $("#'.$id.'").datepicker({  changeMonth:true,
                                        changeYear:true,
            ...
            function updateBox_terima_request_dApproved_cc($field, $id, $value, $rowData) {
                if ($this->input->get('action') == 'view') {
                     $return= $value; 
                }else{
                $return = '<input type="text" name="'.$field.'"  id="'.$id.'"  class="input_rows1 required" size="30" value="'.$value.'"/>';
            ...
            function insertBox_terima_request_cApproved_cc($field, $id) {
                $return = '<input type="text" name="'.$field.'"  id="'.$id.'"  class="input_rows1 required" size="30" maxlength = "50" />';
                $return .= '<script>
                                $("#'.$id.'").keyup(function() {
                                    var len = this.value.length;
            ...
            function updateBox_terima_request_cApproved_cc($field, $id, $value, $rowData) {
                if ($this->input->get('action') == 'view') {
                     $return= $value; 
                }else{
                $return = '<input type="text" name="'.$field.'"  id="'.$id.'"  class="input_rows1 required" size="30" maxlength = "50"  value="'.$value.'"/>';
            ...
            function insertBox_terima_request_dUji_BE($field, $id) {
                $return = '<input type="text" name="'.$field.'"  id="'.$id.'"  class="input_rows1 required" size="30" />';
                $return .= '<script>
                                $("#'.$id.'").datepicker({  changeMonth:true,
                                        changeYear:true,
            ...
            function updateBox_terima_request_dUji_BE($field, $id, $value, $rowData) {
                if ($this->input->get('action') == 'view') {
                     $return= $value; 
                }else{
                $return = '<input type="text" name="'.$field.'"  id="'.$id.'"  class="input_rows1 required" size="30" value="'.$value.'"/>';
            ...
            function insertBox_terima_request_dSelesai_uji_BE($field, $id) {
                $return = '<input type="text" name="'.$field.'"  id="'.$id.'"  class="input_rows1 required" size="30" />';
                $return .= '<script>
                                $("#'.$id.'").datepicker({  changeMonth:true,
                                        changeYear:true,
            ...
            function updateBox_terima_request_dSelesai_uji_BE($field, $id, $value, $rowData) {
                if ($this->input->get('action') == 'view') {
                     $return= $value; 
                }else{
                $return = '<input type="text" name="'.$field.'"  id="'.$id.'"  class="input_rows1 required" size="30" value="'.$value.'"/>';
            ...
            function insertBox_terima_request_vNo_hasil_uji_BE($field, $id) {
                $return = '<input type="text" name="'.$field.'"  id="'.$id.'"  class="input_rows1 required" size="30" maxlength = "50" />';
                $return .= '<script>
                                $("#'.$id.'").keyup(function() {
                                    var len = this.value.length;
            ...
            function updateBox_terima_request_vNo_hasil_uji_BE($field, $id, $value, $rowData) {
                if ($this->input->get('action') == 'view') {
                     $return= $value; 
                }else{
                $return = '<input type="text" name="'.$field.'"  id="'.$id.'"  class="input_rows1 required" size="30" maxlength = "50"  value="'.$value.'"/>';
            ...
            function insertBox_terima_request_vHasil_uji_BE($field, $id) {
                $return = '<input type="text" name="'.$field.'"  id="'.$id.'"  class="input_rows1 required" size="30" />';
                $return .= '<script>
                                $("#'.$id.'").keyup(function() {
                                     this.value = this.value.replace(/[^0-9\.]/g,"");
            ...
            function updateBox_terima_request_vHasil_uji_BE($field, $id, $value, $rowData) {
                if ($this->input->get('action') == 'view') {
                     $return= $value; 
                }else{
                $return = '<input type="text" name="'.$field.'"  id="'.$id.'"  class="input_rows1 required" size="30" value="'.$value.'"/>';
            ...
            function insertBox_terima_request_iStatus_uji_BE($field, $id) {
                $return = '<input type="text" name="'.$field.'"  id="'.$id.'"  class="input_rows1 required" size="30" />';
                $return .= '<script>
                                $("#'.$id.'").keyup(function() {
                                     this.value = this.value.replace(/[^0-9\.]/g,"");
            ...
            function updateBox_terima_request_iStatus_uji_BE($field, $id, $value, $rowData) {
                if ($this->input->get('action') == 'view') {
                     $return= $value; 
                }else{
                $return = '<input type="text" name="'.$field.'"  id="'.$id.'"  class="input_rows1 required" size="30" value="'.$value.'"/>';
            ...
            function insertBox_terima_request_dApproved_uji_BE($field, $id) {
                $return = '<input type="text" name="'.$field.'"  id="'.$id.'"  class="input_rows1 required" size="30" />';
                $return .= '<script>
                                $("#'.$id.'").datepicker({  changeMonth:true,
                                        changeYear:true,
            ...
            function updateBox_terima_request_dApproved_uji_BE($field, $id, $value, $rowData) {
                if ($this->input->get('action') == 'view') {
                     $return= $value; 
                }else{
                $return = '<input type="text" name="'.$field.'"  id="'.$id.'"  class="input_rows1 required" size="30" value="'.$value.'"/>';
            ...
            function insertBox_terima_request_cApproved_uji_BE($field, $id) {
                $return = '<input type="text" name="'.$field.'"  id="'.$id.'"  class="input_rows1 required" size="30" maxlength = "50" />';
                $return .= '<script>
                                $("#'.$id.'").keyup(function() {
                                    var len = this.value.length;
            ...
            function updateBox_terima_request_cApproved_uji_BE($field, $id, $value, $rowData) {
                if ($this->input->get('action') == 'view') {
                     $return= $value; 
                }else{
                $return = '<input type="text" name="'.$field.'"  id="'.$id.'"  class="input_rows1 required" size="30" maxlength = "50"  value="'.$value.'"/>';
            ...
            function insertBox_terima_request_dCreate($field, $id) {
                $return = '<input type="text" name="'.$field.'"  id="'.$id.'"  class="input_rows1 required" size="30" />';
                $return .= '<script>
                                $("#'.$id.'").datepicker({  changeMonth:true,
                                        changeYear:true,
            ...
            function updateBox_terima_request_dCreate($field, $id, $value, $rowData) {
                if ($this->input->get('action') == 'view') {
                     $return= $value; 
                }else{
                $return = '<input type="text" name="'.$field.'"  id="'.$id.'"  class="input_rows1 required" size="30" value="'.$value.'"/>';
            ...
            function insertBox_terima_request_cCreated($field, $id) {
                $return = '<input type="text" name="'.$field.'"  id="'.$id.'"  class="input_rows1 required" size="30" maxlength = "50" />';
                $return .= '<script>
                                $("#'.$id.'").keyup(function() {
                                    var len = this.value.length;
            ...
            function updateBox_terima_request_cCreated($field, $id, $value, $rowData) {
                if ($this->input->get('action') == 'view') {
                     $return= $value; 
                }else{
                $return = '<input type="text" name="'.$field.'"  id="'.$id.'"  class="input_rows1 required" size="30" maxlength = "50"  value="'.$value.'"/>';
            ...
            function insertBox_terima_request_dupdate($field, $id) {
                $return = '<input type="text" name="'.$field.'"  id="'.$id.'"  class="input_rows1 required" size="30" />';
                $return .= '<script>
                                $("#'.$id.'").datepicker({  changeMonth:true,
                                        changeYear:true,
            ...
            function updateBox_terima_request_dupdate($field, $id, $value, $rowData) {
                if ($this->input->get('action') == 'view') {
                     $return= $value; 
                }else{
                $return = '<input type="text" name="'.$field.'"  id="'.$id.'"  class="input_rows1 required" size="30" value="'.$value.'"/>';
            ...
            function insertBox_terima_request_cUpdate($field, $id) {
                $return = '<input type="text" name="'.$field.'"  id="'.$id.'"  class="input_rows1 required" size="30" maxlength = "50" />';
                $return .= '<script>
                                $("#'.$id.'").keyup(function() {
                                    var len = this.value.length;
            ...
            function updateBox_terima_request_cUpdate($field, $id, $value, $rowData) {
                if ($this->input->get('action') == 'view') {
                     $return= $value; 
                }else{
                $return = '<input type="text" name="'.$field.'"  id="'.$id.'"  class="input_rows1 required" size="30" maxlength = "50"  value="'.$value.'"/>';
            ...
            function insertBox_terima_request_lDeleted($field, $id) {
                $return = '<input type="text" name="'.$field.'"  id="'.$id.'"  class="input_rows1 required" size="30" />';
                $return .= '<script>
                                $("#'.$id.'").keyup(function() {
                                     this.value = this.value.replace(/[^0-9\.]/g,"");
            ...
            function updateBox_terima_request_lDeleted($field, $id, $value, $rowData) {
                if ($this->input->get('action') == 'view') {
                     $return= $value; 
                }else{
                $return = '<input type="text" name="'.$field.'"  id="'.$id.'"  class="input_rows1 required" size="30" value="'.$value.'"/>';
            ...
            function insertBox_terima_request_vFile($field, $id) {
                $data['date'] = date('Y-m-d H:i:s');    
                return $this->load->view('terima_request_file',$data,TRUE);
            }

            function updateBox_terima_request_vFile($field, $id, $value, $rowData) {
            ...
            function updateBox_terima_request_cformulator($field, $id, $value, $rowData) {
                $url=base_url().'processor/reformulasi/terima/request?action=getPicRefor';
                $rr = $this->db->get_where('plc2.req_refor', array('cformulator'=>$rowData['cformulator']));
                $cpic_pengirim='';
                $namepic='';
                if ($rr->num_rows()>=1) {
                    $rows=$rr->row_array();
                    if($rows['cformulator']!=''){
                        $sql="select * from hrd.employee em where em.cNip='".$rows['cformulator']."'";
                ...
                $re="
                    ...
                    <input name='".$field."_dis'  id='".$id."_dis' type='text' size='20' value='".$namepic."' class='required' />";
                $re.='<script>
                    var config3 = {
                        source: function( request, response) {
                            $.ajax({
                                ...
                                data: {
                                    term: request.term,
                                    teamPD:  $( "#terima_request_iteam_pd" ).val(),
                ...
                function getPicRefor() {
                        ...
                        $sql = "select * 
                                ...
                                and a.cNip in (select b.vnip 
                                                ...
                                                join plc2.plc2_upb_team_item b on b.iteam_id=a.iteam_id
                                                where a.ldeleted=0
                                                and b.ldeleted=0
                                                and a.iteam_id= '".$teamPD."' )
                                ";
                ...
                function approve_view() {
                                 ...
                                 function submit_ajax(form_id) {
                                    return $.ajax({
                                        ...
                                        success: function(data) {
                                            ...
                                            var url = "'.base_url().'processor/reformulasi/terima_request";                             
                                            if(o.status == true) { 
                                                $("#alert_dialog_form").dialog("close");
                                                     $.get(url+"?action=update&id="+last_id, function(data) {
                                                     $("div#form_terima_request").html(data);
                                                     
                                                });
                                                
                                            }
                                                reload_grid("grid_terima_request");
                                        }
                    ...
                    $echo .= '<form id="form_terima_request_approve" action="'.base_url().'processor/reformulasi/terima_request?action=approve_process" method="post">';
                    ...
                    <button type="button" onclick="submit_ajax(\'form_terima_request_approve\')">Approve</button>';
                ...
                function reject_view() {
                    $echo = '<script type="text/javascript">
                                 function submit_ajax(form_id) {
                                    var remark = $("#terima_request_remark").val();
                                    if (remark=="") {
                    ...
                    $echo .= '<form id="form_terima_request_reject" action="'.base_url().'processor/reformulasi/terima_request?action=reject_process" method="post">';
                    $echo .= '<div style="vertical-align: top;">';
                    $echo .= 'Remark : 
                            <input type="hidden" name="Req_refor_ID" value="'.$this->input->get('Req_refor_ID').'" />
                            <input type="hidden" name="lvl" value="'.$this->input->get('lvl').'" />
                            <input type="hidden" name="group_id" value="'.$this->input->get('group_id').'" />
                            <input type="hidden" name="modul_id" value="'.$this->input->get('modul_id').'" />
                            <textarea name="vRemark" id="reject_terima_request_remark"></textarea>
                    <button type="button" onclick="submit_ajax(\'form_terima_request_reject\')">Reject</button>';
            ...
            function before_update_processor($row, $postData) {
                ...
                if($postData['isdraft']==true){
                    ...
                    $postData['cApproved_terima']=$this->user->gNIP;
                    $postData['dApproved_terima']=date('Y-m-d H:i:s');
                ...
                // kirim    email ketika submit
                        ...
                        if ($iSubmit > 0) {
                            ...
                            $subject="Request Reformulasi: No Request ".$rsql['vNo_req_refor'];
                                ...
                                $content="
                                Diberitahukan bahwa telah ada permintaan Reformulasi, dan membutuhkan Approval Bpk/Ibu sebagai atasan langsung. 
                                    dengan rincian sebagai berikut :<br><br>  
                                    <table border='0' style='width: 600px;'>
                                        <tr>
                                                <td style='width: 110px;'><b>Requestor </b></td><td style='width: 20px;'> : </td>
            ...
            function after_update_processor($fields, $id, $postData) {
                ...
                /*Purchasing Gunung Putri*/
                $teamPR = '24' ;

                $iSubmit_terima = $rsql['iSubmit_terima'];
                ...
                if ($iSubmit_terima > 0) {
                    ...
                    $cformulator = $rsql['cformulator'];
                    $myFormulator = $this->whoAmI($cformulator);
                    $toEmail2='';
                   ...
                   $to = $myFormulator['vEmail'];
                   $cc = $toEmail.';'.$iAm['vEmail'];
                   $subject="Terima Request Reformulasi: No Request ".$rsql['vNo_req_refor'];
                        ...
                        if($sendFormulator){
                                ...
                                $myFormulator = $this->whoAmI($cformulator);
                                $toEmail2='';
                                $toEmail = $this->lib_utilitas->get_email_team( $teamPR );
                                $toEmail2 = $this->lib_utilitas->get_email_leader( $teamPR );                        
                               ...
                               $to = $myFormulator['vEmail'];
                               $cc = $toEmail.';'.$iAm['vEmail'];
                               $subject="Remainder Create PO Reformulasi: No Request ".$rsql['vNo_req_refor'];

                                    $content="
                                    Diberitahukan bahwa telah ada penerimaan Reformulasi, dengan rincian sebagai berikut :<br><br>  
                                        <table border='0' style='width: 600px;'>
                                            <tr>
                                                    <td style='width: 110px;'><b>Requestor </b></td><td style='width: 20px;'> : </td>
                                                    <td>".$rsql['cNip'].' || '.$rsql['vName']."</td>
                                    ...
                                    Mohon segera membuat PO untuk bahan-bahan yang sudah direquest.
            ...
            function manipulate_insert_button($buttons) {
                ...
                $save_draft = '<button onclick="javascript:save_draft_btn_multiupload(\'terima_request\', \''.base_url().'processor/reformulasi/terima/request?draft=true\', this, true)" class="ui-button-text icon-save" id="button_save_draft_terima_request">Save as Draft</button>';
                $save = '<button onclick="javascript:save_btn_multiupload(\'terima_request\', \''.base_url().'processor/reformulasi/terima/request?company_id='.$this->input->get('company_id').'&group_id='.$this->input->get('group_id').'&modul_id='.$this->input->get('modul_id').'\', this)" class="ui-button-text icon-save" id="button_save_terima_request">Save &amp; Submit</button>';
                $js = $this->load->view('js/terima_request_js');
            ...
            function manipulate_update_button($buttons, $rowData) { 
                ...
                $iSubmit = $rowData['iSubmit_terima'];


                $update = '<button onclick="javascript:update_btn_back(\'terima_request\', \''.base_url().'processor/reformulasi/terima/request?company_id='.$this->input->get('company_id').'&group_id='.$this->input->get('group_id').'&modul_id='.$this->input->get('modul_id').'\', this)" class="ui-button-text icon-save" id="button_save_terima_request">Update & Submit</button>';
                $updatedraft = '<button onclick="javascript:update_draft_btn(\'terima_request\', \''.base_url().'processor/reformulasi/terima/request?company_id='.$this->input->get('company_id').'&draft=true&group_id='.$this->input->get('group_id').'&modul_id='.$this->input->get('modul_id').'\', this, true)" class="ui-button-text icon-save" id="button_save_terima_request">Update as Draft</button>';
               ...
               // $reqBB = '<button id="2476" rel="plc/sample/permintaan/sample" style="cursor:pointer;" group="47" class="ui-button-text icon-save" >Permintaan Sample</button>';
                ...
                $approve = '<button onclick="javascript:load_popup(\''.base_url().'processor/reformulasi/terima/request?action=approve&Req_refor_ID='.$rowData['Req_refor_ID'].'&cNip='.$logged_nip.'&lvl=1&status=1&group_id='.$this->input->get('group_id').'&modul_id='.$this->input->get('modul_id').'\')" class="ui-button-text icon-save" id="button_approve_terima_request">Approve</button>';
                $reject = '<button onclick="javascript:load_popup(\''.base_url().'processor/reformulasi/terima/request?action=reject&Req_refor_ID='.$rowData['Req_refor_ID'].'&cNip='.$logged_nip.'&lvl=1&status=1&group_id='.$this->input->get('group_id').'&modul_id='.$this->input->get('modul_id').'\')" class="ui-button-text icon-save" id="button_reject_terima_request">Reject</button>';
                $js = $this->load->view('js/terima_request_js');
                $js .= $this->load->view('js/upload_js');
