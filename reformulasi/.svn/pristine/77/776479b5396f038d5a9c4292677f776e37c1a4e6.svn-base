<?php $table_id="table_file_study_details";
$caption = "File Study Literatur";
 ?>
...
//$jr=$dquery->num_rows();
$i=0;
$o='["<input type=\'hidden\' class=\'num_rows_table_undangan_perusahaan_details\' value=\'1\' /><input type=\'file\' id=\'fileupload_local_study_pd_1\' class=\'fileupload multi multifile\' name=\'fileupload_local_study_pd[]\' style=\'width: 90%\' />","<textarea id=\'file_keterangan_local_study_1\' name=\'file_keterangan_local_study[]\' style=\'width: 240px; height: 50px;\'></textarea>","<button id=\'ihapus_'.$table_id.'\' class=\'ui-button-text icon_hapus\' style=\'width:75px\' onclick=\'javascript:hapus_row_details_file_study(1)\' type=\'button\'>Hapus</button>"]';
?>
...
<script>
	...
	function addrow_disolusi_terbanding_detail_files(){
		...
		var sa=[["<input type='hidden' class='num_rows_table_undangan_perusahaan_details' value='"+rlast+"' /><input type='file' id='fileupload_local_study_pd_"+rlast+"' class='fileupload multi multifile' name='fileupload_local_study_pd[]' style='width: 90%' />","<textarea id='file_keterangan_local_study_"+rlast+"' name='file_keterangan_local_study[]' style='width: 240px; height: 50px;'></textarea>","<button id='ihapus_<?php echo $table_id ?>' class='ui-button-text icon_hapus' style='width:75px' onclick='javascript:hapus_row_details_file_study("+rlast+")' type='button'>Hapus</button>"]];
