        ...
        /* Location: ./modules/home/controllers/export_terima_bb_qa.php */
        /* Please DO NOT modify this information : */ 
         
        if ( ! defined('BASEPATH')) exit('No direct script access allowed');
        class export_terima_bb_qa extends MX_Controller {
            ...
            function index($action = '') {
                ...
                $grid = new Grid;
                $grid->setTitle('Terima BB oleh QA');
                $grid->setTable('reformulasi.export_ro');      
                $grid->setUrl('export_terima_bb_qa');
                ...
                */
                ...
                /*hanya RO yang detailnya perlu uji mikro*/
                $grid->setQuery('iexport_ro in (select b.iexport_ro 
            ...
            */
            ...
            function insertBox_export_terima_bb_qa_detail($field, $id) {
            ...
            function updateBox_export_terima_bb_qa_iClose_po($field, $id, $value, $rowData) {
            ...
            function updateBox_export_terima_bb_qa_detail($field, $id, $value, $rowData) {
                $data['rowData'] = $rowData;
                $data['controller'] = $this;

                return $this->load->view('export/sample/detail_terima_bb_qa', $data, TRUE);

                
            }


            function insertBox_export_terima_bb_qa_vRo_no($field, $id) {
            ...
            function updateBox_export_terima_bb_qa_vRo_no($field, $id, $value, $rowData) {
                $o = "<input type='hidden' name='".$field."' id='".$id."' readonly='readonly' value='".$value."'/>";
            ...
            function insertBox_export_terima_bb_qa_ipo_id($field, $id) {
                $return = '<script>
                ...
                $return .= '&nbsp;<button class="icon_pop"  onclick="browse(\''.base_url().'processor/reformulasi/browse/po/export?field=export_terima_bb_qa&col=ipo_id\',\'List PO\')" type="button">&nbsp;</button>';
                
                return $return;
            }
            
            function updateBox_export_terima_bb_qa_ipo_id($field, $id, $value) {
            ...
            function updateBox_export_terima_bb_qa_ipo_id($field, $id, $value, $rowData) {
            ...
            function insertBox_export_terima_bb_qa_cTerima_pr($field, $id) {
                $nip = $this->user->gNIP;
            ...
            function updateBox_export_terima_bb_qa_cTerima_pr($field, $id, $value, $rowData) {
                if ($this->input->get('action') == 'view') {
            ...
            function insertBox_export_terima_bb_qa_dTgl_terima($field, $id) {
            ...
            function updateBox_export_terima_bb_qa_dTgl_terima($field, $id, $value, $rowData) {
                if ($this->input->get('action') == 'view') {
                     $return= $value; 
                }else{
            ...
            function insertBox_export_terima_bb_qa_isupplier_id($field, $id) {
                $return = '<script>
                                $( "button.icon_pop" ).button({
                                    icons: {
                                        primary: "ui-icon-newwin"
                ...
                $return .= '&nbsp;<button class="icon_pop"  onclick="browse(\''.base_url().'processor/reformulasi/supplier/list/popup?field=export_terima_bb_qa&col=isupplier_id\',\'List Supplier\')" type="button">&nbsp;</button>';
                
                return $return;
            }
            
            function updateBox_export_terima_bb_qa_isupplier_id($field, $id, $value) {
            ...
            function insertBox_export_terima_bb_qa_iSubmit($field, $id) {
                $return = '<input type="text" name="'.$field.'"  id="'.$id.'"  class="input_rows1 required" size="30" />';
                $return .= '<script>
                                $("#'.$id.'").keyup(function() {
                                     this.value = this.value.replace(/[^0-9\.]/g,"");
            ...
            function updateBox_export_terima_bb_qa_iSubmit($field, $id, $value, $rowData) {
                if ($this->input->get('action') == 'view') {
                     $return= $value; 
                }else{
                $return = '<input type="text" name="'.$field.'"  id="'.$id.'"  class="input_rows1 required" size="30" value="'.$value.'"/>';
            ...
            function insertBox_export_terima_bb_qa_iApprove_pr($field, $id) {
                $return = '<input type="text" name="'.$field.'"  id="'.$id.'"  class="input_rows1 required" size="30" />';
                $return .= '<script>
                                $("#'.$id.'").keyup(function() {
                                     this.value = this.value.replace(/[^0-9\.]/g,"");
            ...
            function updateBox_export_terima_bb_qa_iApprove_pr($field, $id, $value, $rowData) {
                if ($this->input->get('action') == 'view') {
                     $return= $value; 
                }else{
                $return = '<input type="text" name="'.$field.'"  id="'.$id.'"  class="input_rows1 required" size="30" value="'.$value.'"/>';
            ...
            function insertBox_export_terima_bb_qa_cApprove_pr($field, $id) {
            ...
            function updateBox_export_terima_bb_qa_cApprove_pr($field, $id, $value, $rowData) {
                if ($this->input->get('action') == 'view') {
                     $return= $value; 
                }else{
            ...
            function insertBox_export_terima_bb_qa_dApprove_pr($field, $id) {
                $return = '<input type="text" name="'.$field.'"  id="'.$id.'"  class="input_rows1 required" size="30" />';
                $return .= '<script>
                                $("#'.$id.'").datepicker({  changeMonth:true,
                                        changeYear:true,
            ...
            function updateBox_export_terima_bb_qa_dApprove_pr($field, $id, $value, $rowData) {
                if ($this->input->get('action') == 'view') {
                     $return= $value; 
                }else{
                $return = '<input type="text" name="'.$field.'"  id="'.$id.'"  class="input_rows1 required" size="30" value="'.$value.'"/>';
            ...
            function insertBox_export_terima_bb_qa_vRemark($field, $id) {
            ...
            function updateBox_export_terima_bb_qa_vRemark($field, $id, $value, $rowData) {
                if ($this->input->get('action') == 'view') {
                     $return= $value; 
                }else{
            ...
            function insertBox_export_terima_bb_qa_dCreate($field, $id) {
                $return = '<input type="text" name="'.$field.'"  id="'.$id.'"  class="input_rows1 required" size="30" />';
                $return .= '<script>
                                $("#'.$id.'").datepicker({  changeMonth:true,
                                        changeYear:true,
            ...
            function updateBox_export_terima_bb_qa_dCreate($field, $id, $value, $rowData) {
                if ($this->input->get('action') == 'view') {
                     $return= $value; 
                }else{
                $return = '<input type="text" name="'.$field.'"  id="'.$id.'"  class="input_rows1 required" size="30" value="'.$value.'"/>';
            ...
            function insertBox_export_terima_bb_qa_cCreated($field, $id) {
                $return = '<input type="text" name="'.$field.'"  id="'.$id.'"  class="input_rows1 required" size="30" maxlength = "50" />';
                $return .= '<script>
                                $("#'.$id.'").keyup(function() {
                                    var len = this.value.length;
            ...
            function updateBox_export_terima_bb_qa_cCreated($field, $id, $value, $rowData) {
                if ($this->input->get('action') == 'view') {
                     $return= $value; 
                }else{
                $return = '<input type="text" name="'.$field.'"  id="'.$id.'"  class="input_rows1 required" size="30" maxlength = "50"  value="'.$value.'"/>';
            ...
            function insertBox_export_terima_bb_qa_dupdate($field, $id) {
                $return = '<input type="text" name="'.$field.'"  id="'.$id.'"  class="input_rows1 required" size="30" />';
                $return .= '<script>
                                $("#'.$id.'").datepicker({  changeMonth:true,
                                        changeYear:true,
            ...
            function updateBox_export_terima_bb_qa_dupdate($field, $id, $value, $rowData) {
                if ($this->input->get('action') == 'view') {
                     $return= $value; 
                }else{
                $return = '<input type="text" name="'.$field.'"  id="'.$id.'"  class="input_rows1 required" size="30" value="'.$value.'"/>';
            ...
            function insertBox_export_terima_bb_qa_cUpdate($field, $id) {
                $return = '<input type="text" name="'.$field.'"  id="'.$id.'"  class="input_rows1 required" size="30" maxlength = "50" />';
                $return .= '<script>
                                $("#'.$id.'").keyup(function() {
                                    var len = this.value.length;
            ...
            function updateBox_export_terima_bb_qa_cUpdate($field, $id, $value, $rowData) {
                if ($this->input->get('action') == 'view') {
                     $return= $value; 
                }else{
                $return = '<input type="text" name="'.$field.'"  id="'.$id.'"  class="input_rows1 required" size="30" maxlength = "50"  value="'.$value.'"/>';
            ...
            function insertBox_export_terima_bb_qa_lDeleted($field, $id) {
                $return = '<input type="text" name="'.$field.'"  id="'.$id.'"  class="input_rows1 required" size="30" />';
                $return .= '<script>
                                $("#'.$id.'").keyup(function() {
                                     this.value = this.value.replace(/[^0-9\.]/g,"");
            ...
            function updateBox_export_terima_bb_qa_lDeleted($field, $id, $value, $rowData) {
                if ($this->input->get('action') == 'view') {
                     $return= $value; 
                }else{
                $return = '<input type="text" name="'.$field.'"  id="'.$id.'"  class="input_rows1 required" size="30" value="'.$value.'"/>';
            ...
            /*
                ...
                function approve_view() {
                                 ...
                                 function submit_ajax(form_id) {
                                    return $.ajax({
                                        ...
                                        success: function(data) {
                                            ...
                                            var url = "'.base_url().'processor/home/export_terima_bb_qa";                             
                                            if(o.status == true) { 
                                                $("#alert_dialog_form").dialog("close");
                                                     $.get(url+"?action=update&id="+last_id, function(data) {
                                                     $("div#form_export_terima_bb_qa").html(data);
                                                     
                                                });
                                                
                                            }
                                                reload_grid("grid_export_terima_bb_qa");
                                        }
                    ...
                    $echo .= '<form id="form_export_terima_bb_qa_approve" action="'.base_url().'processor/home/export_terima_bb_qa?action=approve_process" method="post">';
                    ...
                    <button type="button" onclick="submit_ajax(\'form_export_terima_bb_qa_approve\')">Approve</button>';
            ...
            */
            ...
            /*
                ...
                function reject_view() {
                    $echo = '<script type="text/javascript">
                                 function submit_ajax(form_id) {
                                    var remark = $("#export_terima_bb_qa_remark").val();
                                    if (remark=="") {
                    ...
                    $echo .= '<form id="form_export_terima_bb_qa_reject" action="'.base_url().'processor/home/export_terima_bb_qa?action=reject_process" method="post">';
                    $echo .= '<div style="vertical-align: top;">';
                    $echo .= 'Remark : 
                            <input type="hidden" name="iexport_ro" value="'.$this->input->get('iexport_ro').'" />
                            <input type="hidden" name="lvl" value="'.$this->input->get('lvl').'" />
                            <input type="hidden" name="group_id" value="'.$this->input->get('group_id').'" />
                            <input type="hidden" name="modul_id" value="'.$this->input->get('modul_id').'" />
                            <textarea name="vRemark" id="reject_export_terima_bb_qa_remark"></textarea>
                    <button type="button" onclick="submit_ajax(\'form_export_terima_bb_qa_reject\')">Reject</button>';
            ...
            */
            ...
            function after_update_processor($fields, $id, $postData) {
                ...
                */
                ...
                if ($updet==1) {
                    ...
                    $subject = 'Reformulasi - Update Terima BB oleh QA '.$rsql['vRo_no'];
                    $content="
                        Diberitahukan bahwa telah ada Update data Terima Sample oleh QA dengan rincian sebagai berikut :<br><br>  
            ...
            function manipulate_update_button($buttons, $rowData) { 
                ...
                //$update = '<button onclick="javascript:update_btn_back(\'export_terima_bb_qa\', \''.base_url().'processor/reformulasi/export/terima/bb/pd/ad?company_id='.$this->input->get('company_id').'&group_id='.$this->input->get('group_id').'&modul_id='.$this->input->get('modul_id').'\', this)" class="ui-button-text icon-save" id="button_save_terima_bb_pd_ad">Update & Submit</button>';
                //$updatedraft = '<button onclick="javascript:update_draft_btn(\'export_terima_bb_qa\', \''.base_url().'processor/reformulasi/export/terima/bb/pd/ad?company_id='.$this->input->get('company_id').'&draft=true&group_id='.$this->input->get('group_id').'&modul_id='.$this->input->get('modul_id').'\', this, true)" class="ui-button-text icon-save" id="button_save_terima_bb_pd_ad">Update as Draft</button>';
                $update = '<button onclick="javascript:update_btn_back(\'export_terima_bb_qa\', \''.base_url().'processor/reformulasi/export/terima/bb/pd/ad?company_id='.$this->input->get('company_id').'&group_id='.$this->input->get('group_id').'&modul_id='.$this->input->get('modul_id').'\', this)" class="ui-button-text icon-save" id="button_save_terima_bb_pd_ad">Update & Submit</button>';

                $js = $this->load->view('export/js/terima_qa_js');
