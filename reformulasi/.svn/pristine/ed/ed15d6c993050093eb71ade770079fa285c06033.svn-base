...
class v3_export_uji_kimiawi extends MX_Controller {
    function __construct() {
        ...
        $this->url = 'v3_export_uji_kimiawi';
    ...
    function index($action = '') {
        ...
        $grid->setJoinTable('reformulasi.master_bentuk_sediaan_refor', 'export_refor_formulasi_detail.id_bentuk_sediaan_trial = master_bentuk_sediaan_refor.id_bentuk_sediaan', 'left');
        $grid->setJoinTable('reformulasi.master_pengujian_refor', 'export_refor_formulasi_detail.id_pengujian_trial = master_pengujian_refor.id_pengujian', 'left');

        $grid->addList('vno_formula','id_bentuk_sediaan_trial','id_pengujian_trial','dmulai_analisa_trial','dmulai_analisa_trial','dselesai_analisa_trial','cpic_analisa_trial','ikesimpulan_analisa_trial','isubmit_kimiawi_trial','dsubmit_kimiawi_trial'); 
        $grid->setSortBy('iexport_formulasi_detail');
        $grid->setSortOrder('DESC');  

        $grid->addFields('vno_formula','id_bentuk_sediaan_trial','id_pengujian_trial','dmulai_analisa_trial','dselesai_analisa_trial','cpic_analisa_trial','formulasi_uji_kimiawi','ikesimpulan_analisa_trial','dkesimpulan_analisa_trial'); 

        $grid->setWidth('vno_formula', '100');
        $grid->setAlign('vno_formula', 'left');
        $grid->setLabel('vno_formula','No. Formulasi');
    
        $grid->setWidth('dmulai_analisa_trial', '100');
        $grid->setAlign('dmulai_analisa_trial', 'left');
        $grid->setLabel('dmulai_analisa_trial','Tgl Mulai Analisa ');

        $grid->setWidth('dselesai_analisa_trial', '100');
        $grid->setAlign('dselesai_analisa_trial', 'left');
        $grid->setLabel('dselesai_analisa_trial','Tgl Selesai Analisa ');

        $grid->setWidth('cpic_analisa_trial', '100');
        $grid->setAlign('cpic_analisa_trial', 'left');
        $grid->setLabel('cpic_analisa_trial','PIC Analisa ');
        ...
        $grid->setWidth('isubmit_kimiawi_trial', '100');
        $grid->setAlign('isubmit_kimiawi_trial', 'left');
        $grid->setLabel('isubmit_kimiawi_trial','Status');

        $grid->setWidth('dsubmit_kimiawi_trial', '100');
        $grid->setAlign('dsubmit_kimiawi_trial', 'left');
        $grid->setLabel('dsubmit_kimiawi_trial','Tgl Submit');
        ...
        $grid->setLabel('id_bentuk_sediaan_trial', 'Bentuk Sediaan');
        ...
        $grid->setLabel('id_pengujian_trial', 'Parameter Pengujian');

        $grid->setWidth('ikesimpulan_analisa_trial', '100');
        $grid->setAlign('ikesimpulan_analisa_trial', 'left');
        $grid->setLabel('ikesimpulan_analisa_trial', 'Kesimpulan Analisa');

        $grid->setWidth('dkesimpulan_analisa_trial', '100');
        $grid->setAlign('dkesimpulan_analisa_trial', 'left');
        $grid->setLabel('dkesimpulan_analisa_trial', 'Tanggal Kesimpulan Analisa');
    
        $grid->setQuery('export_refor_formulasi_detail.lDeleted = 0 ', null); 
        $grid->setQuery('export_refor_formulasi_detail.isubmit_fisik_trial = 1 ', null); 
        ...
        $grid->changeFieldType('isubmit_kimiawi_trial','combobox','',array('' => '--Pilih--', 0 => 'Need To Be Submit', 1 => 'Submitted'));
        $grid->changeFieldType('ikesimpulan_analisa_trial','combobox','',array('' => '--Pilih--', 0 => 'TMS', 1 => 'MS'));

        $grid->setSearch('vno_formula','isubmit_kimiawi_trial','ikesimpulan_analisa_trial');
        
        $grid->setRequired('vno_formula','id_bentuk_sediaan_trial','id_pengujian_trial','dmulai_analisa_trial','dselesai_analisa_trial','cpic_analisa_trial','ikesimpulan_analisa_trial','dkesimpulan_analisa_trial'); 
    ...
    public function manipulate_grid_button($button) {  
        ...
        $submit     = (!empty($cekSubmit))?$cekSubmit['isubmit_kimiawi_trial']:0;
    ...
    function listBox_v3_export_uji_kimiawi_id_bentuk_sediaan_trial($value, $pk, $name, $rowData) {
    ...
    function listBox_v3_export_uji_kimiawi_id_pengujian_trial($value, $pk, $name, $rowData) {
    ...
    function listBox_Action($row, $actions) { 
        ...
        $sqlCek     = 'SELECT t.isubmit_kimiawi_trial FROM reformulasi.export_refor_formulasi_detail f
        ...
        if ($submit == 1){
            ...
            if ($row['isubmit_kimiawi_trial'] == 0){
                $actions['edit'] = $edit;
            }
        }
    ...
    function updateBox_v3_export_uji_kimiawi_vno_formula($field, $id, $value, $rowData) {
    ...
    function updateBox_v3_export_uji_kimiawi_id_bentuk_sediaan_trial($field, $id, $value, $rowData) {
        ...
        $return .= '<script>
                        ...
                        function load_pengujian (id_bentuk) { 
                            $.ajax({
                                ...
                                type: "post",
                                data : {
                                    value   : '.$rowData['id_pengujian_trial'].',
                                    bentuk  : id_bentuk,
                                    idclass : "'.$this->url.'_id_pengujian_trial",
                                    name    : "id_pengujian_trial",
                                },
                                success: function(data) {
                                    $(".'.$this->url.'_id_pengujian_trial_form_class").html(data);
                                }
                            });
                        }
                    </script>';
    ...
    function updateBox_v3_export_uji_kimiawi_id_pengujian_trial($field, $id, $value, $rowData) {
        $return = '<div class="'.$id.'_form_class">Pilih Bentuk Sediaan</div>';  
        return $return;
    }

    function updateBox_v3_export_uji_kimiawi_dmulai_analisa_trial($field, $id, $value, $rowData) {
        if ($this->input->get('action') == 'view') {
             $return= $value; 
        }else{ 
    ...
    function updateBox_v3_export_uji_kimiawi_dselesai_analisa_trial($field, $id, $value, $rowData) {
        if ($this->input->get('action') == 'view') {
             $return= $value; 
        }else{ 
            $return = '<input type="date" name="'.$field.'"  id="'.$id.'"  class="input_rows1 tanggal  required" size="15" value="'.$value.'"/>';
    ...
    function updateBox_v3_export_uji_kimiawi_formulasi_uji_kimiawi($field, $id, $value, $rowData) {
    ...
    function updateBox_v3_export_uji_kimiawi_cpic_analisa_trial($field, $id, $value, $rowData) {
    ...
    function updateBox_v3_export_uji_kimiawi_dkesimpulan_analisa_trial($field, $id, $value, $rowData) {
        if ($this->input->get('action') == 'view') {
             $return= $value; 
        }else{ 
            $return = '<input type="date" name="'.$field.'"  id="'.$id.'"  class="input_rows1 tanggal required" size="15" value="'.$value.'"/>';
    ...
    function before_insert_processor($row, $postData) {
        ...
        if($postData['isdraft']==true){
            $postData['isubmit_kimiawi_trial'] = 0;
        } else{
            $postData['isubmit_kimiawi_trial'] = 1;
            $postData['dsubmit_kimiawi_trial'] = date('Y-m-d H:i:s');
            $postData['csubmit_kimiawi_trial'] = $this->user->gNIP;
        } 
        return $postData;
    ...
    function manipulate_update_button($buttons, $rowData) { 
        ...
        if ($this->input->get('action') == 'view' || $rowData['isubmit_kimiawi_trial'] == 1 || $submit == 1){
            unset($buttons['update_back']);
        }
