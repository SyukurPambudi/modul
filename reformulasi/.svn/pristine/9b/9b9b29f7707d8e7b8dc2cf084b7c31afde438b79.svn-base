		...
		<tbody>
			<?php
				foreach ($rows as $num => $row) {
					...
					$rowHead	.= '<td rowspan="'.$span.'">'.$row['dmulai_analisa_trial'].'</td>';
					$rowHead	.= '<td rowspan="'.$span.'">'.$row['dselesai_analisa_trial'].'</td>';
					$rowHead	.= '<td rowspan="'.$span.'">'.$row['nip_pic'].' - '.$row['name_pic'].'</td>';

					$rowFoot	 = '<td rowspan="'.$span.'">'.$arrKesimpulan[$row['ikesimpulan_analisa_trial']].'</td>';
					$rowFoot	.= '<td rowspan="'.$span.'">'.$row['dkesimpulan_analisa_trial'].'</td>';
					$rowFoot	.= '<td rowspan="'.$span.'">'.$row['dsubmit_kimiawi_trial'].'</td>';
