...
<table class="hover_table" id="re_export_req_refor_bahan_baku" cellspacing="0" cellpadding="1" style="width: 98%; border: 1px solid #dddddd; text-align: center; margin-left: 5px; border-collapse: collapse">
		...
		?>
				<tr style="border: 1px solid #dddddd; border-collapse: collapse; background: #ffffff; ">
					...
					<td style="border: 1px solid #dddddd; width: 15%">
						<input <?php echo $read ?>  type="text" name="detsatuan[]" value="<?php echo $row['vSatuan'] ?>"  class="detsatuan" style="width: 80%" />
					</td>
	...
	<tfoot>
		...
		if ($this->input->get('action') != 'view') { 
			if($iSubmit==0){?>
		<tr>
			<td colspan="5"></td><td style="text-align: center"><a href="javascript:;" onclick="javascript:add_row('re_export_req_refor_bahan_baku')">Tambah</a></td>
		</tr>
		<?php } 
			}}?>
	</tfoot>
