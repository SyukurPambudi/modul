...
<th colspan="7" style="border: 1px solid #dddddd;"><span style="font-weight: bold; color: #ffffff; text-shadow: 0 1px 1px rgba(0, 0, 0, 0.3); text-transform: uppercase;">Detail Bahan Baku</span></th>
</tr>
...
<th style="border: 1px solid #dddddd;">Source</th>
...
?>
    <tr style="border: 1px solid #dddddd; border-collapse: collapse; background: #ffffff; ">
        ...
        <td style="border: 1px solid #dddddd; width: 30%">
            ...
            <!-- <button class="btn_browse_bb" type="button" onclick="javascript:browse_multiple('<?php //echo $browse_url ?>?field=re_export_req_refor_bahan_baku&col=detraw_id','List Bahan Baku',this,'btn_browse_bb')">...</button> -->
