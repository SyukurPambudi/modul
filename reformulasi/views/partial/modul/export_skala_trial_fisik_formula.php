	...
	<table id="table_trial_uji_fisik" cellspacing="0" cellpadding="1">
		<thead>
			...
			<tr>
				...
				<th rowspan="2">Tanggal Mulai Orientasi<br>Skala Trial</th>
				<th rowspan="2">Tanggal Selesai Orientasi<br>Skala Trial</th>
				<th rowspan="2">PIC Skala Trial</th>
		...
		<tbody>
			<?php
				foreach ($rows as $num => $row) {
					...
					$rowHead	.= '<td rowspan="'.$span.'">'.$row['dmulai_skala_trial'].'</td>';
					$rowHead	.= '<td rowspan="'.$span.'">'.$row['dselesai_skala_trial'].'</td>';
					$rowHead	.= '<td rowspan="'.$span.'">'.$row['nip_pic'].' - '.$row['name_pic'].'</td>';

					$rowSubmit	= '<td rowspan="'.$span.'">'.$row['dsubmit_fisik_trial'].'</td>';
