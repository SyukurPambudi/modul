											...
											foreach ($upload as $up) {
												?>
													<tr>
														...
														<td>
															<?php
																if (file_exists('./'.$up['filepath'].'/'.$up['idHeader_File'].'/'.$up['vFilename_generate'])) {
																	$link = base_url().'processor/reformulasi/v3/export/skala/trial/fisik?action=download&id='.$up['idHeader_File'].'&path='.$up['filepath'].'&file='.$up['vFilename_generate'];
