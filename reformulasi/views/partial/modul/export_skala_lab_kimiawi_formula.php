		...
		<tbody>
			<?php
				foreach ($rows as $num => $row) {
					...
					$rowHead	.= '<td rowspan="'.$span.'">'.$row['dmulai_analisa'].'</td>';
					$rowHead	.= '<td rowspan="'.$span.'">'.$row['dselesai_analisa'].'</td>';
					$rowHead	.= '<td rowspan="'.$span.'">'.$row['nip_pic'].' - '.$row['name_pic'].'</td>';

					$rowFoot	 = '<td rowspan="'.$span.'">'.$arrKesimpulan[$row['ikesimpulan_analisa']].'</td>';
					$rowFoot	.= '<td rowspan="'.$span.'">'.$row['dkesimpulan_analisa'].'</td>';
					$rowFoot	.= '<td rowspan="'.$span.'">'.$row['dsubmit_kimiawi'].'</td>';
