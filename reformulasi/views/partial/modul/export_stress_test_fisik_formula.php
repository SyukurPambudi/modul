	...
	<table id="table_trial_uji_fisik" cellspacing="0" cellpadding="1">
		<thead>
			...
			<tr>
				...
				<th rowspan="2">Tanggal Mulai Orientasi<br>Stress Test</th>
				<th rowspan="2">Tanggal Selesai Orientasi<br>Stress Test</th>
				<th rowspan="2">PIC Stress Test</th>
		...
		<tbody>
			<?php
				foreach ($rows as $num => $row) {
					...
					$rowHead	.= '<td rowspan="'.$span.'">'.$row['dmulai_stress_test'].'</td>';
					$rowHead	.= '<td rowspan="'.$span.'">'.$row['dselesai_stress_test'].'</td>';
					$rowHead	.= '<td rowspan="'.$span.'">'.$row['nip_pic'].' - '.$row['name_pic'].'</td>';

					$rowSubmit	= '<td rowspan="'.$span.'">'.$row['dsubmit_fisik_stress'].'</td>';
