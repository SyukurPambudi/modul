...
<br>
<table class="hover_table" id="pembuatan_po_sample" cellspacing="0" cellpadding="1" style="width: 99%; border: 1px solid #dddddd; text-align: center; margin-left: 5px; border-collapse: collapse;">
	<thead>
		...
		?>
				<tr style="border: 1px solid #dddddd; border-collapse: collapse; background: #ffffff; ">
					...
					<td style="border: 1px solid #dddddd; width: 15%">
						...
						<input type="hidden" name="ireqdet_id[]" class="ireqdet_id" value="<?php echo $rd['ireqdet_id'] ?>"/>
					</td>
					<td style="border: 1px solid #dddddd; width: 15%">
