        ...
        $grid.jqGrid({
            ...
            gridComplete: function () {
                ...
                $(".autocomplate_flow_process" ).livequery(function() {
                    var idPost = $("#setup_application_idprivi_apps").val();
                    $( this ).autocomplete({
                        source: function( request, response) {
                            $.ajax({
                                url: base_url+"processor/brosur/setup/application?action=getProcess",
                                dataType: "json",
                                data: {
                                    term: request.term,
                                    id: idPost,
            ...
            var sa=
                [
                    [
                        ...
                        "<input type='text' size='90' id='<?php echo $grid ?>_vkode_text_"+rlast+"' class='autocomplate_flow_process required' name='<?php echo $grid ?>_vkode_text[0][]'>"
                            +"<input type='hidden' size='10' class='required classiMmodul' id='<?php echo $grid ?>_vkode_"+rlast+"' name='<?php echo $grid ?>_vkode[0][]'>"
                            +"<input type='hidden' size='10' class='required classiMmodul' id='<?php echo $grid ?>_im_modul_"+rlast+"' name='<?php echo $grid ?>_imodul[0][]' value='0'>"
                    ]
                ];
